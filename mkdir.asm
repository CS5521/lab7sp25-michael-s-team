...
main(int argc, char *argv[])
{
  ...
  47:	e8 22 04 00 00       	call   46e <mkdir>
  ...
  66:	c7 44 24 04 71 09 00 	movl   $0x971,0x4(%esp)
  6d:	00 
...
ps(void)
{
 ...
 2fb:	c7 44 24 04 8d 09 00 	movl   $0x98d,0x4(%esp)
 302:	00 
 ...
 3d1:	c7 44 24 04 a6 09 00 	movl   $0x9a6,0x4(%esp)
 3d8:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 527:	0f b6 80 30 0c 00 00 	movzbl 0xc30(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	75 09                	jne    68f <printf+0x101>
          s = "(null)";
 686:	c7 45 f4 b6 09 00 00 	movl   $0x9b6,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 750:	a1 4c 0c 00 00       	mov    0xc4c,%eax
 ...
 81b:	a3 4c 0c 00 00       	mov    %eax,0xc4c
}
 820:	c9                   	leave  
 821:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 86e:	e8 ce fe ff ff       	call   741 <free>
  return freep;
 873:	a1 4c 0c 00 00       	mov    0xc4c,%eax
}
 878:	c9                   	leave  
 879:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 88c:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 88f:	a1 4c 0c 00 00       	mov    0xc4c,%eax
 894:	89 45 f0             	mov    %eax,-0x10(%ebp)
 897:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 89b:	75 23                	jne    8c0 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 89d:	c7 45 f0 44 0c 00 00 	movl   $0xc44,-0x10(%ebp)
 8a4:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8a7:	a3 4c 0c 00 00       	mov    %eax,0xc4c
 8ac:	a1 4c 0c 00 00       	mov    0xc4c,%eax
 8b1:	a3 44 0c 00 00       	mov    %eax,0xc44
    base.s.size = 0;
 8b6:	c7 05 48 0c 00 00 00 	movl   $0x0,0xc48
 8bd:	00 00 00 
  }
 ...
 913:	a3 4c 0c 00 00       	mov    %eax,0xc4c
      return (void*)(p + 1);
 ...
 91e:	eb 38                	jmp    958 <malloc+0xde>
    ...
    if(p == freep)
 920:	a1 4c 0c 00 00       	mov    0xc4c,%eax
