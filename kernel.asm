...
80100049:	e8 46 4f 00 00       	call   80104f94 <initlock>
...
80100087:	c7 44 24 04 3f 84 10 	movl   $0x8010843f,0x4(%esp)
8010008e:	80 
8010008f:	89 04 24             	mov    %eax,(%esp)
80100092:	e8 9a 4d 00 00       	call   80104e31 <initsleeplock>
...
801000c9:	e8 e7 4e 00 00       	call   80104fb5 <acquire>
...
80100104:	e8 14 4f 00 00       	call   8010501d <release>
      acquiresleep(&b->lock);
80100109:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010010c:	83 c0 0c             	add    $0xc,%eax
8010010f:	89 04 24             	mov    %eax,(%esp)
80100112:	e8 54 4d 00 00       	call   80104e6b <acquiresleep>
      return b;
...
8010017d:	e8 9b 4e 00 00       	call   8010501d <release>
      acquiresleep(&b->lock);
80100182:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100185:	83 c0 0c             	add    $0xc,%eax
80100188:	89 04 24             	mov    %eax,(%esp)
8010018b:	e8 db 4c 00 00       	call   80104e6b <acquiresleep>
      return b;
...
801001a7:	c7 04 24 46 84 10 80 	movl   $0x80108446,(%esp)
...
801001fb:	e8 08 4d 00 00       	call   80104f08 <holdingsleep>
80100200:	85 c0                	test   %eax,%eax
80100202:	75 0c                	jne    80100210 <bwrite+0x24>
    panic("bwrite");
80100204:	c7 04 24 57 84 10 80 	movl   $0x80108457,(%esp)
...
8010023b:	e8 c8 4c 00 00       	call   80104f08 <holdingsleep>
80100240:	85 c0                	test   %eax,%eax
80100242:	75 0c                	jne    80100250 <brelse+0x24>
    panic("brelse");
80100244:	c7 04 24 5e 84 10 80 	movl   $0x8010845e,(%esp)
...
80100259:	e8 68 4c 00 00       	call   80104ec6 <releasesleep>

  acquire(&bcache.lock);
8010025e:	c7 04 24 40 c6 10 80 	movl   $0x8010c640,(%esp)
80100265:	e8 4b 4d 00 00       	call   80104fb5 <acquire>
  b->refcnt--;
...
801002d1:	e8 47 4d 00 00       	call   8010501d <release>
}
801002d6:	c9                   	leave  
801002d7:	c3                   	ret    
...
801003e3:	e8 cd 4b 00 00       	call   80104fb5 <acquire>
...
801003ed:	75 0c                	jne    801003fb <cprintf+0x33>
    panic("null fmt");
801003ef:	c7 04 24 65 84 10 80 	movl   $0x80108465,(%esp)
...
801004d6:	75 09                	jne    801004e1 <cprintf+0x119>
        s = "(null)";
801004d8:	c7 45 ec 6e 84 10 80 	movl   $0x8010846e,-0x14(%ebp)
      for(; *s; s++)
...
8010055b:	e8 bd 4a 00 00       	call   8010501d <release>
}
80100560:	c9                   	leave  
80100561:	c3                   	ret    
...
80100580:	c7 04 24 75 84 10 80 	movl   $0x80108475,(%esp)
...
80100592:	e8 31 fe ff ff       	call   801003c8 <cprintf>
  cprintf("\n");
80100597:	c7 04 24 89 84 10 80 	movl   $0x80108489,(%esp)
...
801005b0:	e8 b3 4a 00 00       	call   80105068 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005c9:	c7 04 24 8b 84 10 80 	movl   $0x8010848b,(%esp)
...
801006ba:	c7 04 24 8f 84 10 80 	movl   $0x8010848f,(%esp)
...
801006ee:	e8 03 4c 00 00       	call   801052f6 <memmove>
    pos -= 80;
...
8010071d:	e8 05 4b 00 00       	call   80105227 <memset>
  }
...
801007fd:	e8 b3 47 00 00       	call   80104fb5 <acquire>
  while((c = getc()) >= 0){
...
80100959:	e8 bf 46 00 00       	call   8010501d <release>
  if(doprocdump) {
8010095e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80100962:	74 05                	je     80100969 <consoleintr+0x180>
    procdump();  // now call procdump() wo. cons.lock held
80100964:	e8 ce 43 00 00       	call   80104d37 <procdump>
  }
}
80100969:	c9                   	leave  
8010096a:	c3                   	ret    
...
80100989:	e8 27 46 00 00       	call   80104fb5 <acquire>
  while(n > 0){
...
801009a8:	e8 70 46 00 00       	call   8010501d <release>
        ilock(ip);
...
80100a4d:	e8 cb 45 00 00       	call   8010501d <release>
  ilock(ip);
...
80100a81:	e8 2f 45 00 00       	call   80104fb5 <acquire>
  for(i = 0; i < n; i++)
...
80100abb:	e8 5d 45 00 00       	call   8010501d <release>
  ilock(ip);
...
80100ad6:	c7 44 24 04 a2 84 10 	movl   $0x801084a2,0x4(%esp)
80100add:	80 
80100ade:	c7 04 24 a0 b5 10 80 	movl   $0x8010b5a0,(%esp)
80100ae5:	e8 aa 44 00 00       	call   80104f94 <initlock>
...
80100b48:	e8 be 29 00 00       	call   8010350b <end_op>
    cprintf("exec: fail\n");
80100b4d:	c7 04 24 aa 84 10 80 	movl   $0x801084aa,(%esp)
...
80100bb1:	e9 85 03 00 00       	jmp    80100f3b <exec+0x41d>
  ...
  if((pgdir = setupkvm()) == 0)
80100bb6:	e8 c8 6f 00 00       	call   80107b83 <setupkvm>
...
80100c74:	e8 e0 72 00 00       	call   80107f59 <allocuvm>
...
80100cc6:	e8 ab 71 00 00       	call   80107e76 <loaduvm>
...
80100d34:	e8 20 72 00 00       	call   80107f59 <allocuvm>
...
80100d59:	e8 6e 74 00 00       	call   801081cc <clearpteu>
  sp = sz;
...
80100d8f:	e8 fd 46 00 00       	call   80105491 <strlen>
...
80100db8:	e8 d4 46 00 00       	call   80105491 <strlen>
...
80100de8:	e8 a2 75 00 00       	call   8010838f <copyout>
...
80100e8f:	e8 fb 74 00 00       	call   8010838f <copyout>
...
80100ee4:	e8 5e 45 00 00       	call   80105447 <safestrcpy>
...
80100f24:	e8 34 6d 00 00       	call   80107c5d <switchuvm>
  freevm(oldpgdir);
80100f29:	8b 45 cc             	mov    -0x34(%ebp),%eax
80100f2c:	89 04 24             	mov    %eax,(%esp)
80100f2f:	e8 01 72 00 00       	call   80108135 <freevm>
  return 0;
...
80100f47:	e8 e9 71 00 00       	call   80108135 <freevm>
  if(ip){
...
80100f6f:	c7 44 24 04 b6 84 10 	movl   $0x801084b6,0x4(%esp)
80100f76:	80 
80100f77:	c7 04 24 40 10 11 80 	movl   $0x80111040,(%esp)
80100f7e:	e8 11 40 00 00       	call   80104f94 <initlock>
}
80100f83:	c9                   	leave  
80100f84:	c3                   	ret    
...
80100f92:	e8 1e 40 00 00       	call   80104fb5 <acquire>
...
80100fbb:	e8 5d 40 00 00       	call   8010501d <release>
      return f;
...
80100fd9:	e8 3f 40 00 00       	call   8010501d <release>
  return 0;
...
80100ff2:	e8 be 3f 00 00       	call   80104fb5 <acquire>
  if(f->ref < 1)
...
80100fff:	7f 0c                	jg     8010100d <filedup+0x28>
    panic("filedup");
80101001:	c7 04 24 bd 84 10 80 	movl   $0x801084bd,(%esp)
...
80101023:	e8 f5 3f 00 00       	call   8010501d <release>
  return f;
...
8010103a:	e8 76 3f 00 00       	call   80104fb5 <acquire>
  if(f->ref < 1)
...
80101047:	7f 0c                	jg     80101055 <fileclose+0x28>
    panic("fileclose");
80101049:	c7 04 24 c5 84 10 80 	movl   $0x801084c5,(%esp)
...
80101075:	e8 a3 3f 00 00       	call   8010501d <release>
...
801010bf:	e8 59 3f 00 00       	call   8010501d <release>
...
801011fe:	eb 0c                	jmp    8010120c <fileread+0xba>
  ...
  panic("fileread");
80101200:	c7 04 24 cf 84 10 80 	movl   $0x801084cf,(%esp)
...
8010130c:	c7 04 24 d8 84 10 80 	movl   $0x801084d8,(%esp)
...
8010133c:	eb 0c                	jmp    8010134a <filewrite+0x13c>
  ...
  panic("filewrite");
8010133e:	c7 04 24 e8 84 10 80 	movl   $0x801084e8,(%esp)
...
80101384:	e8 6d 3f 00 00       	call   801052f6 <memmove>
  brelse(bp);
...
801013ca:	e8 58 3e 00 00       	call   80105227 <memset>
  log_write(bp);
...
80101517:	c7 04 24 f4 84 10 80 	movl   $0x801084f4,(%esp)
...
801015a6:	c7 04 24 0a 85 10 80 	movl   $0x8010850a,(%esp)
...
80101600:	c7 44 24 04 1d 85 10 	movl   $0x8010851d,0x4(%esp)
80101607:	80 
80101608:	c7 04 24 60 1a 11 80 	movl   $0x80111a60,(%esp)
8010160f:	e8 80 39 00 00       	call   80104f94 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101635:	c7 44 24 04 24 85 10 	movl   $0x80108524,0x4(%esp)
8010163c:	80 
8010163d:	89 04 24             	mov    %eax,(%esp)
80101640:	e8 ec 37 00 00       	call   80104e31 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801016af:	c7 04 24 2c 85 10 80 	movl   $0x8010852c,(%esp)
...
80101732:	e8 f0 3a 00 00       	call   80105227 <memset>
      dip->type = type;
...
8010178a:	c7 04 24 7f 85 10 80 	movl   $0x8010857f,(%esp)
...
80101839:	e8 b8 3a 00 00       	call   801052f6 <memmove>
  log_write(bp);
...
80101863:	e8 4d 37 00 00       	call   80104fb5 <acquire>
...
801018ad:	e8 6b 37 00 00       	call   8010501d <release>
      return ip;
...
801018e3:	c7 04 24 91 85 10 80 	movl   $0x80108591,(%esp)
...
80101921:	e8 f7 36 00 00       	call   8010501d <release>
...
80101938:	e8 78 36 00 00       	call   80104fb5 <acquire>
  ip->ref++;
...
80101953:	e8 c5 36 00 00       	call   8010501d <release>
  return ip;
...
80101971:	7f 0c                	jg     8010197f <ilock+0x22>
    panic("ilock");
80101973:	c7 04 24 a1 85 10 80 	movl   $0x801085a1,(%esp)
...
80101988:	e8 de 34 00 00       	call   80104e6b <acquiresleep>
...
80101a36:	e8 bb 38 00 00       	call   801052f6 <memmove>
    brelse(bp);
...
80101a5a:	75 0c                	jne    80101a68 <ilock+0x10b>
      panic("ilock: no type");
80101a5c:	c7 04 24 a7 85 10 80 	movl   $0x801085a7,(%esp)
...
80101a7f:	e8 84 34 00 00       	call   80104f08 <holdingsleep>
...
80101a90:	7f 0c                	jg     80101a9e <iunlock+0x34>
    panic("iunlock");
80101a92:	c7 04 24 b6 85 10 80 	movl   $0x801085b6,(%esp)
...
80101aa7:	e8 1a 34 00 00       	call   80104ec6 <releasesleep>
}
80101aac:	c9                   	leave  
80101aad:	c3                   	ret    
...
80101abd:	e8 a9 33 00 00       	call   80104e6b <acquiresleep>
...
80101adf:	e8 d1 34 00 00       	call   80104fb5 <acquire>
    int r = ip->ref;
...
80101af4:	e8 24 35 00 00       	call   8010501d <release>
    if(r == 1){
...
80101b31:	e8 90 33 00 00       	call   80104ec6 <releasesleep>

  acquire(&icache.lock);
80101b36:	c7 04 24 60 1a 11 80 	movl   $0x80111a60,(%esp)
80101b3d:	e8 73 34 00 00       	call   80104fb5 <acquire>
  ip->ref--;
...
80101b58:	e8 c0 34 00 00       	call   8010501d <release>
}
80101b5d:	c9                   	leave  
80101b5e:	c3                   	ret    
...
80101c7e:	c7 04 24 be 85 10 80 	movl   $0x801085be,(%esp)
...
80101f2b:	e8 c6 33 00 00       	call   801052f6 <memmove>
    brelse(bp);
...
8010208a:	e8 67 32 00 00       	call   801052f6 <memmove>
    log_write(bp);
...
80102108:	e8 8c 32 00 00       	call   80105399 <strncmp>
}
8010210d:	c9                   	leave  
8010210e:	c3                   	ret    
...
80102122:	c7 04 24 d1 85 10 80 	movl   $0x801085d1,(%esp)
...
80102160:	c7 04 24 e3 85 10 80 	movl   $0x801085e3,(%esp)
...
80102243:	74 0c                	je     80102251 <dirlink+0x79>
      panic("dirlink read");
80102245:	c7 04 24 f2 85 10 80 	movl   $0x801085f2,(%esp)
...
8010228a:	e8 60 31 00 00       	call   801053ef <strncpy>
  de.inum = inum;
...
801022ba:	74 0c                	je     801022c8 <dirlink+0xf0>
    panic("dirlink");
801022bc:	c7 04 24 ff 85 10 80 	movl   $0x801085ff,(%esp)
...
80102341:	e8 b0 2f 00 00       	call   801052f6 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
8010235c:	e8 95 2f 00 00       	call   801052f6 <memmove>
    name[len] = 0;
...
801025aa:	c7 44 24 04 07 86 10 	movl   $0x80108607,0x4(%esp)
801025b1:	80 
801025b2:	c7 04 24 e0 b5 10 80 	movl   $0x8010b5e0,(%esp)
801025b9:	e8 d6 29 00 00       	call   80104f94 <initlock>
...
80102648:	75 0c                	jne    80102656 <idestart+0x18>
    panic("idestart");
8010264a:	c7 04 24 0b 86 10 80 	movl   $0x8010860b,(%esp)
...
80102663:	c7 04 24 14 86 10 80 	movl   $0x80108614,(%esp)
...
801026b5:	c7 04 24 0b 86 10 80 	movl   $0x8010860b,(%esp)
...
801027d5:	e8 db 27 00 00       	call   80104fb5 <acquire>
...
801027ef:	e8 29 28 00 00       	call   8010501d <release>
    return;
...
80102884:	e8 94 27 00 00       	call   8010501d <release>
}
80102889:	c9                   	leave  
8010288a:	c3                   	ret    
...
8010289a:	e8 69 26 00 00       	call   80104f08 <holdingsleep>
8010289f:	85 c0                	test   %eax,%eax
801028a1:	75 0c                	jne    801028af <iderw+0x24>
    panic("iderw: buf not locked");
801028a3:	c7 04 24 26 86 10 80 	movl   $0x80108626,(%esp)
...
801028bc:	c7 04 24 3c 86 10 80 	movl   $0x8010863c,(%esp)
...
80102962:	e8 b6 26 00 00       	call   8010501d <release>
}
80102967:	c9                   	leave  
80102968:	c3                   	ret    
...
801029e2:	c7 04 24 70 86 10 80 	movl   $0x80108670,(%esp)
...
80102a84:	c7 44 24 04 a2 86 10 	movl   $0x801086a2,0x4(%esp)
80102a8b:	80 
80102a8c:	c7 04 24 c0 36 11 80 	movl   $0x801136c0,(%esp)
80102a93:	e8 fc 24 00 00       	call   80104f94 <initlock>
  kmem.use_lock = 0;
...
80102b3b:	76 0c                	jbe    80102b49 <kfree+0x36>
    panic("kfree");
80102b3d:	c7 04 24 a7 86 10 80 	movl   $0x801086a7,(%esp)
...
80102b5f:	e8 c3 26 00 00       	call   80105227 <memset>
...
80102b74:	e8 3c 24 00 00       	call   80104fb5 <acquire>
  r = (struct run*)v;
...
80102ba2:	e8 76 24 00 00       	call   8010501d <release>
}
80102ba7:	c9                   	leave  
80102ba8:	c3                   	ret    
...
80102bbf:	e8 f1 23 00 00       	call   80104fb5 <acquire>
  r = kmem.freelist;
...
80102bec:	e8 2c 24 00 00       	call   8010501d <release>
  return (char*)r;
...
80103189:	e8 10 21 00 00       	call   8010529e <memcmp>
...
80103289:	c7 44 24 04 ad 86 10 	movl   $0x801086ad,0x4(%esp)
80103290:	80 
80103291:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
80103298:	e8 f7 1c 00 00       	call   80104f94 <initlock>
  readsb(dev, &sb);
...
80103342:	e8 af 1f 00 00       	call   801052f6 <memmove>
...
80103494:	e8 1c 1b 00 00       	call   80104fb5 <acquire>
  while(1){
    if(log.committing){
...
80103500:	e8 18 1b 00 00       	call   8010501d <release>
      break;
...
8010351f:	e8 91 1a 00 00       	call   80104fb5 <acquire>
  log.outstanding -= 1;
...
8010353a:	c7 04 24 b1 86 10 80 	movl   $0x801086b1,(%esp)
...
80103575:	e8 a3 1a 00 00       	call   8010501d <release>
...
8010358c:	e8 24 1a 00 00       	call   80104fb5 <acquire>
    log.committing = 0;
...
801035ae:	e8 6a 1a 00 00       	call   8010501d <release>
  }
}
801035b3:	c9                   	leave  
801035b4:	c3                   	ret    
...
80103629:	e8 c8 1c 00 00       	call   801052f6 <memmove>
...
801036b4:	c7 04 24 c0 86 10 80 	movl   $0x801086c0,(%esp)
...
801036c9:	c7 04 24 d6 86 10 80 	movl   $0x801086d6,(%esp)
801036d0:	e8 8d ce ff ff       	call   80100562 <panic>

  acquire(&log.lock);
801036d5:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
801036dc:	e8 d4 18 00 00       	call   80104fb5 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103753:	e8 c5 18 00 00       	call   8010501d <release>
}
80103758:	c9                   	leave  
80103759:	c3                   	ret    
...
801037b4:	e8 c9 32 00 00       	call   80106a82 <uartinit>
  pinit();         // process table
801037b9:	e8 f0 08 00 00       	call   801040ae <pinit>
  tvinit();        // trap vectors
801037be:	e8 88 2e 00 00       	call   8010664b <tvinit>
  binit();         // buffer cache
...
801037f8:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801037fb:	e8 43 44 00 00       	call   80107c43 <switchkvm>
  seginit();
80103800:	e8 f3 3e 00 00       	call   801076f8 <seginit>
  lapicinit();
...
8010382a:	c7 04 24 f1 86 10 80 	movl   $0x801086f1,(%esp)
80103831:	e8 92 cb ff ff       	call   801003c8 <cprintf>
  idtinit();       // load idt register
80103836:	e8 84 2f 00 00       	call   801067bf <idtinit>
...
8010387e:	e8 73 1a 00 00       	call   801052f6 <memmove>
...
801039bb:	00 
801039bc:	c7 44 24 04 08 87 10 	movl   $0x80108708,0x4(%esp)
801039c3:	80 
801039c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039c7:	89 04 24             	mov    %eax,(%esp)
801039ca:	e8 cf 18 00 00       	call   8010529e <memcmp>
...
80103af9:	00 
80103afa:	c7 44 24 04 0d 87 10 	movl   $0x8010870d,0x4(%esp)
80103b01:	80 
80103b02:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b05:	89 04 24             	mov    %eax,(%esp)
80103b08:	e8 91 17 00 00       	call   8010529e <memcmp>
...
80103b80:	c7 04 24 12 87 10 80 	movl   $0x80108712,(%esp)
...
80103bc9:	8b 04 85 4c 87 10 80 	mov    -0x7fef78b4(,%eax,4),%eax
...
80103c48:	c7 04 24 2c 87 10 80 	movl   $0x8010872c,(%esp)
...
80103d7d:	c7 44 24 04 60 87 10 	movl   $0x80108760,0x4(%esp)
80103d84:	80 
80103d85:	89 04 24             	mov    %eax,(%esp)
80103d88:	e8 07 12 00 00       	call   80104f94 <initlock>
  (*f0)->type = FD_PIPE;
...
80103e34:	e8 7c 11 00 00       	call   80104fb5 <acquire>
  if(writable){
...
80103e9b:	e8 7d 11 00 00       	call   8010501d <release>
    kfree((char*)p);
...
80103eb3:	e8 65 11 00 00       	call   8010501d <release>
}
80103eb8:	c9                   	leave  
80103eb9:	c3                   	ret    
...
80103ec6:	e8 ea 10 00 00       	call   80104fb5 <acquire>
  for(i = 0; i < n; i++){
...
80103ef8:	e8 20 11 00 00       	call   8010501d <release>
        return -1;
...
80103f9e:	e8 7a 10 00 00       	call   8010501d <release>
  return n;
...
80103fb5:	e8 fb 0f 00 00       	call   80104fb5 <acquire>
...
80103fce:	e8 4a 10 00 00       	call   8010501d <release>
      return -1;
...
8010408a:	e8 8e 0f 00 00       	call   8010501d <release>
  return i;
...
801040b4:	c7 44 24 04 68 87 10 	movl   $0x80108768,0x4(%esp)
801040bb:	80 
801040bc:	c7 04 24 a0 3d 11 80 	movl   $0x80113da0,(%esp)
801040c3:	e8 cc 0e 00 00       	call   80104f94 <initlock>
}
801040c8:	c9                   	leave  
801040c9:	c3                   	ret    
...
801040ff:	c7 04 24 70 87 10 80 	movl   $0x80108770,(%esp)
...
80104153:	c7 04 24 96 87 10 80 	movl   $0x80108796,(%esp)
...
80104164:	83 ec 18             	sub    $0x18,%esp
  ...
  struct proc *p;
  pushcli();
80104167:	e8 b6 0f 00 00       	call   80105122 <pushcli>
  c = mycpu();
...
8010417d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  popcli();
80104180:	e8 e9 0f 00 00       	call   8010516e <popcli>
  return p;
...
80104197:	e8 19 0e 00 00       	call   80104fb5 <acquire>
...
801041d5:	e8 43 0e 00 00       	call   8010501d <release>
...
80104208:	e8 10 0e 00 00       	call   8010501d <release>
  return 0;
...
80104244:	ba 06 66 10 80       	mov    $0x80106606,%edx
...
80104274:	e8 ae 0f 00 00       	call   80105227 <memset>
...
801042a2:	e8 dc 38 00 00       	call   80107b83 <setupkvm>
...
801042b7:	c7 04 24 a6 87 10 80 	movl   $0x801087a6,(%esp)
...
801042dd:	e8 0c 3b 00 00       	call   80107dee <inituvm>
  p->sz = PGSIZE;
...
80104304:	e8 1e 0f 00 00       	call   80105227 <memset>
...
8010437d:	00 
8010437e:	c7 44 24 04 bf 87 10 	movl   $0x801087bf,0x4(%esp)
80104385:	80 
80104386:	89 04 24             	mov    %eax,(%esp)
80104389:	e8 b9 10 00 00       	call   80105447 <safestrcpy>
  p->cwd = namei("/");
8010438e:	c7 04 24 c8 87 10 80 	movl   $0x801087c8,(%esp)
...
801043be:	e8 f2 0b 00 00       	call   80104fb5 <acquire>
...
801043d4:	e8 44 0c 00 00       	call   8010501d <release>
}
801043d9:	c9                   	leave  
801043da:	c3                   	ret    
...
80104413:	e8 41 3b 00 00       	call   80107f59 <allocuvm>
...
8010444a:	e8 20 3c 00 00       	call   8010806f <deallocuvm>
...
8010446d:	e8 eb 37 00 00       	call   80107c5d <switchuvm>
  return 0;
...
801044b4:	e8 59 3d 00 00       	call   80108212 <copyuvm>
...
801045a5:	e8 9d 0e 00 00       	call   80105447 <safestrcpy>
...
801045ba:	e8 f6 09 00 00       	call   80104fb5 <acquire>

  np->state = RUNNABLE;
801045bf:	8b 45 dc             	mov    -0x24(%ebp),%eax
801045c2:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  
  // set the tick and tickets
  np->ticks = 0;
801045c9:	8b 45 dc             	mov    -0x24(%ebp),%eax
801045cc:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
801045d3:	00 00 00 
  if (curproc->tickets > 10)
801045d6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045d9:	8b 40 7c             	mov    0x7c(%eax),%eax
801045dc:	83 f8 0a             	cmp    $0xa,%eax
801045df:	7e 0e                	jle    801045ef <fork+0x176>
  {
    np->tickets = curproc->tickets;
801045e1:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045e4:	8b 50 7c             	mov    0x7c(%eax),%edx
801045e7:	8b 45 dc             	mov    -0x24(%ebp),%eax
801045ea:	89 50 7c             	mov    %edx,0x7c(%eax)
801045ed:	eb 0a                	jmp    801045f9 <fork+0x180>
  }
  else
  {
    np->tickets = 10;
801045ef:	8b 45 dc             	mov    -0x24(%ebp),%eax
801045f2:	c7 40 7c 0a 00 00 00 	movl   $0xa,0x7c(%eax)
  }

  release(&ptable.lock);
801045f9:	c7 04 24 a0 3d 11 80 	movl   $0x80113da0,(%esp)
80104600:	e8 18 0a 00 00       	call   8010501d <release>
...
80104626:	75 0c                	jne    80104634 <exit+0x24>
    panic("init exiting");
80104628:	c7 04 24 ca 87 10 80 	movl   $0x801087ca,(%esp)
...
801046a7:	e8 09 09 00 00       	call   80104fb5 <acquire>
...
8010470c:	e8 c9 01 00 00       	call   801048da <sched>
  panic("zombie exit");
80104711:	c7 04 24 d7 87 10 80 	movl   $0x801087d7,(%esp)
...
80104732:	e8 7e 08 00 00       	call   80104fb5 <acquire>
  for(;;){
...
80104796:	e8 9a 39 00 00       	call   80108135 <freevm>
        p->pid = 0;
...
801047d1:	e8 47 08 00 00       	call   8010501d <release>
        return pid;
...
80104806:	e8 12 08 00 00       	call   8010501d <release>
      return -1;
...
80104853:	e8 5d 07 00 00       	call   80104fb5 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104880:	e8 d8 33 00 00       	call   80107c5d <switchuvm>
      p->state = RUNNING;
...
801048a2:	e8 11 0c 00 00       	call   801054b8 <swtch>
      switchkvm();
801048a7:	e8 97 33 00 00       	call   80107c43 <switchkvm>
...
801048d0:	e8 48 07 00 00       	call   8010501d <release>
...
801048ef:	e8 ed 07 00 00       	call   801050e1 <holding>
801048f4:	85 c0                	test   %eax,%eax
801048f6:	75 0c                	jne    80104904 <sched+0x2a>
    panic("sched ptable.lock");
801048f8:	c7 04 24 e3 87 10 80 	movl   $0x801087e3,(%esp)
...
80104912:	74 0c                	je     80104920 <sched+0x46>
    panic("sched locks");
80104914:	c7 04 24 f5 87 10 80 	movl   $0x801087f5,(%esp)
...
80104929:	75 0c                	jne    80104937 <sched+0x5d>
    panic("sched running");
8010492b:	c7 04 24 01 88 10 80 	movl   $0x80108801,(%esp)
...
80104945:	c7 04 24 0f 88 10 80 	movl   $0x8010880f,(%esp)
...
80104974:	e8 3f 0b 00 00       	call   801054b8 <swtch>
  mycpu()->intena = intena;
...
80104996:	e8 1a 06 00 00       	call   80104fb5 <acquire>
...
801049b3:	e8 65 06 00 00       	call   8010501d <release>
}
801049b8:	c9                   	leave  
801049b9:	c3                   	ret    
...
801049c7:	e8 51 06 00 00       	call   8010501d <release>
...
80104a0b:	75 0c                	jne    80104a19 <sleep+0x20>
    panic("sleep");
80104a0d:	c7 04 24 23 88 10 80 	movl   $0x80108823,(%esp)
...
80104a1f:	c7 04 24 29 88 10 80 	movl   $0x80108829,(%esp)
...
80104a3b:	e8 75 05 00 00       	call   80104fb5 <acquire>
    release(lk);
80104a40:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a43:	89 04 24             	mov    %eax,(%esp)
80104a46:	e8 d2 05 00 00       	call   8010501d <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80104a7d:	e8 9b 05 00 00       	call   8010501d <release>
    acquire(lk);
80104a82:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a85:	89 04 24             	mov    %eax,(%esp)
80104a88:	e8 28 05 00 00       	call   80104fb5 <acquire>
  }
}
80104a8d:	c9                   	leave  
80104a8e:	c3                   	ret    
...
80104add:	e8 d3 04 00 00       	call   80104fb5 <acquire>
  wakeup1(chan);
...
80104af4:	e8 24 05 00 00       	call   8010501d <release>
}
80104af9:	c9                   	leave  
80104afa:	c3                   	ret    
...
80104b08:	e8 a8 04 00 00       	call   80104fb5 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104b47:	e8 d1 04 00 00       	call   8010501d <release>
      return 0;
...
80104b6a:	e8 ae 04 00 00       	call   8010501d <release>
  return -1;
...
80104b7a:	83 ec 24             	sub    $0x24,%esp
  struct proc * p;
  int i = 0;
80104b7d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++, i++)
80104b84:	c7 45 f4 d4 3d 11 80 	movl   $0x80113dd4,-0xc(%ebp)
80104b8b:	e9 94 01 00 00       	jmp    80104d24 <fillpstat+0x1ae>
  {
    if (i >= NPROC)
80104b90:	83 7d f0 3f          	cmpl   $0x3f,-0x10(%ebp)
80104b94:	7e 05                	jle    80104b9b <fillpstat+0x25>
    {
      break;
80104b96:	e9 96 01 00 00       	jmp    80104d31 <fillpstat+0x1bb>
    }

    if (p->state == UNUSED)
80104b9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b9e:	8b 40 0c             	mov    0xc(%eax),%eax
80104ba1:	85 c0                	test   %eax,%eax
80104ba3:	75 1d                	jne    80104bc2 <fillpstat+0x4c>
    {
      (*pstat)[i].inuse = 0;
80104ba5:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104ba8:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104bab:	89 d0                	mov    %edx,%eax
80104bad:	c1 e0 03             	shl    $0x3,%eax
80104bb0:	01 d0                	add    %edx,%eax
80104bb2:	c1 e0 02             	shl    $0x2,%eax
80104bb5:	01 c8                	add    %ecx,%eax
80104bb7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80104bbd:	e9 57 01 00 00       	jmp    80104d19 <fillpstat+0x1a3>
    }
    else
    {
      (*pstat)[i].inuse = 1;
...
80104bca:	c1 e0 03             	shl    $0x3,%eax
80104bcd:	01 d0                	add    %edx,%eax
80104bcf:	c1 e0 02             	shl    $0x2,%eax
80104bd2:	01 c8                	add    %ecx,%eax
80104bd4:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
      (*pstat)[i].pid = p->pid;
80104bda:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bdd:	8b 48 10             	mov    0x10(%eax),%ecx
80104be0:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104be3:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104be6:	89 d0                	mov    %edx,%eax
80104be8:	c1 e0 03             	shl    $0x3,%eax
80104beb:	01 d0                	add    %edx,%eax
80104bed:	c1 e0 02             	shl    $0x2,%eax
80104bf0:	01 d8                	add    %ebx,%eax
80104bf2:	83 c0 08             	add    $0x8,%eax
80104bf5:	89 08                	mov    %ecx,(%eax)
      (*pstat)[i].tickets = p->tickets;
80104bf7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bfa:	8b 48 7c             	mov    0x7c(%eax),%ecx
80104bfd:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104c00:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104c03:	89 d0                	mov    %edx,%eax
80104c05:	c1 e0 03             	shl    $0x3,%eax
80104c08:	01 d0                	add    %edx,%eax
80104c0a:	c1 e0 02             	shl    $0x2,%eax
80104c0d:	01 d8                	add    %ebx,%eax
80104c0f:	83 c0 04             	add    $0x4,%eax
80104c12:	89 08                	mov    %ecx,(%eax)
      (*pstat)[i].ticks = p->ticks;
80104c14:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c17:	8b 88 80 00 00 00    	mov    0x80(%eax),%ecx
80104c1d:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104c20:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104c23:	89 d0                	mov    %edx,%eax
80104c25:	c1 e0 03             	shl    $0x3,%eax
80104c28:	01 d0                	add    %edx,%eax
80104c2a:	c1 e0 02             	shl    $0x2,%eax
80104c2d:	01 d8                	add    %ebx,%eax
80104c2f:	83 c0 0c             	add    $0xc,%eax
80104c32:	89 08                	mov    %ecx,(%eax)
      safestrcpy((*pstat)[i].name, p->name, sizeof((*pstat)[i].name));
80104c34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c37:	8d 48 6c             	lea    0x6c(%eax),%ecx
80104c3a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104c3d:	89 d0                	mov    %edx,%eax
80104c3f:	c1 e0 03             	shl    $0x3,%eax
80104c42:	01 d0                	add    %edx,%eax
80104c44:	c1 e0 02             	shl    $0x2,%eax
80104c47:	8d 50 10             	lea    0x10(%eax),%edx
80104c4a:	8b 45 08             	mov    0x8(%ebp),%eax
80104c4d:	01 d0                	add    %edx,%eax
80104c4f:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104c56:	00 
80104c57:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80104c5b:	89 04 24             	mov    %eax,(%esp)
80104c5e:	e8 e4 07 00 00       	call   80105447 <safestrcpy>
      switch (p->state) 
80104c63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c66:	8b 40 0c             	mov    0xc(%eax),%eax
80104c69:	83 f8 05             	cmp    $0x5,%eax
80104c6c:	0f 87 8e 00 00 00    	ja     80104d00 <fillpstat+0x18a>
80104c72:	8b 04 85 3c 88 10 80 	mov    -0x7fef77c4(,%eax,4),%eax
80104c79:	ff e0                	jmp    *%eax
      {
...
80104c8d:	83 c0 20             	add    $0x20,%eax
80104c90:	c6 00 45             	movb   $0x45,(%eax)
          break;
80104c93:	e9 81 00 00 00       	jmp    80104d19 <fillpstat+0x1a3>
...
80104ca0:	c1 e0 03             	shl    $0x3,%eax
80104ca3:	01 d0                	add    %edx,%eax
80104ca5:	c1 e0 02             	shl    $0x2,%eax
80104ca8:	01 c8                	add    %ecx,%eax
80104caa:	83 c0 20             	add    $0x20,%eax
80104cad:	c6 00 52             	movb   $0x52,(%eax)
          break;
80104cb0:	eb 67                	jmp    80104d19 <fillpstat+0x1a3>
...
80104cc4:	83 c0 20             	add    $0x20,%eax
80104cc7:	c6 00 41             	movb   $0x41,(%eax)
          break;
80104cca:	eb 4d                	jmp    80104d19 <fillpstat+0x1a3>
        case SLEEPING: (*pstat)[i].state = 'S';
80104ccc:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104ccf:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104cd2:	89 d0                	mov    %edx,%eax
80104cd4:	c1 e0 03             	shl    $0x3,%eax
80104cd7:	01 d0                	add    %edx,%eax
80104cd9:	c1 e0 02             	shl    $0x2,%eax
80104cdc:	01 c8                	add    %ecx,%eax
80104cde:	83 c0 20             	add    $0x20,%eax
80104ce1:	c6 00 53             	movb   $0x53,(%eax)
          break;
80104ce4:	eb 33                	jmp    80104d19 <fillpstat+0x1a3>
        case ZOMBIE: (*pstat)[i].state = 'Z';
80104ce6:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104ce9:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104cec:	89 d0                	mov    %edx,%eax
80104cee:	c1 e0 03             	shl    $0x3,%eax
80104cf1:	01 d0                	add    %edx,%eax
80104cf3:	c1 e0 02             	shl    $0x2,%eax
80104cf6:	01 c8                	add    %ecx,%eax
80104cf8:	83 c0 20             	add    $0x20,%eax
80104cfb:	c6 00 5a             	movb   $0x5a,(%eax)
          break;
80104cfe:	eb 19                	jmp    80104d19 <fillpstat+0x1a3>
        default: (*pstat)[i].state = '?';
80104d00:	8b 4d 08             	mov    0x8(%ebp),%ecx
...
80104d10:	01 c8                	add    %ecx,%eax
80104d12:	83 c0 20             	add    $0x20,%eax
80104d15:	c6 00 3f             	movb   $0x3f,(%eax)
          break;
80104d18:	90                   	nop
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++, i++)
80104d19:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104d20:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104d24:	81 7d f4 d4 5e 11 80 	cmpl   $0x80115ed4,-0xc(%ebp)
80104d2b:	0f 82 5f fe ff ff    	jb     80104b90 <fillpstat+0x1a>
      } 
    }
  }
}
80104d31:	83 c4 24             	add    $0x24,%esp
80104d34:	5b                   	pop    %ebx
80104d35:	5d                   	pop    %ebp
80104d36:	c3                   	ret    
...
80104d3a:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d3d:	c7 45 f0 d4 3d 11 80 	movl   $0x80113dd4,-0x10(%ebp)
80104d44:	e9 d9 00 00 00       	jmp    80104e22 <procdump+0xeb>
    if(p->state == UNUSED)
80104d49:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d4c:	8b 40 0c             	mov    0xc(%eax),%eax
80104d4f:	85 c0                	test   %eax,%eax
80104d51:	75 05                	jne    80104d58 <procdump+0x21>
      continue;
80104d53:	e9 c3 00 00 00       	jmp    80104e1b <procdump+0xe4>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104d58:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d5b:	8b 40 0c             	mov    0xc(%eax),%eax
80104d5e:	83 f8 05             	cmp    $0x5,%eax
80104d61:	77 23                	ja     80104d86 <procdump+0x4f>
80104d63:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d66:	8b 40 0c             	mov    0xc(%eax),%eax
80104d69:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104d70:	85 c0                	test   %eax,%eax
80104d72:	74 12                	je     80104d86 <procdump+0x4f>
      state = states[p->state];
80104d74:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d77:	8b 40 0c             	mov    0xc(%eax),%eax
80104d7a:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104d81:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104d84:	eb 07                	jmp    80104d8d <procdump+0x56>
    else
      state = "???";
80104d86:	c7 45 ec 54 88 10 80 	movl   $0x80108854,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104d8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d90:	8d 50 6c             	lea    0x6c(%eax),%edx
80104d93:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d96:	8b 40 10             	mov    0x10(%eax),%eax
80104d99:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104d9d:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104da0:	89 54 24 08          	mov    %edx,0x8(%esp)
80104da4:	89 44 24 04          	mov    %eax,0x4(%esp)
80104da8:	c7 04 24 58 88 10 80 	movl   $0x80108858,(%esp)
80104daf:	e8 14 b6 ff ff       	call   801003c8 <cprintf>
    if(p->state == SLEEPING){
80104db4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104db7:	8b 40 0c             	mov    0xc(%eax),%eax
80104dba:	83 f8 02             	cmp    $0x2,%eax
80104dbd:	75 50                	jne    80104e0f <procdump+0xd8>
...
80104dcb:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104dce:	89 54 24 04          	mov    %edx,0x4(%esp)
80104dd2:	89 04 24             	mov    %eax,(%esp)
80104dd5:	e8 8e 02 00 00       	call   80105068 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104dda:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104de1:	eb 1b                	jmp    80104dfe <procdump+0xc7>
        cprintf(" %p", pc[i]);
80104de3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104de6:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104dea:	89 44 24 04          	mov    %eax,0x4(%esp)
80104dee:	c7 04 24 61 88 10 80 	movl   $0x80108861,(%esp)
80104df5:	e8 ce b5 ff ff       	call   801003c8 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104dfa:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104dfe:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104e02:	7f 0b                	jg     80104e0f <procdump+0xd8>
80104e04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e07:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104e0b:	85 c0                	test   %eax,%eax
80104e0d:	75 d4                	jne    80104de3 <procdump+0xac>
    }
    cprintf("\n");
80104e0f:	c7 04 24 65 88 10 80 	movl   $0x80108865,(%esp)
80104e16:	e8 ad b5 ff ff       	call   801003c8 <cprintf>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e1b:	81 45 f0 84 00 00 00 	addl   $0x84,-0x10(%ebp)
80104e22:	81 7d f0 d4 5e 11 80 	cmpl   $0x80115ed4,-0x10(%ebp)
80104e29:	0f 82 1a ff ff ff    	jb     80104d49 <procdump+0x12>
  }
}
80104e2f:	c9                   	leave  
80104e30:	c3                   	ret    

80104e31 <initsleeplock>:
#include "spinlock.h"
#include "sleeplock.h"
...
80104e34:	83 ec 18             	sub    $0x18,%esp
  initlock(&lk->lk, "sleep lock");
80104e37:	8b 45 08             	mov    0x8(%ebp),%eax
80104e3a:	83 c0 04             	add    $0x4,%eax
80104e3d:	c7 44 24 04 91 88 10 	movl   $0x80108891,0x4(%esp)
80104e44:	80 
80104e45:	89 04 24             	mov    %eax,(%esp)
80104e48:	e8 47 01 00 00       	call   80104f94 <initlock>
  lk->name = name;
80104e4d:	8b 45 08             	mov    0x8(%ebp),%eax
80104e50:	8b 55 0c             	mov    0xc(%ebp),%edx
80104e53:	89 50 38             	mov    %edx,0x38(%eax)
  lk->locked = 0;
80104e56:	8b 45 08             	mov    0x8(%ebp),%eax
80104e59:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->pid = 0;
80104e5f:	8b 45 08             	mov    0x8(%ebp),%eax
80104e62:	c7 40 3c 00 00 00 00 	movl   $0x0,0x3c(%eax)
}
80104e69:	c9                   	leave  
80104e6a:	c3                   	ret    

80104e6b <acquiresleep>:
...
80104e74:	83 c0 04             	add    $0x4,%eax
80104e77:	89 04 24             	mov    %eax,(%esp)
80104e7a:	e8 36 01 00 00       	call   80104fb5 <acquire>
  while (lk->locked) {
80104e7f:	eb 15                	jmp    80104e96 <acquiresleep+0x2b>
    sleep(lk, &lk->lk);
80104e81:	8b 45 08             	mov    0x8(%ebp),%eax
80104e84:	83 c0 04             	add    $0x4,%eax
80104e87:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e8b:	8b 45 08             	mov    0x8(%ebp),%eax
80104e8e:	89 04 24             	mov    %eax,(%esp)
80104e91:	e8 63 fb ff ff       	call   801049f9 <sleep>
  while (lk->locked) {
80104e96:	8b 45 08             	mov    0x8(%ebp),%eax
80104e99:	8b 00                	mov    (%eax),%eax
80104e9b:	85 c0                	test   %eax,%eax
80104e9d:	75 e2                	jne    80104e81 <acquiresleep+0x16>
  }
  lk->locked = 1;
80104e9f:	8b 45 08             	mov    0x8(%ebp),%eax
80104ea2:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  lk->pid = myproc()->pid;
80104ea8:	e8 b4 f2 ff ff       	call   80104161 <myproc>
80104ead:	8b 50 10             	mov    0x10(%eax),%edx
80104eb0:	8b 45 08             	mov    0x8(%ebp),%eax
80104eb3:	89 50 3c             	mov    %edx,0x3c(%eax)
  release(&lk->lk);
80104eb6:	8b 45 08             	mov    0x8(%ebp),%eax
80104eb9:	83 c0 04             	add    $0x4,%eax
80104ebc:	89 04 24             	mov    %eax,(%esp)
80104ebf:	e8 59 01 00 00       	call   8010501d <release>
}
80104ec4:	c9                   	leave  
80104ec5:	c3                   	ret    

80104ec6 <releasesleep>:
...
80104f0c:	83 ec 24             	sub    $0x24,%esp
  int r;
...
80104f18:	e8 98 00 00 00       	call   80104fb5 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104f1d:	8b 45 08             	mov    0x8(%ebp),%eax
80104f20:	8b 00                	mov    (%eax),%eax
80104f22:	85 c0                	test   %eax,%eax
80104f24:	74 19                	je     80104f3f <holdingsleep+0x37>
80104f26:	8b 45 08             	mov    0x8(%ebp),%eax
80104f29:	8b 58 3c             	mov    0x3c(%eax),%ebx
80104f2c:	e8 30 f2 ff ff       	call   80104161 <myproc>
80104f31:	8b 40 10             	mov    0x10(%eax),%eax
80104f34:	39 c3                	cmp    %eax,%ebx
80104f36:	75 07                	jne    80104f3f <holdingsleep+0x37>
80104f38:	b8 01 00 00 00       	mov    $0x1,%eax
80104f3d:	eb 05                	jmp    80104f44 <holdingsleep+0x3c>
...
80104f50:	e8 c8 00 00 00       	call   8010501d <release>
  return r;
80104f55:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
80104f58:	83 c4 24             	add    $0x24,%esp
80104f5b:	5b                   	pop    %ebx
80104f5c:	5d                   	pop    %ebp
80104f5d:	c3                   	ret    
...
80104f61:	83 ec 10             	sub    $0x10,%esp
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80104f64:	9c                   	pushf  
80104f65:	58                   	pop    %eax
...
80104f7d:	83 ec 10             	sub    $0x10,%esp
  asm volatile("lock; xchgl %0, %1" :
80104f80:	8b 55 08             	mov    0x8(%ebp),%edx
80104f83:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f86:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104f89:	f0 87 02             	lock xchg %eax,(%edx)
...
80104fb9:	83 ec 14             	sub    $0x14,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80104fbc:	e8 61 01 00 00       	call   80105122 <pushcli>
  if(holding(lk))
80104fc1:	8b 45 08             	mov    0x8(%ebp),%eax
80104fc4:	89 04 24             	mov    %eax,(%esp)
80104fc7:	e8 15 01 00 00       	call   801050e1 <holding>
80104fcc:	85 c0                	test   %eax,%eax
80104fce:	74 0c                	je     80104fdc <acquire+0x27>
    panic("acquire");
80104fd0:	c7 04 24 9c 88 10 80 	movl   $0x8010889c,(%esp)
80104fd7:	e8 86 b5 ff ff       	call   80100562 <panic>

  // The xchg is atomic.
  while(xchg(&lk->locked, 1) != 0)
80104fdc:	90                   	nop
80104fdd:	8b 45 08             	mov    0x8(%ebp),%eax
80104fe0:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104fe7:	00 
80104fe8:	89 04 24             	mov    %eax,(%esp)
80104feb:	e8 8a ff ff ff       	call   80104f7a <xchg>
80104ff0:	85 c0                	test   %eax,%eax
80104ff2:	75 e9                	jne    80104fdd <acquire+0x28>
    ;
  ...
  __sync_synchronize();
80104ff4:	0f ae f0             	mfence 

  // Record info about lock acquisition for debugging.
  lk->cpu = mycpu();
80104ff7:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104ffa:	e8 ec f0 ff ff       	call   801040eb <mycpu>
80104fff:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
80105002:	8b 45 08             	mov    0x8(%ebp),%eax
80105005:	83 c0 0c             	add    $0xc,%eax
80105008:	89 44 24 04          	mov    %eax,0x4(%esp)
8010500c:	8d 45 08             	lea    0x8(%ebp),%eax
8010500f:	89 04 24             	mov    %eax,(%esp)
80105012:	e8 51 00 00 00       	call   80105068 <getcallerpcs>
}
80105017:	83 c4 14             	add    $0x14,%esp
8010501a:	5b                   	pop    %ebx
8010501b:	5d                   	pop    %ebp
8010501c:	c3                   	ret    
...
80105029:	e8 b3 00 00 00       	call   801050e1 <holding>
8010502e:	85 c0                	test   %eax,%eax
80105030:	75 0c                	jne    8010503e <release+0x21>
    panic("release");
80105032:	c7 04 24 a4 88 10 80 	movl   $0x801088a4,(%esp)
80105039:	e8 24 b5 ff ff       	call   80100562 <panic>

  lk->pcs[0] = 0;
8010503e:	8b 45 08             	mov    0x8(%ebp),%eax
80105041:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
...
8010505b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)

  popcli();
80105061:	e8 08 01 00 00       	call   8010516e <popcli>
}
80105066:	c9                   	leave  
80105067:	c3                   	ret    

80105068 <getcallerpcs>:
...
80105071:	83 e8 08             	sub    $0x8,%eax
80105074:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80105077:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
8010507e:	eb 38                	jmp    801050b8 <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105080:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105084:	74 38                	je     801050be <getcallerpcs+0x56>
80105086:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
8010508d:	76 2f                	jbe    801050be <getcallerpcs+0x56>
8010508f:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105093:	74 29                	je     801050be <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105095:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105098:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010509f:	8b 45 0c             	mov    0xc(%ebp),%eax
801050a2:	01 c2                	add    %eax,%edx
...
801050b1:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
801050b4:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801050b8:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801050bc:	7e c2                	jle    80105080 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
801050be:	eb 19                	jmp    801050d9 <getcallerpcs+0x71>
    pcs[i] = 0;
801050c0:	8b 45 f8             	mov    -0x8(%ebp),%eax
801050c3:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801050ca:	8b 45 0c             	mov    0xc(%ebp),%eax
801050cd:	01 d0                	add    %edx,%eax
801050cf:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801050d5:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801050d9:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801050dd:	7e e1                	jle    801050c0 <getcallerpcs+0x58>
}
801050df:	c9                   	leave  
801050e0:	c3                   	ret    
...
801050e5:	83 ec 14             	sub    $0x14,%esp
  int r;
  pushcli();
801050e8:	e8 35 00 00 00       	call   80105122 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801050ed:	8b 45 08             	mov    0x8(%ebp),%eax
801050f0:	8b 00                	mov    (%eax),%eax
801050f2:	85 c0                	test   %eax,%eax
801050f4:	74 16                	je     8010510c <holding+0x2b>
801050f6:	8b 45 08             	mov    0x8(%ebp),%eax
801050f9:	8b 58 08             	mov    0x8(%eax),%ebx
801050fc:	e8 ea ef ff ff       	call   801040eb <mycpu>
80105101:	39 c3                	cmp    %eax,%ebx
80105103:	75 07                	jne    8010510c <holding+0x2b>
80105105:	b8 01 00 00 00       	mov    $0x1,%eax
8010510a:	eb 05                	jmp    80105111 <holding+0x30>
8010510c:	b8 00 00 00 00       	mov    $0x0,%eax
80105111:	89 45 f4             	mov    %eax,-0xc(%ebp)
  popcli();
80105114:	e8 55 00 00 00       	call   8010516e <popcli>
  return r;
...
80105125:	83 ec 18             	sub    $0x18,%esp
  ...
  eflags = readeflags();
80105128:	e8 31 fe ff ff       	call   80104f5e <readeflags>
8010512d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  cli();
80105130:	e8 39 fe ff ff       	call   80104f6e <cli>
  if(mycpu()->ncli == 0)
80105135:	e8 b1 ef ff ff       	call   801040eb <mycpu>
8010513a:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80105140:	85 c0                	test   %eax,%eax
80105142:	75 14                	jne    80105158 <pushcli+0x36>
    mycpu()->intena = eflags & FL_IF;
80105144:	e8 a2 ef ff ff       	call   801040eb <mycpu>
80105149:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010514c:	81 e2 00 02 00 00    	and    $0x200,%edx
80105152:	89 90 a8 00 00 00    	mov    %edx,0xa8(%eax)
  mycpu()->ncli += 1;
80105158:	e8 8e ef ff ff       	call   801040eb <mycpu>
8010515d:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80105163:	83 c2 01             	add    $0x1,%edx
80105166:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
}
8010516c:	c9                   	leave  
8010516d:	c3                   	ret    
...
80105171:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105174:	e8 e5 fd ff ff       	call   80104f5e <readeflags>
80105179:	25 00 02 00 00       	and    $0x200,%eax
8010517e:	85 c0                	test   %eax,%eax
80105180:	74 0c                	je     8010518e <popcli+0x20>
    panic("popcli - interruptible");
80105182:	c7 04 24 ac 88 10 80 	movl   $0x801088ac,(%esp)
80105189:	e8 d4 b3 ff ff       	call   80100562 <panic>
  if(--mycpu()->ncli < 0)
8010518e:	e8 58 ef ff ff       	call   801040eb <mycpu>
80105193:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80105199:	83 ea 01             	sub    $0x1,%edx
8010519c:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
801051a2:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801051a8:	85 c0                	test   %eax,%eax
801051aa:	79 0c                	jns    801051b8 <popcli+0x4a>
    panic("popcli");
801051ac:	c7 04 24 c3 88 10 80 	movl   $0x801088c3,(%esp)
801051b3:	e8 aa b3 ff ff       	call   80100562 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
801051b8:	e8 2e ef ff ff       	call   801040eb <mycpu>
801051bd:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801051c3:	85 c0                	test   %eax,%eax
801051c5:	75 14                	jne    801051db <popcli+0x6d>
801051c7:	e8 1f ef ff ff       	call   801040eb <mycpu>
801051cc:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
801051d2:	85 c0                	test   %eax,%eax
801051d4:	74 05                	je     801051db <popcli+0x6d>
    sti();
801051d6:	e8 99 fd ff ff       	call   80104f74 <sti>
}
801051db:	c9                   	leave  
801051dc:	c3                   	ret    
...
801051e0:	57                   	push   %edi
801051e1:	53                   	push   %ebx
  asm volatile("cld; rep stosb" :
801051e2:	8b 4d 08             	mov    0x8(%ebp),%ecx
801051e5:	8b 55 10             	mov    0x10(%ebp),%edx
801051e8:	8b 45 0c             	mov    0xc(%ebp),%eax
801051eb:	89 cb                	mov    %ecx,%ebx
801051ed:	89 df                	mov    %ebx,%edi
801051ef:	89 d1                	mov    %edx,%ecx
801051f1:	fc                   	cld    
801051f2:	f3 aa                	rep stos %al,%es:(%edi)
801051f4:	89 ca                	mov    %ecx,%edx
801051f6:	89 fb                	mov    %edi,%ebx
801051f8:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
8010520a:	8b 55 10             	mov    0x10(%ebp),%edx
8010520d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105210:	89 cb                	mov    %ecx,%ebx
80105212:	89 df                	mov    %ebx,%edi
80105214:	89 d1                	mov    %edx,%ecx
80105216:	fc                   	cld    
80105217:	f3 ab                	rep stos %eax,%es:(%edi)
80105219:	89 ca                	mov    %ecx,%edx
8010521b:	89 fb                	mov    %edi,%ebx
8010521d:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80105230:	83 e0 03             	and    $0x3,%eax
80105233:	85 c0                	test   %eax,%eax
80105235:	75 49                	jne    80105280 <memset+0x59>
80105237:	8b 45 10             	mov    0x10(%ebp),%eax
8010523a:	83 e0 03             	and    $0x3,%eax
8010523d:	85 c0                	test   %eax,%eax
8010523f:	75 3f                	jne    80105280 <memset+0x59>
    c &= 0xFF;
80105241:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105248:	8b 45 10             	mov    0x10(%ebp),%eax
8010524b:	c1 e8 02             	shr    $0x2,%eax
8010524e:	89 c2                	mov    %eax,%edx
80105250:	8b 45 0c             	mov    0xc(%ebp),%eax
80105253:	c1 e0 18             	shl    $0x18,%eax
80105256:	89 c1                	mov    %eax,%ecx
80105258:	8b 45 0c             	mov    0xc(%ebp),%eax
8010525b:	c1 e0 10             	shl    $0x10,%eax
8010525e:	09 c1                	or     %eax,%ecx
80105260:	8b 45 0c             	mov    0xc(%ebp),%eax
80105263:	c1 e0 08             	shl    $0x8,%eax
80105266:	09 c8                	or     %ecx,%eax
80105268:	0b 45 0c             	or     0xc(%ebp),%eax
8010526b:	89 54 24 08          	mov    %edx,0x8(%esp)
8010526f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105273:	8b 45 08             	mov    0x8(%ebp),%eax
80105276:	89 04 24             	mov    %eax,(%esp)
80105279:	e8 84 ff ff ff       	call   80105202 <stosl>
8010527e:	eb 19                	jmp    80105299 <memset+0x72>
  } else
    stosb(dst, c, n);
80105280:	8b 45 10             	mov    0x10(%ebp),%eax
80105283:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105294:	e8 44 ff ff ff       	call   801051dd <stosb>
  return dst;
...
801052ad:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801052b0:	eb 30                	jmp    801052e2 <memcmp+0x44>
    if(*s1 != *s2)
801052b2:	8b 45 fc             	mov    -0x4(%ebp),%eax
801052b5:	0f b6 10             	movzbl (%eax),%edx
801052b8:	8b 45 f8             	mov    -0x8(%ebp),%eax
801052bb:	0f b6 00             	movzbl (%eax),%eax
801052be:	38 c2                	cmp    %al,%dl
801052c0:	74 18                	je     801052da <memcmp+0x3c>
      return *s1 - *s2;
801052c2:	8b 45 fc             	mov    -0x4(%ebp),%eax
801052c5:	0f b6 00             	movzbl (%eax),%eax
801052c8:	0f b6 d0             	movzbl %al,%edx
...
801052d8:	eb 1a                	jmp    801052f4 <memcmp+0x56>
    s1++, s2++;
801052da:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801052de:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
  while(n-- > 0){
801052e2:	8b 45 10             	mov    0x10(%ebp),%eax
801052e5:	8d 50 ff             	lea    -0x1(%eax),%edx
801052e8:	89 55 10             	mov    %edx,0x10(%ebp)
801052eb:	85 c0                	test   %eax,%eax
801052ed:	75 c3                	jne    801052b2 <memcmp+0x14>
  }
...
80105305:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
80105308:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010530b:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010530e:	73 3d                	jae    8010534d <memmove+0x57>
80105310:	8b 45 10             	mov    0x10(%ebp),%eax
80105313:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105316:	01 d0                	add    %edx,%eax
80105318:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010531b:	76 30                	jbe    8010534d <memmove+0x57>
    s += n;
8010531d:	8b 45 10             	mov    0x10(%ebp),%eax
80105320:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105323:	8b 45 10             	mov    0x10(%ebp),%eax
80105326:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105329:	eb 13                	jmp    8010533e <memmove+0x48>
      *--d = *--s;
8010532b:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010532f:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
...
80105341:	8d 50 ff             	lea    -0x1(%eax),%edx
80105344:	89 55 10             	mov    %edx,0x10(%ebp)
80105347:	85 c0                	test   %eax,%eax
80105349:	75 e0                	jne    8010532b <memmove+0x35>
  if(s < d && s + n > d){
8010534b:	eb 26                	jmp    80105373 <memmove+0x7d>
  } else
    while(n-- > 0)
8010534d:	eb 17                	jmp    80105366 <memmove+0x70>
      *d++ = *s++;
8010534f:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105352:	8d 50 01             	lea    0x1(%eax),%edx
80105355:	89 55 f8             	mov    %edx,-0x8(%ebp)
80105358:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010535b:	8d 4a 01             	lea    0x1(%edx),%ecx
8010535e:	89 4d fc             	mov    %ecx,-0x4(%ebp)
80105361:	0f b6 12             	movzbl (%edx),%edx
80105364:	88 10                	mov    %dl,(%eax)
    while(n-- > 0)
80105366:	8b 45 10             	mov    0x10(%ebp),%eax
80105369:	8d 50 ff             	lea    -0x1(%eax),%edx
8010536c:	89 55 10             	mov    %edx,0x10(%ebp)
8010536f:	85 c0                	test   %eax,%eax
80105371:	75 dc                	jne    8010534f <memmove+0x59>
...
80105388:	89 44 24 04          	mov    %eax,0x4(%esp)
8010538c:	8b 45 08             	mov    0x8(%ebp),%eax
8010538f:	89 04 24             	mov    %eax,(%esp)
80105392:	e8 5f ff ff ff       	call   801052f6 <memmove>
}
80105397:	c9                   	leave  
80105398:	c3                   	ret    
...
8010539a:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
8010539c:	eb 0c                	jmp    801053aa <strncmp+0x11>
    n--, p++, q++;
8010539e:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801053a2:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801053a6:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
  while(n > 0 && *p && *p == *q)
801053aa:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801053ae:	74 1a                	je     801053ca <strncmp+0x31>
801053b0:	8b 45 08             	mov    0x8(%ebp),%eax
801053b3:	0f b6 00             	movzbl (%eax),%eax
801053b6:	84 c0                	test   %al,%al
801053b8:	74 10                	je     801053ca <strncmp+0x31>
...
801053c6:	38 c2                	cmp    %al,%dl
801053c8:	74 d4                	je     8010539e <strncmp+0x5>
  if(n == 0)
801053ca:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801053ce:	75 07                	jne    801053d7 <strncmp+0x3e>
    return 0;
801053d0:	b8 00 00 00 00       	mov    $0x0,%eax
801053d5:	eb 16                	jmp    801053ed <strncmp+0x54>
...
80105407:	7e 1e                	jle    80105427 <strncpy+0x38>
...
80105425:	75 d5                	jne    801053fc <strncpy+0xd>
    ;
  while(n-- > 0)
80105427:	eb 0c                	jmp    80105435 <strncpy+0x46>
    *s++ = 0;
80105429:	8b 45 08             	mov    0x8(%ebp),%eax
8010542c:	8d 50 01             	lea    0x1(%eax),%edx
8010542f:	89 55 08             	mov    %edx,0x8(%ebp)
80105432:	c6 00 00             	movb   $0x0,(%eax)
  while(n-- > 0)
...
80105440:	7f e7                	jg     80105429 <strncpy+0x3a>
  return os;
...
80105450:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80105453:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105457:	7f 05                	jg     8010545e <safestrcpy+0x17>
    return os;
80105459:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010545c:	eb 31                	jmp    8010548f <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
8010545e:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105462:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105466:	7e 1e                	jle    80105486 <safestrcpy+0x3f>
80105468:	8b 45 08             	mov    0x8(%ebp),%eax
8010546b:	8d 50 01             	lea    0x1(%eax),%edx
8010546e:	89 55 08             	mov    %edx,0x8(%ebp)
80105471:	8b 55 0c             	mov    0xc(%ebp),%edx
80105474:	8d 4a 01             	lea    0x1(%edx),%ecx
80105477:	89 4d 0c             	mov    %ecx,0xc(%ebp)
8010547a:	0f b6 12             	movzbl (%edx),%edx
8010547d:	88 10                	mov    %dl,(%eax)
8010547f:	0f b6 00             	movzbl (%eax),%eax
80105482:	84 c0                	test   %al,%al
80105484:	75 d8                	jne    8010545e <safestrcpy+0x17>
    ;
  *s = 0;
80105486:	8b 45 08             	mov    0x8(%ebp),%eax
80105489:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
8010549e:	eb 04                	jmp    801054a4 <strlen+0x13>
801054a0:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
801054b1:	75 ed                	jne    801054a0 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801054b8:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801054bc:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801054c3:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801054c4:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801054c6:	89 d4                	mov    %edx,%esp
...
801054d0:	83 ec 18             	sub    $0x18,%esp
  struct proc *curproc = myproc();
801054d3:	e8 89 ec ff ff       	call   80104161 <myproc>
...
801054e3:	76 0f                	jbe    801054f4 <fetchint+0x27>
...
801054f0:	39 c2                	cmp    %eax,%edx
801054f2:	76 07                	jbe    801054fb <fetchint+0x2e>
    return -1;
801054f4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054f9:	eb 0f                	jmp    8010550a <fetchint+0x3d>
  *ip = *(int*)(addr);
801054fb:	8b 45 08             	mov    0x8(%ebp),%eax
801054fe:	8b 10                	mov    (%eax),%edx
80105500:	8b 45 0c             	mov    0xc(%ebp),%eax
80105503:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105576:	e8 e6 eb ff ff       	call   80104161 <myproc>
8010557b:	8b 40 18             	mov    0x18(%eax),%eax
8010557e:	8b 50 44             	mov    0x44(%eax),%edx
80105581:	8b 45 08             	mov    0x8(%ebp),%eax
80105584:	c1 e0 02             	shl    $0x2,%eax
80105587:	01 d0                	add    %edx,%eax
...
80105596:	e8 32 ff ff ff       	call   801054cd <fetchint>
}
8010559b:	c9                   	leave  
8010559c:	c3                   	ret    
...
801055a0:	83 ec 28             	sub    $0x28,%esp
  int i;
  struct proc *curproc = myproc();
801055a3:	e8 b9 eb ff ff       	call   80104161 <myproc>
...
8010560a:	83 ec 28             	sub    $0x28,%esp
  int addr;
  if(argint(n, &addr) < 0)
...
8010561a:	e8 51 ff ff ff       	call   80105570 <argint>
8010561f:	85 c0                	test   %eax,%eax
80105621:	79 07                	jns    8010562a <argstr+0x23>
    return -1;
80105623:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105628:	eb 12                	jmp    8010563c <argstr+0x35>
  return fetchstr(addr, pp);
8010562a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010562d:	8b 55 0c             	mov    0xc(%ebp),%edx
80105630:	89 54 24 04          	mov    %edx,0x4(%esp)
80105634:	89 04 24             	mov    %eax,(%esp)
80105637:	e8 d0 fe ff ff       	call   8010550c <fetchstr>
}
8010563c:	c9                   	leave  
8010563d:	c3                   	ret    
...
80105642:	83 ec 24             	sub    $0x24,%esp
  int num;
  struct proc *curproc = myproc();
80105645:	e8 17 eb ff ff       	call   80104161 <myproc>
8010564a:	89 45 f4             	mov    %eax,-0xc(%ebp)

  num = curproc->tf->eax;
8010564d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105650:	8b 40 18             	mov    0x18(%eax),%eax
80105653:	8b 40 1c             	mov    0x1c(%eax),%eax
80105656:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105659:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010565d:	7e 2d                	jle    8010568c <syscall+0x4e>
8010565f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105662:	83 f8 16             	cmp    $0x16,%eax
80105665:	77 25                	ja     8010568c <syscall+0x4e>
80105667:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010566a:	8b 04 85 20 b0 10 80 	mov    -0x7fef4fe0(,%eax,4),%eax
80105671:	85 c0                	test   %eax,%eax
80105673:	74 17                	je     8010568c <syscall+0x4e>
    curproc->tf->eax = syscalls[num]();
80105675:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105678:	8b 58 18             	mov    0x18(%eax),%ebx
8010567b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010567e:	8b 04 85 20 b0 10 80 	mov    -0x7fef4fe0(,%eax,4),%eax
80105685:	ff d0                	call   *%eax
80105687:	89 43 1c             	mov    %eax,0x1c(%ebx)
8010568a:	eb 34                	jmp    801056c0 <syscall+0x82>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
8010568c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010568f:	8d 48 6c             	lea    0x6c(%eax),%ecx
    cprintf("%d %s: unknown sys call %d\n",
...
801056a7:	c7 04 24 ca 88 10 80 	movl   $0x801088ca,(%esp)
801056ae:	e8 15 ad ff ff       	call   801003c8 <cprintf>
    curproc->tf->eax = -1;
...
801056d9:	e8 92 fe ff ff       	call   80105570 <argint>
801056de:	85 c0                	test   %eax,%eax
801056e0:	79 07                	jns    801056e9 <argfd+0x23>
    return -1;
801056e2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056e7:	eb 4f                	jmp    80105738 <argfd+0x72>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801056e9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056ec:	85 c0                	test   %eax,%eax
801056ee:	78 20                	js     80105710 <argfd+0x4a>
801056f0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056f3:	83 f8 0f             	cmp    $0xf,%eax
801056f6:	7f 18                	jg     80105710 <argfd+0x4a>
801056f8:	e8 64 ea ff ff       	call   80104161 <myproc>
801056fd:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105700:	83 c2 08             	add    $0x8,%edx
80105703:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105707:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010570a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010570e:	75 07                	jne    80105717 <argfd+0x51>
    return -1;
80105710:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105715:	eb 21                	jmp    80105738 <argfd+0x72>
  if(pfd)
80105717:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
8010571b:	74 08                	je     80105725 <argfd+0x5f>
    *pfd = fd;
...
80105729:	74 08                	je     80105733 <argfd+0x6d>
    *pf = f;
8010572b:	8b 45 10             	mov    0x10(%ebp),%eax
8010572e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105731:	89 10                	mov    %edx,(%eax)
  return 0;
80105733:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105738:	c9                   	leave  
80105739:	c3                   	ret    
...
8010573d:	83 ec 18             	sub    $0x18,%esp
  int fd;
  struct proc *curproc = myproc();
80105740:	e8 1c ea ff ff       	call   80104161 <myproc>
80105745:	89 45 f0             	mov    %eax,-0x10(%ebp)

  for(fd = 0; fd < NOFILE; fd++){
80105748:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010574f:	eb 2a                	jmp    8010577b <fdalloc+0x41>
    if(curproc->ofile[fd] == 0){
80105751:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105754:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105757:	83 c2 08             	add    $0x8,%edx
8010575a:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010575e:	85 c0                	test   %eax,%eax
80105760:	75 15                	jne    80105777 <fdalloc+0x3d>
      curproc->ofile[fd] = f;
...
80105775:	eb 0f                	jmp    80105786 <fdalloc+0x4c>
  for(fd = 0; fd < NOFILE; fd++){
80105777:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010577b:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
8010577f:	7e d0                	jle    80105751 <fdalloc+0x17>
    }
  }
  return -1;
...
801057a4:	e8 1d ff ff ff       	call   801056c6 <argfd>
...
801057ba:	e8 7b ff ff ff       	call   8010573a <fdalloc>
...
801057d5:	e8 0b b8 ff ff       	call   80100fe5 <filedup>
  return fd;
...
801057fb:	e8 c6 fe ff ff       	call   801056c6 <argfd>
...
80105812:	e8 59 fd ff ff       	call   80105570 <argint>
...
80105830:	e8 68 fd ff ff       	call   8010559d <argptr>
...
80105854:	e8 f9 b8 ff ff       	call   80101152 <fileread>
}
80105859:	c9                   	leave  
8010585a:	c3                   	ret    
...
80105877:	e8 4a fe ff ff       	call   801056c6 <argfd>
...
8010588e:	e8 dd fc ff ff       	call   80105570 <argint>
...
801058ac:	e8 ec fc ff ff       	call   8010559d <argptr>
...
801058d0:	e8 39 b9 ff ff       	call   8010120e <filewrite>
}
801058d5:	c9                   	leave  
801058d6:	c3                   	ret    
...
801058f2:	e8 cf fd ff ff       	call   801056c6 <argfd>
801058f7:	85 c0                	test   %eax,%eax
801058f9:	79 07                	jns    80105902 <sys_close+0x2b>
    return -1;
801058fb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105900:	eb 23                	jmp    80105925 <sys_close+0x4e>
  myproc()->ofile[fd] = 0;
80105902:	e8 5a e8 ff ff       	call   80104161 <myproc>
...
8010591b:	e8 0d b7 ff ff       	call   8010102d <fileclose>
  return 0;
...
8010592a:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;

  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
8010592d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105930:	89 44 24 08          	mov    %eax,0x8(%esp)
80105934:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010593b:	00 
8010593c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105943:	e8 7e fd ff ff       	call   801056c6 <argfd>
80105948:	85 c0                	test   %eax,%eax
8010594a:	78 1f                	js     8010596b <sys_fstat+0x44>
8010594c:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105953:	00 
80105954:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105957:	89 44 24 04          	mov    %eax,0x4(%esp)
8010595b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105962:	e8 36 fc ff ff       	call   8010559d <argptr>
80105967:	85 c0                	test   %eax,%eax
80105969:	79 07                	jns    80105972 <sys_fstat+0x4b>
    return -1;
8010596b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105970:	eb 12                	jmp    80105984 <sys_fstat+0x5d>
...
8010597f:	e8 7f b7 ff ff       	call   80101103 <filestat>
}
80105984:	c9                   	leave  
80105985:	c3                   	ret    
...
80105989:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
8010598c:	8d 45 d8             	lea    -0x28(%ebp),%eax
8010598f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105993:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010599a:	e8 68 fc ff ff       	call   80105607 <argstr>
8010599f:	85 c0                	test   %eax,%eax
801059a1:	78 17                	js     801059ba <sys_link+0x34>
801059a3:	8d 45 dc             	lea    -0x24(%ebp),%eax
801059a6:	89 44 24 04          	mov    %eax,0x4(%esp)
801059aa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801059b1:	e8 51 fc ff ff       	call   80105607 <argstr>
801059b6:	85 c0                	test   %eax,%eax
801059b8:	79 0a                	jns    801059c4 <sys_link+0x3e>
    return -1;
801059ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059bf:	e9 42 01 00 00       	jmp    80105b06 <sys_link+0x180>

  begin_op();
801059c4:	e8 be da ff ff       	call   80103487 <begin_op>
  if((ip = namei(old)) == 0){
801059c9:	8b 45 d8             	mov    -0x28(%ebp),%eax
801059cc:	89 04 24             	mov    %eax,(%esp)
801059cf:	e8 c3 ca ff ff       	call   80102497 <namei>
801059d4:	89 45 f4             	mov    %eax,-0xc(%ebp)
801059d7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801059db:	75 0f                	jne    801059ec <sys_link+0x66>
    end_op();
801059dd:	e8 29 db ff ff       	call   8010350b <end_op>
    return -1;
801059e2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059e7:	e9 1a 01 00 00       	jmp    80105b06 <sys_link+0x180>
  }

  ilock(ip);
801059ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059ef:	89 04 24             	mov    %eax,(%esp)
801059f2:	e8 66 bf ff ff       	call   8010195d <ilock>
  if(ip->type == T_DIR){
801059f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059fa:	0f b7 40 50          	movzwl 0x50(%eax),%eax
801059fe:	66 83 f8 01          	cmp    $0x1,%ax
80105a02:	75 1a                	jne    80105a1e <sys_link+0x98>
    iunlockput(ip);
80105a04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a07:	89 04 24             	mov    %eax,(%esp)
80105a0a:	e8 50 c1 ff ff       	call   80101b5f <iunlockput>
    end_op();
80105a0f:	e8 f7 da ff ff       	call   8010350b <end_op>
    return -1;
80105a14:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a19:	e9 e8 00 00 00       	jmp    80105b06 <sys_link+0x180>
  }

  ip->nlink++;
80105a1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a21:	0f b7 40 56          	movzwl 0x56(%eax),%eax
...
80105b0e:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105b15:	eb 4b                	jmp    80105b62 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105b17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b1a:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105b21:	00 
80105b22:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105b33:	e8 c2 c2 ff ff       	call   80101dfa <readi>
80105b38:	83 f8 10             	cmp    $0x10,%eax
80105b3b:	74 0c                	je     80105b49 <isdirempty+0x41>
      panic("isdirempty: readi");
80105b3d:	c7 04 24 e6 88 10 80 	movl   $0x801088e6,(%esp)
80105b44:	e8 19 aa ff ff       	call   80100562 <panic>
    if(de.inum != 0)
80105b49:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105b4d:	66 85 c0             	test   %ax,%ax
80105b50:	74 07                	je     80105b59 <isdirempty+0x51>
      return 0;
80105b52:	b8 00 00 00 00       	mov    $0x0,%eax
80105b57:	eb 1b                	jmp    80105b74 <isdirempty+0x6c>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105b59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b5c:	83 c0 10             	add    $0x10,%eax
80105b5f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105b62:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105b65:	8b 45 08             	mov    0x8(%ebp),%eax
80105b68:	8b 40 58             	mov    0x58(%eax),%eax
80105b6b:	39 c2                	cmp    %eax,%edx
80105b6d:	72 a8                	jb     80105b17 <isdirempty+0xf>
  }
  return 1;
...
80105b79:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105b7c:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105b7f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b83:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105b8a:	e8 78 fa ff ff       	call   80105607 <argstr>
80105b8f:	85 c0                	test   %eax,%eax
80105b91:	79 0a                	jns    80105b9d <sys_unlink+0x27>
    return -1;
80105b93:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b98:	e9 af 01 00 00       	jmp    80105d4c <sys_unlink+0x1d6>

  begin_op();
80105b9d:	e8 e5 d8 ff ff       	call   80103487 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105ba2:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105ba5:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105ba8:	89 54 24 04          	mov    %edx,0x4(%esp)
80105bac:	89 04 24             	mov    %eax,(%esp)
80105baf:	e8 05 c9 ff ff       	call   801024b9 <nameiparent>
80105bb4:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105bb7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105bbb:	75 0f                	jne    80105bcc <sys_unlink+0x56>
    end_op();
80105bbd:	e8 49 d9 ff ff       	call   8010350b <end_op>
    return -1;
80105bc2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bc7:	e9 80 01 00 00       	jmp    80105d4c <sys_unlink+0x1d6>
  }

  ilock(dp);
80105bcc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bcf:	89 04 24             	mov    %eax,(%esp)
80105bd2:	e8 86 bd ff ff       	call   8010195d <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105bd7:	c7 44 24 04 f8 88 10 	movl   $0x801088f8,0x4(%esp)
80105bde:	80 
80105bdf:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105be2:	89 04 24             	mov    %eax,(%esp)
80105be5:	e8 03 c5 ff ff       	call   801020ed <namecmp>
80105bea:	85 c0                	test   %eax,%eax
80105bec:	0f 84 45 01 00 00    	je     80105d37 <sys_unlink+0x1c1>
...
80105c07:	0f 84 2a 01 00 00    	je     80105d37 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105c0d:	8d 45 c8             	lea    -0x38(%ebp),%eax
...
80105c21:	e8 e9 c4 ff ff       	call   8010210f <dirlookup>
80105c26:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c29:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c2d:	75 05                	jne    80105c34 <sys_unlink+0xbe>
    goto bad;
80105c2f:	e9 03 01 00 00       	jmp    80105d37 <sys_unlink+0x1c1>
  ilock(ip);
80105c34:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c37:	89 04 24             	mov    %eax,(%esp)
80105c3a:	e8 1e bd ff ff       	call   8010195d <ilock>

  if(ip->nlink < 1)
80105c3f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c42:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105c46:	66 85 c0             	test   %ax,%ax
80105c49:	7f 0c                	jg     80105c57 <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105c4b:	c7 04 24 fd 88 10 80 	movl   $0x801088fd,(%esp)
80105c52:	e8 0b a9 ff ff       	call   80100562 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105c57:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c5a:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105c5e:	66 83 f8 01          	cmp    $0x1,%ax
80105c62:	75 1f                	jne    80105c83 <sys_unlink+0x10d>
80105c64:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c67:	89 04 24             	mov    %eax,(%esp)
80105c6a:	e8 99 fe ff ff       	call   80105b08 <isdirempty>
80105c6f:	85 c0                	test   %eax,%eax
80105c71:	75 10                	jne    80105c83 <sys_unlink+0x10d>
    iunlockput(ip);
80105c73:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c76:	89 04 24             	mov    %eax,(%esp)
80105c79:	e8 e1 be ff ff       	call   80101b5f <iunlockput>
    goto bad;
80105c7e:	e9 b4 00 00 00       	jmp    80105d37 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105c83:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105c8a:	00 
80105c8b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105c92:	00 
80105c93:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105c96:	89 04 24             	mov    %eax,(%esp)
80105c99:	e8 89 f5 ff ff       	call   80105227 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105c9e:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105ca1:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105ca8:	00 
80105ca9:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cad:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105cb0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cb4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cb7:	89 04 24             	mov    %eax,(%esp)
80105cba:	e8 9f c2 ff ff       	call   80101f5e <writei>
80105cbf:	83 f8 10             	cmp    $0x10,%eax
80105cc2:	74 0c                	je     80105cd0 <sys_unlink+0x15a>
    panic("unlink: writei");
80105cc4:	c7 04 24 0f 89 10 80 	movl   $0x8010890f,(%esp)
80105ccb:	e8 92 a8 ff ff       	call   80100562 <panic>
  if(ip->type == T_DIR){
80105cd0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cd3:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105cd7:	66 83 f8 01          	cmp    $0x1,%ax
80105cdb:	75 1c                	jne    80105cf9 <sys_unlink+0x183>
    dp->nlink--;
80105cdd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ce0:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105ce4:	8d 50 ff             	lea    -0x1(%eax),%edx
80105ce7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cea:	66 89 50 56          	mov    %dx,0x56(%eax)
    iupdate(dp);
80105cee:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cf1:	89 04 24             	mov    %eax,(%esp)
80105cf4:	e8 9f ba ff ff       	call   80101798 <iupdate>
  }
  iunlockput(dp);
80105cf9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cfc:	89 04 24             	mov    %eax,(%esp)
80105cff:	e8 5b be ff ff       	call   80101b5f <iunlockput>

  ip->nlink--;
80105d04:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d07:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105d0b:	8d 50 ff             	lea    -0x1(%eax),%edx
80105d0e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d11:	66 89 50 56          	mov    %dx,0x56(%eax)
  iupdate(ip);
80105d15:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d18:	89 04 24             	mov    %eax,(%esp)
80105d1b:	e8 78 ba ff ff       	call   80101798 <iupdate>
  iunlockput(ip);
80105d20:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d23:	89 04 24             	mov    %eax,(%esp)
80105d26:	e8 34 be ff ff       	call   80101b5f <iunlockput>

  end_op();
80105d2b:	e8 db d7 ff ff       	call   8010350b <end_op>

  return 0;
80105d30:	b8 00 00 00 00       	mov    $0x0,%eax
80105d35:	eb 15                	jmp    80105d4c <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105d37:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d3a:	89 04 24             	mov    %eax,(%esp)
80105d3d:	e8 1d be ff ff       	call   80101b5f <iunlockput>
  end_op();
80105d42:	e8 c4 d7 ff ff       	call   8010350b <end_op>
  return -1;
...
80105d51:	83 ec 48             	sub    $0x48,%esp
80105d54:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105d57:	8b 55 10             	mov    0x10(%ebp),%edx
80105d5a:	8b 45 14             	mov    0x14(%ebp),%eax
80105d5d:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105d61:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105d65:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105d69:	8d 45 de             	lea    -0x22(%ebp),%eax
80105d6c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d70:	8b 45 08             	mov    0x8(%ebp),%eax
80105d73:	89 04 24             	mov    %eax,(%esp)
80105d76:	e8 3e c7 ff ff       	call   801024b9 <nameiparent>
80105d7b:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105d7e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105d82:	75 0a                	jne    80105d8e <create+0x40>
    return 0;
80105d84:	b8 00 00 00 00       	mov    $0x0,%eax
80105d89:	e9 7e 01 00 00       	jmp    80105f0c <create+0x1be>
  ilock(dp);
80105d8e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d91:	89 04 24             	mov    %eax,(%esp)
80105d94:	e8 c4 bb ff ff       	call   8010195d <ilock>
...
80105dad:	e8 5d c3 ff ff       	call   8010210f <dirlookup>
80105db2:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105db5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105db9:	74 47                	je     80105e02 <create+0xb4>
    iunlockput(dp);
80105dbb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dbe:	89 04 24             	mov    %eax,(%esp)
80105dc1:	e8 99 bd ff ff       	call   80101b5f <iunlockput>
    ilock(ip);
80105dc6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dc9:	89 04 24             	mov    %eax,(%esp)
80105dcc:	e8 8c bb ff ff       	call   8010195d <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105dd1:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105dd6:	75 15                	jne    80105ded <create+0x9f>
80105dd8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ddb:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105ddf:	66 83 f8 02          	cmp    $0x2,%ax
80105de3:	75 08                	jne    80105ded <create+0x9f>
      return ip;
80105de5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105de8:	e9 1f 01 00 00       	jmp    80105f0c <create+0x1be>
    iunlockput(ip);
...
80105dfd:	e9 0a 01 00 00       	jmp    80105f0c <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105e02:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105e06:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e09:	8b 00                	mov    (%eax),%eax
80105e0b:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e0f:	89 04 24             	mov    %eax,(%esp)
80105e12:	e8 ac b8 ff ff       	call   801016c3 <ialloc>
80105e17:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e1a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e1e:	75 0c                	jne    80105e2c <create+0xde>
    panic("create: ialloc");
80105e20:	c7 04 24 1e 89 10 80 	movl   $0x8010891e,(%esp)
80105e27:	e8 36 a7 ff ff       	call   80100562 <panic>

  ilock(ip);
80105e2c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e2f:	89 04 24             	mov    %eax,(%esp)
80105e32:	e8 26 bb ff ff       	call   8010195d <ilock>
  ip->major = major;
80105e37:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e3a:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105e3e:	66 89 50 52          	mov    %dx,0x52(%eax)
  ip->minor = minor;
80105e42:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e45:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105e49:	66 89 50 54          	mov    %dx,0x54(%eax)
  ip->nlink = 1;
80105e4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e50:	66 c7 40 56 01 00    	movw   $0x1,0x56(%eax)
  iupdate(ip);
80105e56:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e59:	89 04 24             	mov    %eax,(%esp)
80105e5c:	e8 37 b9 ff ff       	call   80101798 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105e61:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105e66:	75 6a                	jne    80105ed2 <create+0x184>
    dp->nlink++;  // for ".."
80105e68:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e6b:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105e6f:	8d 50 01             	lea    0x1(%eax),%edx
...
80105e7f:	e8 14 b9 ff ff       	call   80101798 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105e84:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e87:	8b 40 04             	mov    0x4(%eax),%eax
80105e8a:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e8e:	c7 44 24 04 f8 88 10 	movl   $0x801088f8,0x4(%esp)
80105e95:	80 
80105e96:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e99:	89 04 24             	mov    %eax,(%esp)
80105e9c:	e8 37 c3 ff ff       	call   801021d8 <dirlink>
80105ea1:	85 c0                	test   %eax,%eax
80105ea3:	78 21                	js     80105ec6 <create+0x178>
80105ea5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ea8:	8b 40 04             	mov    0x4(%eax),%eax
80105eab:	89 44 24 08          	mov    %eax,0x8(%esp)
80105eaf:	c7 44 24 04 fa 88 10 	movl   $0x801088fa,0x4(%esp)
80105eb6:	80 
80105eb7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eba:	89 04 24             	mov    %eax,(%esp)
80105ebd:	e8 16 c3 ff ff       	call   801021d8 <dirlink>
80105ec2:	85 c0                	test   %eax,%eax
80105ec4:	79 0c                	jns    80105ed2 <create+0x184>
      panic("create dots");
80105ec6:	c7 04 24 2d 89 10 80 	movl   $0x8010892d,(%esp)
...
80105ed8:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105ef0:	79 0c                	jns    80105efe <create+0x1b0>
    panic("create: dirlink");
80105ef2:	c7 04 24 39 89 10 80 	movl   $0x80108939,(%esp)
80105ef9:	e8 64 a6 ff ff       	call   80100562 <panic>

  iunlockput(dp);
80105efe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f01:	89 04 24             	mov    %eax,(%esp)
80105f04:	e8 56 bc ff ff       	call   80101b5f <iunlockput>
...
80105f11:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105f14:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105f17:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f1b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f22:	e8 e0 f6 ff ff       	call   80105607 <argstr>
80105f27:	85 c0                	test   %eax,%eax
80105f29:	78 17                	js     80105f42 <sys_open+0x34>
80105f2b:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105f2e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105f39:	e8 32 f6 ff ff       	call   80105570 <argint>
80105f3e:	85 c0                	test   %eax,%eax
80105f40:	79 0a                	jns    80105f4c <sys_open+0x3e>
    return -1;
80105f42:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f47:	e9 5c 01 00 00       	jmp    801060a8 <sys_open+0x19a>

  begin_op();
80105f4c:	e8 36 d5 ff ff       	call   80103487 <begin_op>

  if(omode & O_CREATE){
80105f51:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f54:	25 00 02 00 00       	and    $0x200,%eax
80105f59:	85 c0                	test   %eax,%eax
80105f5b:	74 3b                	je     80105f98 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80105f5d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105f60:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105f67:	00 
80105f68:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105f6f:	00 
80105f70:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105f77:	00 
80105f78:	89 04 24             	mov    %eax,(%esp)
80105f7b:	e8 ce fd ff ff       	call   80105d4e <create>
80105f80:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80105f83:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f87:	75 6b                	jne    80105ff4 <sys_open+0xe6>
      end_op();
80105f89:	e8 7d d5 ff ff       	call   8010350b <end_op>
      return -1;
80105f8e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f93:	e9 10 01 00 00       	jmp    801060a8 <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
80105f98:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105f9b:	89 04 24             	mov    %eax,(%esp)
80105f9e:	e8 f4 c4 ff ff       	call   80102497 <namei>
80105fa3:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105fa6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105faa:	75 0f                	jne    80105fbb <sys_open+0xad>
      end_op();
80105fac:	e8 5a d5 ff ff       	call   8010350b <end_op>
      return -1;
80105fb1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fb6:	e9 ed 00 00 00       	jmp    801060a8 <sys_open+0x19a>
    }
    ilock(ip);
80105fbb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fbe:	89 04 24             	mov    %eax,(%esp)
80105fc1:	e8 97 b9 ff ff       	call   8010195d <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105fc6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fc9:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105fcd:	66 83 f8 01          	cmp    $0x1,%ax
80105fd1:	75 21                	jne    80105ff4 <sys_open+0xe6>
80105fd3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fd6:	85 c0                	test   %eax,%eax
80105fd8:	74 1a                	je     80105ff4 <sys_open+0xe6>
      iunlockput(ip);
80105fda:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fdd:	89 04 24             	mov    %eax,(%esp)
80105fe0:	e8 7a bb ff ff       	call   80101b5f <iunlockput>
      end_op();
80105fe5:	e8 21 d5 ff ff       	call   8010350b <end_op>
      return -1;
80105fea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fef:	e9 b4 00 00 00       	jmp    801060a8 <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105ff4:	e8 8c af ff ff       	call   80100f85 <filealloc>
80105ff9:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ffc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106000:	74 14                	je     80106016 <sys_open+0x108>
80106002:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106005:	89 04 24             	mov    %eax,(%esp)
80106008:	e8 2d f7 ff ff       	call   8010573a <fdalloc>
8010600d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106010:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106014:	79 28                	jns    8010603e <sys_open+0x130>
    if(f)
80106016:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010601a:	74 0b                	je     80106027 <sys_open+0x119>
      fileclose(f);
8010601c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010601f:	89 04 24             	mov    %eax,(%esp)
80106022:	e8 06 b0 ff ff       	call   8010102d <fileclose>
    iunlockput(ip);
80106027:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010602a:	89 04 24             	mov    %eax,(%esp)
8010602d:	e8 2d bb ff ff       	call   80101b5f <iunlockput>
    end_op();
80106032:	e8 d4 d4 ff ff       	call   8010350b <end_op>
    return -1;
80106037:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010603c:	eb 6a                	jmp    801060a8 <sys_open+0x19a>
  }
  iunlock(ip);
8010603e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106041:	89 04 24             	mov    %eax,(%esp)
80106044:	e8 21 ba ff ff       	call   80101a6a <iunlock>
  end_op();
80106049:	e8 bd d4 ff ff       	call   8010350b <end_op>
...
80106085:	75 0a                	jne    80106091 <sys_open+0x183>
80106087:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010608a:	83 e0 02             	and    $0x2,%eax
8010608d:	85 c0                	test   %eax,%eax
8010608f:	74 07                	je     80106098 <sys_open+0x18a>
80106091:	b8 01 00 00 00       	mov    $0x1,%eax
80106096:	eb 05                	jmp    8010609d <sys_open+0x18f>
...
801060ad:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801060b0:	e8 d2 d3 ff ff       	call   80103487 <begin_op>
...
801060c3:	e8 3f f5 ff ff       	call   80105607 <argstr>
801060c8:	85 c0                	test   %eax,%eax
801060ca:	78 2c                	js     801060f8 <sys_mkdir+0x4e>
...
8010611e:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106121:	e8 61 d3 ff ff       	call   80103487 <begin_op>
  if((argstr(0, &path)) < 0 ||
80106126:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106129:	89 44 24 04          	mov    %eax,0x4(%esp)
8010612d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106134:	e8 ce f4 ff ff       	call   80105607 <argstr>
80106139:	85 c0                	test   %eax,%eax
8010613b:	78 5e                	js     8010619b <sys_mknod+0x80>
     argint(1, &major) < 0 ||
8010613d:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106140:	89 44 24 04          	mov    %eax,0x4(%esp)
80106144:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010614b:	e8 20 f4 ff ff       	call   80105570 <argint>
  if((argstr(0, &path)) < 0 ||
80106150:	85 c0                	test   %eax,%eax
80106152:	78 47                	js     8010619b <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
80106154:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106157:	89 44 24 04          	mov    %eax,0x4(%esp)
8010615b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106162:	e8 09 f4 ff ff       	call   80105570 <argint>
     argint(1, &major) < 0 ||
80106167:	85 c0                	test   %eax,%eax
80106169:	78 30                	js     8010619b <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
8010616b:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010616e:	0f bf c8             	movswl %ax,%ecx
80106171:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106174:	0f bf d0             	movswl %ax,%edx
80106177:	8b 45 f0             	mov    -0x10(%ebp),%eax
     argint(2, &minor) < 0 ||
8010617a:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010617e:	89 54 24 08          	mov    %edx,0x8(%esp)
80106182:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106189:	00 
8010618a:	89 04 24             	mov    %eax,(%esp)
8010618d:	e8 bc fb ff ff       	call   80105d4e <create>
80106192:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106195:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106199:	75 0c                	jne    801061a7 <sys_mknod+0x8c>
    end_op();
8010619b:	e8 6b d3 ff ff       	call   8010350b <end_op>
    return -1;
801061a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061a5:	eb 15                	jmp    801061bc <sys_mknod+0xa1>
  }
  iunlockput(ip);
801061a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061aa:	89 04 24             	mov    %eax,(%esp)
801061ad:	e8 ad b9 ff ff       	call   80101b5f <iunlockput>
  end_op();
801061b2:	e8 54 d3 ff ff       	call   8010350b <end_op>
  return 0;
...
801061c1:	83 ec 28             	sub    $0x28,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801061c4:	e8 98 df ff ff       	call   80104161 <myproc>
801061c9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  
  begin_op();
801061cc:	e8 b6 d2 ff ff       	call   80103487 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
801061d1:	8d 45 ec             	lea    -0x14(%ebp),%eax
801061d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801061d8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061df:	e8 23 f4 ff ff       	call   80105607 <argstr>
801061e4:	85 c0                	test   %eax,%eax
801061e6:	78 14                	js     801061fc <sys_chdir+0x3e>
801061e8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801061eb:	89 04 24             	mov    %eax,(%esp)
801061ee:	e8 a4 c2 ff ff       	call   80102497 <namei>
801061f3:	89 45 f0             	mov    %eax,-0x10(%ebp)
801061f6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801061fa:	75 0c                	jne    80106208 <sys_chdir+0x4a>
    end_op();
801061fc:	e8 0a d3 ff ff       	call   8010350b <end_op>
    return -1;
80106201:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106206:	eb 5b                	jmp    80106263 <sys_chdir+0xa5>
  }
  ilock(ip);
80106208:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010620b:	89 04 24             	mov    %eax,(%esp)
8010620e:	e8 4a b7 ff ff       	call   8010195d <ilock>
  if(ip->type != T_DIR){
80106213:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106216:	0f b7 40 50          	movzwl 0x50(%eax),%eax
8010621a:	66 83 f8 01          	cmp    $0x1,%ax
8010621e:	74 17                	je     80106237 <sys_chdir+0x79>
    iunlockput(ip);
80106220:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106223:	89 04 24             	mov    %eax,(%esp)
80106226:	e8 34 b9 ff ff       	call   80101b5f <iunlockput>
    end_op();
8010622b:	e8 db d2 ff ff       	call   8010350b <end_op>
    return -1;
80106230:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106235:	eb 2c                	jmp    80106263 <sys_chdir+0xa5>
  }
  iunlock(ip);
80106237:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010623a:	89 04 24             	mov    %eax,(%esp)
8010623d:	e8 28 b8 ff ff       	call   80101a6a <iunlock>
  iput(curproc->cwd);
80106242:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106245:	8b 40 68             	mov    0x68(%eax),%eax
80106248:	89 04 24             	mov    %eax,(%esp)
8010624b:	e8 5e b8 ff ff       	call   80101aae <iput>
  end_op();
80106250:	e8 b6 d2 ff ff       	call   8010350b <end_op>
  curproc->cwd = ip;
80106255:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106258:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010625b:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
80106268:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
8010627c:	e8 86 f3 ff ff       	call   80105607 <argstr>
80106281:	85 c0                	test   %eax,%eax
80106283:	78 1a                	js     8010629f <sys_exec+0x3a>
80106285:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
8010628b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010628f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106296:	e8 d5 f2 ff ff       	call   80105570 <argint>
8010629b:	85 c0                	test   %eax,%eax
8010629d:	79 0a                	jns    801062a9 <sys_exec+0x44>
    return -1;
8010629f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062a4:	e9 c8 00 00 00       	jmp    80106371 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
801062a9:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801062b0:	00 
801062b1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801062b8:	00 
801062b9:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801062bf:	89 04 24             	mov    %eax,(%esp)
801062c2:	e8 60 ef ff ff       	call   80105227 <memset>
  for(i=0;; i++){
801062c7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801062ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062d1:	83 f8 1f             	cmp    $0x1f,%eax
801062d4:	76 0a                	jbe    801062e0 <sys_exec+0x7b>
      return -1;
801062d6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062db:	e9 91 00 00 00       	jmp    80106371 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801062e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062e3:	c1 e0 02             	shl    $0x2,%eax
801062e6:	89 c2                	mov    %eax,%edx
801062e8:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801062ee:	01 c2                	add    %eax,%edx
801062f0:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
801062f6:	89 44 24 04          	mov    %eax,0x4(%esp)
801062fa:	89 14 24             	mov    %edx,(%esp)
801062fd:	e8 cb f1 ff ff       	call   801054cd <fetchint>
80106302:	85 c0                	test   %eax,%eax
80106304:	79 07                	jns    8010630d <sys_exec+0xa8>
      return -1;
80106306:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010630b:	eb 64                	jmp    80106371 <sys_exec+0x10c>
    if(uarg == 0){
8010630d:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106313:	85 c0                	test   %eax,%eax
80106315:	75 26                	jne    8010633d <sys_exec+0xd8>
      argv[i] = 0;
80106317:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010631a:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106321:	00 00 00 00 
      break;
80106325:	90                   	nop
    }
...
80106329:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
8010632f:	89 54 24 04          	mov    %edx,0x4(%esp)
80106333:	89 04 24             	mov    %eax,(%esp)
80106336:	e8 e3 a7 ff ff       	call   80100b1e <exec>
8010633b:	eb 34                	jmp    80106371 <sys_exec+0x10c>
    if(fetchstr(uarg, &argv[i]) < 0)
...
8010634b:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106351:	89 54 24 04          	mov    %edx,0x4(%esp)
80106355:	89 04 24             	mov    %eax,(%esp)
80106358:	e8 af f1 ff ff       	call   8010550c <fetchstr>
8010635d:	85 c0                	test   %eax,%eax
8010635f:	79 07                	jns    80106368 <sys_exec+0x103>
      return -1;
80106361:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106366:	eb 09                	jmp    80106371 <sys_exec+0x10c>
  for(i=0;; i++){
80106368:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }
8010636c:	e9 5d ff ff ff       	jmp    801062ce <sys_exec+0x69>
}
80106371:	c9                   	leave  
80106372:	c3                   	ret    
...
80106379:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106380:	00 
80106381:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106384:	89 44 24 04          	mov    %eax,0x4(%esp)
80106388:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010638f:	e8 09 f2 ff ff       	call   8010559d <argptr>
80106394:	85 c0                	test   %eax,%eax
80106396:	79 0a                	jns    801063a2 <sys_pipe+0x2f>
    return -1;
80106398:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010639d:	e9 9a 00 00 00       	jmp    8010643c <sys_pipe+0xc9>
  if(pipealloc(&rf, &wf) < 0)
801063a2:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801063a5:	89 44 24 04          	mov    %eax,0x4(%esp)
801063a9:	8d 45 e8             	lea    -0x18(%ebp),%eax
801063ac:	89 04 24             	mov    %eax,(%esp)
801063af:	e8 31 d9 ff ff       	call   80103ce5 <pipealloc>
801063b4:	85 c0                	test   %eax,%eax
801063b6:	79 07                	jns    801063bf <sys_pipe+0x4c>
    return -1;
801063b8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063bd:	eb 7d                	jmp    8010643c <sys_pipe+0xc9>
  fd0 = -1;
801063bf:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801063c6:	8b 45 e8             	mov    -0x18(%ebp),%eax
801063c9:	89 04 24             	mov    %eax,(%esp)
801063cc:	e8 69 f3 ff ff       	call   8010573a <fdalloc>
801063d1:	89 45 f4             	mov    %eax,-0xc(%ebp)
801063d4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801063d8:	78 14                	js     801063ee <sys_pipe+0x7b>
801063da:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801063dd:	89 04 24             	mov    %eax,(%esp)
801063e0:	e8 55 f3 ff ff       	call   8010573a <fdalloc>
801063e5:	89 45 f0             	mov    %eax,-0x10(%ebp)
801063e8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801063ec:	79 36                	jns    80106424 <sys_pipe+0xb1>
    if(fd0 >= 0)
801063ee:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801063f2:	78 13                	js     80106407 <sys_pipe+0x94>
      myproc()->ofile[fd0] = 0;
801063f4:	e8 68 dd ff ff       	call   80104161 <myproc>
...
8010640d:	e8 1b ac ff ff       	call   8010102d <fileclose>
    fileclose(wf);
80106412:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106415:	89 04 24             	mov    %eax,(%esp)
80106418:	e8 10 ac ff ff       	call   8010102d <fileclose>
    return -1;
8010641d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106422:	eb 18                	jmp    8010643c <sys_pipe+0xc9>
  }
  fd[0] = fd0;
...
80106441:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106444:	e8 30 e0 ff ff       	call   80104479 <fork>
}
80106449:	c9                   	leave  
8010644a:	c3                   	ret    
...
8010644e:	83 ec 08             	sub    $0x8,%esp
  exit();
80106451:	e8 ba e1 ff ff       	call   80104610 <exit>
...
80106460:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106463:	e8 b5 e2 ff ff       	call   8010471d <wait>
}
80106468:	c9                   	leave  
80106469:	c3                   	ret    
...
8010646d:	83 ec 28             	sub    $0x28,%esp
  int pid;

  if(argint(0, &pid) < 0)
80106470:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106473:	89 44 24 04          	mov    %eax,0x4(%esp)
80106477:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010647e:	e8 ed f0 ff ff       	call   80105570 <argint>
80106483:	85 c0                	test   %eax,%eax
80106485:	79 07                	jns    8010648e <sys_kill+0x24>
    return -1;
80106487:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010648c:	eb 0b                	jmp    80106499 <sys_kill+0x2f>
  return kill(pid);
8010648e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106491:	89 04 24             	mov    %eax,(%esp)
80106494:	e8 62 e6 ff ff       	call   80104afb <kill>
}
80106499:	c9                   	leave  
8010649a:	c3                   	ret    
...
8010649e:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801064a1:	e8 bb dc ff ff       	call   80104161 <myproc>
801064a6:	8b 40 10             	mov    0x10(%eax),%eax
}
801064a9:	c9                   	leave  
801064aa:	c3                   	ret    
...
801064bf:	e8 ac f0 ff ff       	call   80105570 <argint>
801064c4:	85 c0                	test   %eax,%eax
801064c6:	79 07                	jns    801064cf <sys_sbrk+0x24>
    return -1;
801064c8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064cd:	eb 23                	jmp    801064f2 <sys_sbrk+0x47>
  addr = myproc()->sz;
801064cf:	e8 8d dc ff ff       	call   80104161 <myproc>
...
801064df:	e8 f7 de ff ff       	call   801043db <growproc>
801064e4:	85 c0                	test   %eax,%eax
801064e6:	79 07                	jns    801064ef <sys_sbrk+0x44>
    return -1;
801064e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064ed:	eb 03                	jmp    801064f2 <sys_sbrk+0x47>
  return addr;
...
80106508:	e8 63 f0 ff ff       	call   80105570 <argint>
8010650d:	85 c0                	test   %eax,%eax
8010650f:	79 07                	jns    80106518 <sys_sleep+0x24>
    return -1;
80106511:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106516:	eb 6b                	jmp    80106583 <sys_sleep+0x8f>
  acquire(&tickslock);
80106518:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
8010651f:	e8 91 ea ff ff       	call   80104fb5 <acquire>
  ticks0 = ticks;
80106524:	a1 20 67 11 80       	mov    0x80116720,%eax
80106529:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
8010652c:	eb 33                	jmp    80106561 <sys_sleep+0x6d>
    if(myproc()->killed){
8010652e:	e8 2e dc ff ff       	call   80104161 <myproc>
80106533:	8b 40 24             	mov    0x24(%eax),%eax
80106536:	85 c0                	test   %eax,%eax
80106538:	74 13                	je     8010654d <sys_sleep+0x59>
      release(&tickslock);
8010653a:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
80106541:	e8 d7 ea ff ff       	call   8010501d <release>
      return -1;
80106546:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010654b:	eb 36                	jmp    80106583 <sys_sleep+0x8f>
    }
    sleep(&ticks, &tickslock);
8010654d:	c7 44 24 04 e0 5e 11 	movl   $0x80115ee0,0x4(%esp)
80106554:	80 
80106555:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
8010655c:	e8 98 e4 ff ff       	call   801049f9 <sleep>
  while(ticks - ticks0 < n){
...
8010656e:	39 c2                	cmp    %eax,%edx
80106570:	72 bc                	jb     8010652e <sys_sleep+0x3a>
  }
  release(&tickslock);
80106572:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
80106579:	e8 9f ea ff ff       	call   8010501d <release>
  return 0;
...
80106592:	e8 1e ea ff ff       	call   80104fb5 <acquire>
  xticks = ticks;
80106597:	a1 20 67 11 80       	mov    0x80116720,%eax
8010659c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
8010659f:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
801065a6:	e8 72 ea ff ff       	call   8010501d <release>
  return xticks;
...
801065da:	eb 10                	jmp    801065ec <sys_getpinfo+0x3c>
  }
  
  fillpstat(pstat);
801065dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065df:	89 04 24             	mov    %eax,(%esp)
801065e2:	e8 8f e5 ff ff       	call   80104b76 <fillpstat>
  return 0;
...
801065ef:	06                   	push   %es
  pushl %fs
801065f0:	0f a0                	push   %fs
  pushl %gs
801065f2:	0f a8                	push   %gs
  pushal
801065f4:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801065f5:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801065f9:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801065fb:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801065fd:	54                   	push   %esp
  call trap
801065fe:	e8 d8 01 00 00       	call   801067db <trap>
  addl $4, %esp
80106603:	83 c4 04             	add    $0x4,%esp
...
80106606:	61                   	popa   
  popl %gs
80106607:	0f a9                	pop    %gs
  popl %fs
80106609:	0f a1                	pop    %fs
  popl %es
8010660b:	07                   	pop    %es
  popl %ds
8010660c:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010660d:	83 c4 08             	add    $0x8,%esp
  iret
80106610:	cf                   	iret   
...
80106614:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80106617:	8b 45 0c             	mov    0xc(%ebp),%eax
8010661a:	83 e8 01             	sub    $0x1,%eax
8010661d:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106621:	8b 45 08             	mov    0x8(%ebp),%eax
80106624:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106628:	8b 45 08             	mov    0x8(%ebp),%eax
8010662b:	c1 e8 10             	shr    $0x10,%eax
8010662e:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80106632:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106635:	0f 01 18             	lidtl  (%eax)
}
80106638:	c9                   	leave  
80106639:	c3                   	ret    
...
80106658:	e9 c3 00 00 00       	jmp    80106720 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
8010665d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106660:	8b 04 85 7c b0 10 80 	mov    -0x7fef4f84(,%eax,4),%eax
80106667:	89 c2                	mov    %eax,%edx
80106669:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010666c:	66 89 14 c5 20 5f 11 	mov    %dx,-0x7feea0e0(,%eax,8)
80106673:	80 
80106674:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106677:	66 c7 04 c5 22 5f 11 	movw   $0x8,-0x7feea0de(,%eax,8)
8010667e:	80 08 00 
80106681:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106684:	0f b6 14 c5 24 5f 11 	movzbl -0x7feea0dc(,%eax,8),%edx
8010668b:	80 
8010668c:	83 e2 e0             	and    $0xffffffe0,%edx
8010668f:	88 14 c5 24 5f 11 80 	mov    %dl,-0x7feea0dc(,%eax,8)
80106696:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106699:	0f b6 14 c5 24 5f 11 	movzbl -0x7feea0dc(,%eax,8),%edx
801066a0:	80 
801066a1:	83 e2 1f             	and    $0x1f,%edx
801066a4:	88 14 c5 24 5f 11 80 	mov    %dl,-0x7feea0dc(,%eax,8)
801066ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066ae:	0f b6 14 c5 25 5f 11 	movzbl -0x7feea0db(,%eax,8),%edx
801066b5:	80 
801066b6:	83 e2 f0             	and    $0xfffffff0,%edx
801066b9:	83 ca 0e             	or     $0xe,%edx
801066bc:	88 14 c5 25 5f 11 80 	mov    %dl,-0x7feea0db(,%eax,8)
801066c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066c6:	0f b6 14 c5 25 5f 11 	movzbl -0x7feea0db(,%eax,8),%edx
801066cd:	80 
801066ce:	83 e2 ef             	and    $0xffffffef,%edx
801066d1:	88 14 c5 25 5f 11 80 	mov    %dl,-0x7feea0db(,%eax,8)
801066d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066db:	0f b6 14 c5 25 5f 11 	movzbl -0x7feea0db(,%eax,8),%edx
801066e2:	80 
801066e3:	83 e2 9f             	and    $0xffffff9f,%edx
801066e6:	88 14 c5 25 5f 11 80 	mov    %dl,-0x7feea0db(,%eax,8)
801066ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066f0:	0f b6 14 c5 25 5f 11 	movzbl -0x7feea0db(,%eax,8),%edx
801066f7:	80 
801066f8:	83 ca 80             	or     $0xffffff80,%edx
801066fb:	88 14 c5 25 5f 11 80 	mov    %dl,-0x7feea0db(,%eax,8)
80106702:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106705:	8b 04 85 7c b0 10 80 	mov    -0x7fef4f84(,%eax,4),%eax
8010670c:	c1 e8 10             	shr    $0x10,%eax
8010670f:	89 c2                	mov    %eax,%edx
80106711:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106714:	66 89 14 c5 26 5f 11 	mov    %dx,-0x7feea0da(,%eax,8)
8010671b:	80 
  for(i = 0; i < 256; i++)
8010671c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106720:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106727:	0f 8e 30 ff ff ff    	jle    8010665d <tvinit+0x12>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010672d:	a1 7c b1 10 80       	mov    0x8010b17c,%eax
80106732:	66 a3 20 61 11 80    	mov    %ax,0x80116120
80106738:	66 c7 05 22 61 11 80 	movw   $0x8,0x80116122
8010673f:	08 00 
80106741:	0f b6 05 24 61 11 80 	movzbl 0x80116124,%eax
80106748:	83 e0 e0             	and    $0xffffffe0,%eax
8010674b:	a2 24 61 11 80       	mov    %al,0x80116124
80106750:	0f b6 05 24 61 11 80 	movzbl 0x80116124,%eax
80106757:	83 e0 1f             	and    $0x1f,%eax
8010675a:	a2 24 61 11 80       	mov    %al,0x80116124
8010675f:	0f b6 05 25 61 11 80 	movzbl 0x80116125,%eax
80106766:	83 c8 0f             	or     $0xf,%eax
80106769:	a2 25 61 11 80       	mov    %al,0x80116125
8010676e:	0f b6 05 25 61 11 80 	movzbl 0x80116125,%eax
80106775:	83 e0 ef             	and    $0xffffffef,%eax
80106778:	a2 25 61 11 80       	mov    %al,0x80116125
8010677d:	0f b6 05 25 61 11 80 	movzbl 0x80116125,%eax
80106784:	83 c8 60             	or     $0x60,%eax
80106787:	a2 25 61 11 80       	mov    %al,0x80116125
8010678c:	0f b6 05 25 61 11 80 	movzbl 0x80116125,%eax
80106793:	83 c8 80             	or     $0xffffff80,%eax
80106796:	a2 25 61 11 80       	mov    %al,0x80116125
8010679b:	a1 7c b1 10 80       	mov    0x8010b17c,%eax
801067a0:	c1 e8 10             	shr    $0x10,%eax
801067a3:	66 a3 26 61 11 80    	mov    %ax,0x80116126

  initlock(&tickslock, "time");
801067a9:	c7 44 24 04 4c 89 10 	movl   $0x8010894c,0x4(%esp)
801067b0:	80 
801067b1:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
801067b8:	e8 d7 e7 ff ff       	call   80104f94 <initlock>
}
801067bd:	c9                   	leave  
801067be:	c3                   	ret    
...
801067c2:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801067c5:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801067cc:	00 
801067cd:	c7 04 24 20 5f 11 80 	movl   $0x80115f20,(%esp)
801067d4:	e8 38 fe ff ff       	call   80106611 <lidt>
}
801067d9:	c9                   	leave  
801067da:	c3                   	ret    
...
801067de:	57                   	push   %edi
801067df:	56                   	push   %esi
801067e0:	53                   	push   %ebx
801067e1:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801067e4:	8b 45 08             	mov    0x8(%ebp),%eax
801067e7:	8b 40 30             	mov    0x30(%eax),%eax
801067ea:	83 f8 40             	cmp    $0x40,%eax
801067ed:	75 3c                	jne    8010682b <trap+0x50>
    if(myproc()->killed)
801067ef:	e8 6d d9 ff ff       	call   80104161 <myproc>
801067f4:	8b 40 24             	mov    0x24(%eax),%eax
801067f7:	85 c0                	test   %eax,%eax
801067f9:	74 05                	je     80106800 <trap+0x25>
      exit();
801067fb:	e8 10 de ff ff       	call   80104610 <exit>
    myproc()->tf = tf;
80106800:	e8 5c d9 ff ff       	call   80104161 <myproc>
80106805:	8b 55 08             	mov    0x8(%ebp),%edx
80106808:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
8010680b:	e8 2e ee ff ff       	call   8010563e <syscall>
    if(myproc()->killed)
80106810:	e8 4c d9 ff ff       	call   80104161 <myproc>
80106815:	8b 40 24             	mov    0x24(%eax),%eax
80106818:	85 c0                	test   %eax,%eax
8010681a:	74 0a                	je     80106826 <trap+0x4b>
      exit();
8010681c:	e8 ef dd ff ff       	call   80104610 <exit>
    return;
80106821:	e9 19 02 00 00       	jmp    80106a3f <trap+0x264>
80106826:	e9 14 02 00 00       	jmp    80106a3f <trap+0x264>
  }

  switch(tf->trapno){
8010682b:	8b 45 08             	mov    0x8(%ebp),%eax
8010682e:	8b 40 30             	mov    0x30(%eax),%eax
80106831:	83 e8 20             	sub    $0x20,%eax
80106834:	83 f8 1f             	cmp    $0x1f,%eax
80106837:	0f 87 b1 00 00 00    	ja     801068ee <trap+0x113>
8010683d:	8b 04 85 f4 89 10 80 	mov    -0x7fef760c(,%eax,4),%eax
80106844:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80106846:	e8 7f d8 ff ff       	call   801040ca <cpuid>
8010684b:	85 c0                	test   %eax,%eax
8010684d:	75 31                	jne    80106880 <trap+0xa5>
      acquire(&tickslock);
8010684f:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
80106856:	e8 5a e7 ff ff       	call   80104fb5 <acquire>
      ticks++;
8010685b:	a1 20 67 11 80       	mov    0x80116720,%eax
80106860:	83 c0 01             	add    $0x1,%eax
80106863:	a3 20 67 11 80       	mov    %eax,0x80116720
      wakeup(&ticks);
80106868:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
8010686f:	e8 5c e2 ff ff       	call   80104ad0 <wakeup>
      release(&tickslock);
80106874:	c7 04 24 e0 5e 11 80 	movl   $0x80115ee0,(%esp)
8010687b:	e8 9d e7 ff ff       	call   8010501d <release>
    }
    lapiceoi();
80106880:	e8 cc c6 ff ff       	call   80102f51 <lapiceoi>
    break;
80106885:	e9 37 01 00 00       	jmp    801069c1 <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
8010688a:	e8 39 bf ff ff       	call   801027c8 <ideintr>
    lapiceoi();
8010688f:	e8 bd c6 ff ff       	call   80102f51 <lapiceoi>
    break;
80106894:	e9 28 01 00 00       	jmp    801069c1 <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106899:	e8 c8 c4 ff ff       	call   80102d66 <kbdintr>
    lapiceoi();
8010689e:	e8 ae c6 ff ff       	call   80102f51 <lapiceoi>
    break;
801068a3:	e9 19 01 00 00       	jmp    801069c1 <trap+0x1e6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801068a8:	e8 7b 03 00 00       	call   80106c28 <uartintr>
    lapiceoi();
801068ad:	e8 9f c6 ff ff       	call   80102f51 <lapiceoi>
    break;
801068b2:	e9 0a 01 00 00       	jmp    801069c1 <trap+0x1e6>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801068b7:	8b 45 08             	mov    0x8(%ebp),%eax
801068ba:	8b 70 38             	mov    0x38(%eax),%esi
            cpuid(), tf->cs, tf->eip);
801068bd:	8b 45 08             	mov    0x8(%ebp),%eax
801068c0:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801068c4:	0f b7 d8             	movzwl %ax,%ebx
801068c7:	e8 fe d7 ff ff       	call   801040ca <cpuid>
801068cc:	89 74 24 0c          	mov    %esi,0xc(%esp)
801068d0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801068d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801068d8:	c7 04 24 54 89 10 80 	movl   $0x80108954,(%esp)
801068df:	e8 e4 9a ff ff       	call   801003c8 <cprintf>
    lapiceoi();
801068e4:	e8 68 c6 ff ff       	call   80102f51 <lapiceoi>
    break;
801068e9:	e9 d3 00 00 00       	jmp    801069c1 <trap+0x1e6>

  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
801068ee:	e8 6e d8 ff ff       	call   80104161 <myproc>
801068f3:	85 c0                	test   %eax,%eax
801068f5:	74 11                	je     80106908 <trap+0x12d>
801068f7:	8b 45 08             	mov    0x8(%ebp),%eax
801068fa:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801068fe:	0f b7 c0             	movzwl %ax,%eax
80106901:	83 e0 03             	and    $0x3,%eax
80106904:	85 c0                	test   %eax,%eax
80106906:	75 40                	jne    80106948 <trap+0x16d>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106908:	e8 2d fd ff ff       	call   8010663a <rcr2>
8010690d:	89 c3                	mov    %eax,%ebx
8010690f:	8b 45 08             	mov    0x8(%ebp),%eax
80106912:	8b 70 38             	mov    0x38(%eax),%esi
80106915:	e8 b0 d7 ff ff       	call   801040ca <cpuid>
8010691a:	8b 55 08             	mov    0x8(%ebp),%edx
8010691d:	8b 52 30             	mov    0x30(%edx),%edx
80106920:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106924:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106928:	89 44 24 08          	mov    %eax,0x8(%esp)
8010692c:	89 54 24 04          	mov    %edx,0x4(%esp)
80106930:	c7 04 24 78 89 10 80 	movl   $0x80108978,(%esp)
80106937:	e8 8c 9a ff ff       	call   801003c8 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010693c:	c7 04 24 aa 89 10 80 	movl   $0x801089aa,(%esp)
80106943:	e8 1a 9c ff ff       	call   80100562 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106948:	e8 ed fc ff ff       	call   8010663a <rcr2>
8010694d:	89 c6                	mov    %eax,%esi
8010694f:	8b 45 08             	mov    0x8(%ebp),%eax
80106952:	8b 40 38             	mov    0x38(%eax),%eax
80106955:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106958:	e8 6d d7 ff ff       	call   801040ca <cpuid>
8010695d:	89 c3                	mov    %eax,%ebx
8010695f:	8b 45 08             	mov    0x8(%ebp),%eax
80106962:	8b 78 34             	mov    0x34(%eax),%edi
80106965:	89 7d e0             	mov    %edi,-0x20(%ebp)
80106968:	8b 45 08             	mov    0x8(%ebp),%eax
8010696b:	8b 78 30             	mov    0x30(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010696e:	e8 ee d7 ff ff       	call   80104161 <myproc>
80106973:	8d 50 6c             	lea    0x6c(%eax),%edx
80106976:	89 55 dc             	mov    %edx,-0x24(%ebp)
80106979:	e8 e3 d7 ff ff       	call   80104161 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010697e:	8b 40 10             	mov    0x10(%eax),%eax
80106981:	89 74 24 1c          	mov    %esi,0x1c(%esp)
80106985:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106988:	89 4c 24 18          	mov    %ecx,0x18(%esp)
8010698c:	89 5c 24 14          	mov    %ebx,0x14(%esp)
80106990:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80106993:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80106997:	89 7c 24 0c          	mov    %edi,0xc(%esp)
8010699b:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010699e:	89 54 24 08          	mov    %edx,0x8(%esp)
801069a2:	89 44 24 04          	mov    %eax,0x4(%esp)
801069a6:	c7 04 24 b0 89 10 80 	movl   $0x801089b0,(%esp)
801069ad:	e8 16 9a ff ff       	call   801003c8 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801069b2:	e8 aa d7 ff ff       	call   80104161 <myproc>
801069b7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801069be:	eb 01                	jmp    801069c1 <trap+0x1e6>
    break;
801069c0:	90                   	nop
  }
...
801069c1:	e8 9b d7 ff ff       	call   80104161 <myproc>
801069c6:	85 c0                	test   %eax,%eax
801069c8:	74 23                	je     801069ed <trap+0x212>
801069ca:	e8 92 d7 ff ff       	call   80104161 <myproc>
801069cf:	8b 40 24             	mov    0x24(%eax),%eax
801069d2:	85 c0                	test   %eax,%eax
801069d4:	74 17                	je     801069ed <trap+0x212>
801069d6:	8b 45 08             	mov    0x8(%ebp),%eax
801069d9:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801069dd:	0f b7 c0             	movzwl %ax,%eax
801069e0:	83 e0 03             	and    $0x3,%eax
801069e3:	83 f8 03             	cmp    $0x3,%eax
801069e6:	75 05                	jne    801069ed <trap+0x212>
    exit();
801069e8:	e8 23 dc ff ff       	call   80104610 <exit>
...
80106a38:	75 05                	jne    80106a3f <trap+0x264>
    exit();
80106a3a:	e8 d1 db ff ff       	call   80104610 <exit>
}
80106a3f:	83 c4 3c             	add    $0x3c,%esp
80106a42:	5b                   	pop    %ebx
80106a43:	5e                   	pop    %esi
80106a44:	5f                   	pop    %edi
80106a45:	5d                   	pop    %ebp
...
80106a4a:	83 ec 14             	sub    $0x14,%esp
80106a4d:	8b 45 08             	mov    0x8(%ebp),%eax
80106a50:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106a54:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106a58:	89 c2                	mov    %eax,%edx
80106a5a:	ec                   	in     (%dx),%al
80106a5b:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106a5e:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106a62:	c9                   	leave  
80106a63:	c3                   	ret    
...
80106a70:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106a74:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106a77:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106a7b:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106a7f:	ee                   	out    %al,(%dx)
}
80106a80:	c9                   	leave  
80106a81:	c3                   	ret    
...
80106a97:	e8 c8 ff ff ff       	call   80106a64 <outb>

  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106a9c:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106aa3:	00 
80106aa4:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106aab:	e8 b4 ff ff ff       	call   80106a64 <outb>
  outb(COM1+0, 115200/9600);
80106ab0:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106ab7:	00 
80106ab8:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106abf:	e8 a0 ff ff ff       	call   80106a64 <outb>
  outb(COM1+1, 0);
80106ac4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106acb:	00 
80106acc:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106ad3:	e8 8c ff ff ff       	call   80106a64 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106ad8:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106adf:	00 
80106ae0:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106ae7:	e8 78 ff ff ff       	call   80106a64 <outb>
  outb(COM1+4, 0);
80106aec:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106af3:	00 
80106af4:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106afb:	e8 64 ff ff ff       	call   80106a64 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106b00:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106b07:	00 
80106b08:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b0f:	e8 50 ff ff ff       	call   80106a64 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106b14:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b1b:	e8 27 ff ff ff       	call   80106a47 <inb>
80106b20:	3c ff                	cmp    $0xff,%al
80106b22:	75 02                	jne    80106b26 <uartinit+0xa4>
    return;
80106b24:	eb 5e                	jmp    80106b84 <uartinit+0x102>
  uart = 1;
80106b26:	c7 05 24 b6 10 80 01 	movl   $0x1,0x8010b624
80106b2d:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106b30:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106b37:	e8 0b ff ff ff       	call   80106a47 <inb>
  inb(COM1+0);
80106b3c:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b43:	e8 ff fe ff ff       	call   80106a47 <inb>
  ioapicenable(IRQ_COM1, 0);
80106b48:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b4f:	00 
80106b50:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106b57:	e8 e3 be ff ff       	call   80102a3f <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106b5c:	c7 45 f4 74 8a 10 80 	movl   $0x80108a74,-0xc(%ebp)
80106b63:	eb 15                	jmp    80106b7a <uartinit+0xf8>
    uartputc(*p);
80106b65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b68:	0f b6 00             	movzbl (%eax),%eax
80106b6b:	0f be c0             	movsbl %al,%eax
80106b6e:	89 04 24             	mov    %eax,(%esp)
80106b71:	e8 10 00 00 00       	call   80106b86 <uartputc>
  for(p="xv6...\n"; *p; p++)
80106b76:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106b7a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b7d:	0f b6 00             	movzbl (%eax),%eax
80106b80:	84 c0                	test   %al,%al
80106b82:	75 e1                	jne    80106b65 <uartinit+0xe3>
}
80106b84:	c9                   	leave  
80106b85:	c3                   	ret    
...
80106b89:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106b8c:	a1 24 b6 10 80       	mov    0x8010b624,%eax
80106b91:	85 c0                	test   %eax,%eax
80106b93:	75 02                	jne    80106b97 <uartputc+0x11>
    return;
80106b95:	eb 4b                	jmp    80106be2 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106b97:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106b9e:	eb 10                	jmp    80106bb0 <uartputc+0x2a>
    microdelay(10);
80106ba0:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106ba7:	e8 ca c3 ff ff       	call   80102f76 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106bac:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106bb0:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106bb4:	7f 16                	jg     80106bcc <uartputc+0x46>
80106bb6:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106bbd:	e8 85 fe ff ff       	call   80106a47 <inb>
80106bc2:	0f b6 c0             	movzbl %al,%eax
80106bc5:	83 e0 20             	and    $0x20,%eax
80106bc8:	85 c0                	test   %eax,%eax
80106bca:	74 d4                	je     80106ba0 <uartputc+0x1a>
  outb(COM1+0, c);
80106bcc:	8b 45 08             	mov    0x8(%ebp),%eax
80106bcf:	0f b6 c0             	movzbl %al,%eax
80106bd2:	89 44 24 04          	mov    %eax,0x4(%esp)
80106bd6:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106bdd:	e8 82 fe ff ff       	call   80106a64 <outb>
}
80106be2:	c9                   	leave  
80106be3:	c3                   	ret    
...
80106be7:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106bea:	a1 24 b6 10 80       	mov    0x8010b624,%eax
80106bef:	85 c0                	test   %eax,%eax
80106bf1:	75 07                	jne    80106bfa <uartgetc+0x16>
    return -1;
80106bf3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bf8:	eb 2c                	jmp    80106c26 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106bfa:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c01:	e8 41 fe ff ff       	call   80106a47 <inb>
80106c06:	0f b6 c0             	movzbl %al,%eax
80106c09:	83 e0 01             	and    $0x1,%eax
80106c0c:	85 c0                	test   %eax,%eax
80106c0e:	75 07                	jne    80106c17 <uartgetc+0x33>
    return -1;
80106c10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c15:	eb 0f                	jmp    80106c26 <uartgetc+0x42>
  return inb(COM1+0);
80106c17:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c1e:	e8 24 fe ff ff       	call   80106a47 <inb>
...
80106c2b:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106c2e:	c7 04 24 e4 6b 10 80 	movl   $0x80106be4,(%esp)
80106c35:	e8 af 9b ff ff       	call   801007e9 <consoleintr>
}
80106c3a:	c9                   	leave  
80106c3b:	c3                   	ret    
...
80106c3e:	6a 00                	push   $0x0
  jmp alltraps
80106c40:	e9 a9 f9 ff ff       	jmp    801065ee <alltraps>
...
80106c47:	6a 01                	push   $0x1
  jmp alltraps
80106c49:	e9 a0 f9 ff ff       	jmp    801065ee <alltraps>
...
80106c4e:	6a 00                	push   $0x0
  pushl $2
80106c50:	6a 02                	push   $0x2
  jmp alltraps
80106c52:	e9 97 f9 ff ff       	jmp    801065ee <alltraps>
...
80106c57:	6a 00                	push   $0x0
  pushl $3
80106c59:	6a 03                	push   $0x3
  jmp alltraps
80106c5b:	e9 8e f9 ff ff       	jmp    801065ee <alltraps>
...
80106c60:	6a 00                	push   $0x0
  pushl $4
80106c62:	6a 04                	push   $0x4
  jmp alltraps
80106c64:	e9 85 f9 ff ff       	jmp    801065ee <alltraps>
...
80106c69:	6a 00                	push   $0x0
  pushl $5
80106c6b:	6a 05                	push   $0x5
  jmp alltraps
80106c6d:	e9 7c f9 ff ff       	jmp    801065ee <alltraps>
...
80106c72:	6a 00                	push   $0x0
  pushl $6
80106c74:	6a 06                	push   $0x6
  jmp alltraps
80106c76:	e9 73 f9 ff ff       	jmp    801065ee <alltraps>
...
80106c7b:	6a 00                	push   $0x0
  pushl $7
80106c7d:	6a 07                	push   $0x7
  jmp alltraps
80106c7f:	e9 6a f9 ff ff       	jmp    801065ee <alltraps>

80106c84 <vector8>:
.globl vector8
vector8:
  pushl $8
80106c84:	6a 08                	push   $0x8
  jmp alltraps
80106c86:	e9 63 f9 ff ff       	jmp    801065ee <alltraps>
...
80106c8b:	6a 00                	push   $0x0
  pushl $9
80106c8d:	6a 09                	push   $0x9
  jmp alltraps
80106c8f:	e9 5a f9 ff ff       	jmp    801065ee <alltraps>

80106c94 <vector10>:
.globl vector10
vector10:
  pushl $10
80106c94:	6a 0a                	push   $0xa
  jmp alltraps
80106c96:	e9 53 f9 ff ff       	jmp    801065ee <alltraps>

80106c9b <vector11>:
.globl vector11
vector11:
  pushl $11
80106c9b:	6a 0b                	push   $0xb
  jmp alltraps
80106c9d:	e9 4c f9 ff ff       	jmp    801065ee <alltraps>

80106ca2 <vector12>:
.globl vector12
vector12:
  pushl $12
80106ca2:	6a 0c                	push   $0xc
  jmp alltraps
80106ca4:	e9 45 f9 ff ff       	jmp    801065ee <alltraps>

80106ca9 <vector13>:
.globl vector13
vector13:
  pushl $13
80106ca9:	6a 0d                	push   $0xd
  jmp alltraps
80106cab:	e9 3e f9 ff ff       	jmp    801065ee <alltraps>

80106cb0 <vector14>:
.globl vector14
vector14:
  pushl $14
80106cb0:	6a 0e                	push   $0xe
  jmp alltraps
80106cb2:	e9 37 f9 ff ff       	jmp    801065ee <alltraps>
...
80106cb7:	6a 00                	push   $0x0
  pushl $15
80106cb9:	6a 0f                	push   $0xf
  jmp alltraps
80106cbb:	e9 2e f9 ff ff       	jmp    801065ee <alltraps>
...
80106cc0:	6a 00                	push   $0x0
  pushl $16
80106cc2:	6a 10                	push   $0x10
  jmp alltraps
80106cc4:	e9 25 f9 ff ff       	jmp    801065ee <alltraps>

80106cc9 <vector17>:
.globl vector17
vector17:
  pushl $17
80106cc9:	6a 11                	push   $0x11
  jmp alltraps
80106ccb:	e9 1e f9 ff ff       	jmp    801065ee <alltraps>
...
80106cd0:	6a 00                	push   $0x0
  pushl $18
80106cd2:	6a 12                	push   $0x12
  jmp alltraps
80106cd4:	e9 15 f9 ff ff       	jmp    801065ee <alltraps>
...
80106cd9:	6a 00                	push   $0x0
  pushl $19
80106cdb:	6a 13                	push   $0x13
  jmp alltraps
80106cdd:	e9 0c f9 ff ff       	jmp    801065ee <alltraps>
...
80106ce2:	6a 00                	push   $0x0
  pushl $20
80106ce4:	6a 14                	push   $0x14
  jmp alltraps
80106ce6:	e9 03 f9 ff ff       	jmp    801065ee <alltraps>
...
80106ceb:	6a 00                	push   $0x0
  pushl $21
80106ced:	6a 15                	push   $0x15
  jmp alltraps
80106cef:	e9 fa f8 ff ff       	jmp    801065ee <alltraps>
...
80106cf4:	6a 00                	push   $0x0
  pushl $22
80106cf6:	6a 16                	push   $0x16
  jmp alltraps
80106cf8:	e9 f1 f8 ff ff       	jmp    801065ee <alltraps>
...
80106cfd:	6a 00                	push   $0x0
  pushl $23
80106cff:	6a 17                	push   $0x17
  jmp alltraps
80106d01:	e9 e8 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d06:	6a 00                	push   $0x0
  pushl $24
80106d08:	6a 18                	push   $0x18
  jmp alltraps
80106d0a:	e9 df f8 ff ff       	jmp    801065ee <alltraps>
...
80106d0f:	6a 00                	push   $0x0
  pushl $25
80106d11:	6a 19                	push   $0x19
  jmp alltraps
80106d13:	e9 d6 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d18:	6a 00                	push   $0x0
  pushl $26
80106d1a:	6a 1a                	push   $0x1a
  jmp alltraps
80106d1c:	e9 cd f8 ff ff       	jmp    801065ee <alltraps>
...
80106d21:	6a 00                	push   $0x0
  pushl $27
80106d23:	6a 1b                	push   $0x1b
  jmp alltraps
80106d25:	e9 c4 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d2a:	6a 00                	push   $0x0
  pushl $28
80106d2c:	6a 1c                	push   $0x1c
  jmp alltraps
80106d2e:	e9 bb f8 ff ff       	jmp    801065ee <alltraps>
...
80106d33:	6a 00                	push   $0x0
  pushl $29
80106d35:	6a 1d                	push   $0x1d
  jmp alltraps
80106d37:	e9 b2 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d3c:	6a 00                	push   $0x0
  pushl $30
80106d3e:	6a 1e                	push   $0x1e
  jmp alltraps
80106d40:	e9 a9 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d45:	6a 00                	push   $0x0
  pushl $31
80106d47:	6a 1f                	push   $0x1f
  jmp alltraps
80106d49:	e9 a0 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d4e:	6a 00                	push   $0x0
  pushl $32
80106d50:	6a 20                	push   $0x20
  jmp alltraps
80106d52:	e9 97 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d57:	6a 00                	push   $0x0
  pushl $33
80106d59:	6a 21                	push   $0x21
  jmp alltraps
80106d5b:	e9 8e f8 ff ff       	jmp    801065ee <alltraps>
...
80106d60:	6a 00                	push   $0x0
  pushl $34
80106d62:	6a 22                	push   $0x22
  jmp alltraps
80106d64:	e9 85 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d69:	6a 00                	push   $0x0
  pushl $35
80106d6b:	6a 23                	push   $0x23
  jmp alltraps
80106d6d:	e9 7c f8 ff ff       	jmp    801065ee <alltraps>
...
80106d72:	6a 00                	push   $0x0
  pushl $36
80106d74:	6a 24                	push   $0x24
  jmp alltraps
80106d76:	e9 73 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d7b:	6a 00                	push   $0x0
  pushl $37
80106d7d:	6a 25                	push   $0x25
  jmp alltraps
80106d7f:	e9 6a f8 ff ff       	jmp    801065ee <alltraps>
...
80106d84:	6a 00                	push   $0x0
  pushl $38
80106d86:	6a 26                	push   $0x26
  jmp alltraps
80106d88:	e9 61 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d8d:	6a 00                	push   $0x0
  pushl $39
80106d8f:	6a 27                	push   $0x27
  jmp alltraps
80106d91:	e9 58 f8 ff ff       	jmp    801065ee <alltraps>
...
80106d96:	6a 00                	push   $0x0
  pushl $40
80106d98:	6a 28                	push   $0x28
  jmp alltraps
80106d9a:	e9 4f f8 ff ff       	jmp    801065ee <alltraps>
...
80106d9f:	6a 00                	push   $0x0
  pushl $41
80106da1:	6a 29                	push   $0x29
  jmp alltraps
80106da3:	e9 46 f8 ff ff       	jmp    801065ee <alltraps>
...
80106da8:	6a 00                	push   $0x0
  pushl $42
80106daa:	6a 2a                	push   $0x2a
  jmp alltraps
80106dac:	e9 3d f8 ff ff       	jmp    801065ee <alltraps>
...
80106db1:	6a 00                	push   $0x0
  pushl $43
80106db3:	6a 2b                	push   $0x2b
  jmp alltraps
80106db5:	e9 34 f8 ff ff       	jmp    801065ee <alltraps>
...
80106dba:	6a 00                	push   $0x0
  pushl $44
80106dbc:	6a 2c                	push   $0x2c
  jmp alltraps
80106dbe:	e9 2b f8 ff ff       	jmp    801065ee <alltraps>
...
80106dc3:	6a 00                	push   $0x0
  pushl $45
80106dc5:	6a 2d                	push   $0x2d
  jmp alltraps
80106dc7:	e9 22 f8 ff ff       	jmp    801065ee <alltraps>
...
80106dcc:	6a 00                	push   $0x0
  pushl $46
80106dce:	6a 2e                	push   $0x2e
  jmp alltraps
80106dd0:	e9 19 f8 ff ff       	jmp    801065ee <alltraps>
...
80106dd5:	6a 00                	push   $0x0
  pushl $47
80106dd7:	6a 2f                	push   $0x2f
  jmp alltraps
80106dd9:	e9 10 f8 ff ff       	jmp    801065ee <alltraps>
...
80106dde:	6a 00                	push   $0x0
  pushl $48
80106de0:	6a 30                	push   $0x30
  jmp alltraps
80106de2:	e9 07 f8 ff ff       	jmp    801065ee <alltraps>
...
80106de7:	6a 00                	push   $0x0
  pushl $49
80106de9:	6a 31                	push   $0x31
  jmp alltraps
80106deb:	e9 fe f7 ff ff       	jmp    801065ee <alltraps>
...
80106df0:	6a 00                	push   $0x0
  pushl $50
80106df2:	6a 32                	push   $0x32
  jmp alltraps
80106df4:	e9 f5 f7 ff ff       	jmp    801065ee <alltraps>
...
80106df9:	6a 00                	push   $0x0
  pushl $51
80106dfb:	6a 33                	push   $0x33
  jmp alltraps
80106dfd:	e9 ec f7 ff ff       	jmp    801065ee <alltraps>
...
80106e02:	6a 00                	push   $0x0
  pushl $52
80106e04:	6a 34                	push   $0x34
  jmp alltraps
80106e06:	e9 e3 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e0b:	6a 00                	push   $0x0
  pushl $53
80106e0d:	6a 35                	push   $0x35
  jmp alltraps
80106e0f:	e9 da f7 ff ff       	jmp    801065ee <alltraps>
...
80106e14:	6a 00                	push   $0x0
  pushl $54
80106e16:	6a 36                	push   $0x36
  jmp alltraps
80106e18:	e9 d1 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e1d:	6a 00                	push   $0x0
  pushl $55
80106e1f:	6a 37                	push   $0x37
  jmp alltraps
80106e21:	e9 c8 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e26:	6a 00                	push   $0x0
  pushl $56
80106e28:	6a 38                	push   $0x38
  jmp alltraps
80106e2a:	e9 bf f7 ff ff       	jmp    801065ee <alltraps>
...
80106e2f:	6a 00                	push   $0x0
  pushl $57
80106e31:	6a 39                	push   $0x39
  jmp alltraps
80106e33:	e9 b6 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e38:	6a 00                	push   $0x0
  pushl $58
80106e3a:	6a 3a                	push   $0x3a
  jmp alltraps
80106e3c:	e9 ad f7 ff ff       	jmp    801065ee <alltraps>
...
80106e41:	6a 00                	push   $0x0
  pushl $59
80106e43:	6a 3b                	push   $0x3b
  jmp alltraps
80106e45:	e9 a4 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e4a:	6a 00                	push   $0x0
  pushl $60
80106e4c:	6a 3c                	push   $0x3c
  jmp alltraps
80106e4e:	e9 9b f7 ff ff       	jmp    801065ee <alltraps>
...
80106e53:	6a 00                	push   $0x0
  pushl $61
80106e55:	6a 3d                	push   $0x3d
  jmp alltraps
80106e57:	e9 92 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e5c:	6a 00                	push   $0x0
  pushl $62
80106e5e:	6a 3e                	push   $0x3e
  jmp alltraps
80106e60:	e9 89 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e65:	6a 00                	push   $0x0
  pushl $63
80106e67:	6a 3f                	push   $0x3f
  jmp alltraps
80106e69:	e9 80 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e6e:	6a 00                	push   $0x0
  pushl $64
80106e70:	6a 40                	push   $0x40
  jmp alltraps
80106e72:	e9 77 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e77:	6a 00                	push   $0x0
  pushl $65
80106e79:	6a 41                	push   $0x41
  jmp alltraps
80106e7b:	e9 6e f7 ff ff       	jmp    801065ee <alltraps>
...
80106e80:	6a 00                	push   $0x0
  pushl $66
80106e82:	6a 42                	push   $0x42
  jmp alltraps
80106e84:	e9 65 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e89:	6a 00                	push   $0x0
  pushl $67
80106e8b:	6a 43                	push   $0x43
  jmp alltraps
80106e8d:	e9 5c f7 ff ff       	jmp    801065ee <alltraps>
...
80106e92:	6a 00                	push   $0x0
  pushl $68
80106e94:	6a 44                	push   $0x44
  jmp alltraps
80106e96:	e9 53 f7 ff ff       	jmp    801065ee <alltraps>
...
80106e9b:	6a 00                	push   $0x0
  pushl $69
80106e9d:	6a 45                	push   $0x45
  jmp alltraps
80106e9f:	e9 4a f7 ff ff       	jmp    801065ee <alltraps>
...
80106ea4:	6a 00                	push   $0x0
  pushl $70
80106ea6:	6a 46                	push   $0x46
  jmp alltraps
80106ea8:	e9 41 f7 ff ff       	jmp    801065ee <alltraps>
...
80106ead:	6a 00                	push   $0x0
  pushl $71
80106eaf:	6a 47                	push   $0x47
  jmp alltraps
80106eb1:	e9 38 f7 ff ff       	jmp    801065ee <alltraps>
...
80106eb6:	6a 00                	push   $0x0
  pushl $72
80106eb8:	6a 48                	push   $0x48
  jmp alltraps
80106eba:	e9 2f f7 ff ff       	jmp    801065ee <alltraps>
...
80106ebf:	6a 00                	push   $0x0
  pushl $73
80106ec1:	6a 49                	push   $0x49
  jmp alltraps
80106ec3:	e9 26 f7 ff ff       	jmp    801065ee <alltraps>
...
80106ec8:	6a 00                	push   $0x0
  pushl $74
80106eca:	6a 4a                	push   $0x4a
  jmp alltraps
80106ecc:	e9 1d f7 ff ff       	jmp    801065ee <alltraps>
...
80106ed1:	6a 00                	push   $0x0
  pushl $75
80106ed3:	6a 4b                	push   $0x4b
  jmp alltraps
80106ed5:	e9 14 f7 ff ff       	jmp    801065ee <alltraps>
...
80106eda:	6a 00                	push   $0x0
  pushl $76
80106edc:	6a 4c                	push   $0x4c
  jmp alltraps
80106ede:	e9 0b f7 ff ff       	jmp    801065ee <alltraps>
...
80106ee3:	6a 00                	push   $0x0
  pushl $77
80106ee5:	6a 4d                	push   $0x4d
  jmp alltraps
80106ee7:	e9 02 f7 ff ff       	jmp    801065ee <alltraps>
...
80106eec:	6a 00                	push   $0x0
  pushl $78
80106eee:	6a 4e                	push   $0x4e
  jmp alltraps
80106ef0:	e9 f9 f6 ff ff       	jmp    801065ee <alltraps>
...
80106ef5:	6a 00                	push   $0x0
  pushl $79
80106ef7:	6a 4f                	push   $0x4f
  jmp alltraps
80106ef9:	e9 f0 f6 ff ff       	jmp    801065ee <alltraps>
...
80106efe:	6a 00                	push   $0x0
  pushl $80
80106f00:	6a 50                	push   $0x50
  jmp alltraps
80106f02:	e9 e7 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f07:	6a 00                	push   $0x0
  pushl $81
80106f09:	6a 51                	push   $0x51
  jmp alltraps
80106f0b:	e9 de f6 ff ff       	jmp    801065ee <alltraps>
...
80106f10:	6a 00                	push   $0x0
  pushl $82
80106f12:	6a 52                	push   $0x52
  jmp alltraps
80106f14:	e9 d5 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f19:	6a 00                	push   $0x0
  pushl $83
80106f1b:	6a 53                	push   $0x53
  jmp alltraps
80106f1d:	e9 cc f6 ff ff       	jmp    801065ee <alltraps>
...
80106f22:	6a 00                	push   $0x0
  pushl $84
80106f24:	6a 54                	push   $0x54
  jmp alltraps
80106f26:	e9 c3 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f2b:	6a 00                	push   $0x0
  pushl $85
80106f2d:	6a 55                	push   $0x55
  jmp alltraps
80106f2f:	e9 ba f6 ff ff       	jmp    801065ee <alltraps>
...
80106f34:	6a 00                	push   $0x0
  pushl $86
80106f36:	6a 56                	push   $0x56
  jmp alltraps
80106f38:	e9 b1 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f3d:	6a 00                	push   $0x0
  pushl $87
80106f3f:	6a 57                	push   $0x57
  jmp alltraps
80106f41:	e9 a8 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f46:	6a 00                	push   $0x0
  pushl $88
80106f48:	6a 58                	push   $0x58
  jmp alltraps
80106f4a:	e9 9f f6 ff ff       	jmp    801065ee <alltraps>
...
80106f4f:	6a 00                	push   $0x0
  pushl $89
80106f51:	6a 59                	push   $0x59
  jmp alltraps
80106f53:	e9 96 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f58:	6a 00                	push   $0x0
  pushl $90
80106f5a:	6a 5a                	push   $0x5a
  jmp alltraps
80106f5c:	e9 8d f6 ff ff       	jmp    801065ee <alltraps>
...
80106f61:	6a 00                	push   $0x0
  pushl $91
80106f63:	6a 5b                	push   $0x5b
  jmp alltraps
80106f65:	e9 84 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f6a:	6a 00                	push   $0x0
  pushl $92
80106f6c:	6a 5c                	push   $0x5c
  jmp alltraps
80106f6e:	e9 7b f6 ff ff       	jmp    801065ee <alltraps>
...
80106f73:	6a 00                	push   $0x0
  pushl $93
80106f75:	6a 5d                	push   $0x5d
  jmp alltraps
80106f77:	e9 72 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f7c:	6a 00                	push   $0x0
  pushl $94
80106f7e:	6a 5e                	push   $0x5e
  jmp alltraps
80106f80:	e9 69 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f85:	6a 00                	push   $0x0
  pushl $95
80106f87:	6a 5f                	push   $0x5f
  jmp alltraps
80106f89:	e9 60 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f8e:	6a 00                	push   $0x0
  pushl $96
80106f90:	6a 60                	push   $0x60
  jmp alltraps
80106f92:	e9 57 f6 ff ff       	jmp    801065ee <alltraps>
...
80106f97:	6a 00                	push   $0x0
  pushl $97
80106f99:	6a 61                	push   $0x61
  jmp alltraps
80106f9b:	e9 4e f6 ff ff       	jmp    801065ee <alltraps>
...
80106fa0:	6a 00                	push   $0x0
  pushl $98
80106fa2:	6a 62                	push   $0x62
  jmp alltraps
80106fa4:	e9 45 f6 ff ff       	jmp    801065ee <alltraps>
...
80106fa9:	6a 00                	push   $0x0
  pushl $99
80106fab:	6a 63                	push   $0x63
  jmp alltraps
80106fad:	e9 3c f6 ff ff       	jmp    801065ee <alltraps>
...
80106fb2:	6a 00                	push   $0x0
  pushl $100
80106fb4:	6a 64                	push   $0x64
  jmp alltraps
80106fb6:	e9 33 f6 ff ff       	jmp    801065ee <alltraps>
...
80106fbb:	6a 00                	push   $0x0
  pushl $101
80106fbd:	6a 65                	push   $0x65
  jmp alltraps
80106fbf:	e9 2a f6 ff ff       	jmp    801065ee <alltraps>
...
80106fc4:	6a 00                	push   $0x0
  pushl $102
80106fc6:	6a 66                	push   $0x66
  jmp alltraps
80106fc8:	e9 21 f6 ff ff       	jmp    801065ee <alltraps>
...
80106fcd:	6a 00                	push   $0x0
  pushl $103
80106fcf:	6a 67                	push   $0x67
  jmp alltraps
80106fd1:	e9 18 f6 ff ff       	jmp    801065ee <alltraps>
...
80106fd6:	6a 00                	push   $0x0
  pushl $104
80106fd8:	6a 68                	push   $0x68
  jmp alltraps
80106fda:	e9 0f f6 ff ff       	jmp    801065ee <alltraps>
...
80106fdf:	6a 00                	push   $0x0
  pushl $105
80106fe1:	6a 69                	push   $0x69
  jmp alltraps
80106fe3:	e9 06 f6 ff ff       	jmp    801065ee <alltraps>
...
80106fe8:	6a 00                	push   $0x0
  pushl $106
80106fea:	6a 6a                	push   $0x6a
  jmp alltraps
80106fec:	e9 fd f5 ff ff       	jmp    801065ee <alltraps>
...
80106ff1:	6a 00                	push   $0x0
  pushl $107
80106ff3:	6a 6b                	push   $0x6b
  jmp alltraps
80106ff5:	e9 f4 f5 ff ff       	jmp    801065ee <alltraps>
...
80106ffa:	6a 00                	push   $0x0
  pushl $108
80106ffc:	6a 6c                	push   $0x6c
  jmp alltraps
80106ffe:	e9 eb f5 ff ff       	jmp    801065ee <alltraps>
...
80107003:	6a 00                	push   $0x0
  pushl $109
80107005:	6a 6d                	push   $0x6d
  jmp alltraps
80107007:	e9 e2 f5 ff ff       	jmp    801065ee <alltraps>
...
8010700c:	6a 00                	push   $0x0
  pushl $110
8010700e:	6a 6e                	push   $0x6e
  jmp alltraps
80107010:	e9 d9 f5 ff ff       	jmp    801065ee <alltraps>
...
80107015:	6a 00                	push   $0x0
  pushl $111
80107017:	6a 6f                	push   $0x6f
  jmp alltraps
80107019:	e9 d0 f5 ff ff       	jmp    801065ee <alltraps>
...
8010701e:	6a 00                	push   $0x0
  pushl $112
80107020:	6a 70                	push   $0x70
  jmp alltraps
80107022:	e9 c7 f5 ff ff       	jmp    801065ee <alltraps>
...
80107027:	6a 00                	push   $0x0
  pushl $113
80107029:	6a 71                	push   $0x71
  jmp alltraps
8010702b:	e9 be f5 ff ff       	jmp    801065ee <alltraps>
...
80107030:	6a 00                	push   $0x0
  pushl $114
80107032:	6a 72                	push   $0x72
  jmp alltraps
80107034:	e9 b5 f5 ff ff       	jmp    801065ee <alltraps>
...
80107039:	6a 00                	push   $0x0
  pushl $115
8010703b:	6a 73                	push   $0x73
  jmp alltraps
8010703d:	e9 ac f5 ff ff       	jmp    801065ee <alltraps>
...
80107042:	6a 00                	push   $0x0
  pushl $116
80107044:	6a 74                	push   $0x74
  jmp alltraps
80107046:	e9 a3 f5 ff ff       	jmp    801065ee <alltraps>
...
8010704b:	6a 00                	push   $0x0
  pushl $117
8010704d:	6a 75                	push   $0x75
  jmp alltraps
8010704f:	e9 9a f5 ff ff       	jmp    801065ee <alltraps>
...
80107054:	6a 00                	push   $0x0
  pushl $118
80107056:	6a 76                	push   $0x76
  jmp alltraps
80107058:	e9 91 f5 ff ff       	jmp    801065ee <alltraps>
...
8010705d:	6a 00                	push   $0x0
  pushl $119
8010705f:	6a 77                	push   $0x77
  jmp alltraps
80107061:	e9 88 f5 ff ff       	jmp    801065ee <alltraps>
...
80107066:	6a 00                	push   $0x0
  pushl $120
80107068:	6a 78                	push   $0x78
  jmp alltraps
8010706a:	e9 7f f5 ff ff       	jmp    801065ee <alltraps>
...
8010706f:	6a 00                	push   $0x0
  pushl $121
80107071:	6a 79                	push   $0x79
  jmp alltraps
80107073:	e9 76 f5 ff ff       	jmp    801065ee <alltraps>
...
80107078:	6a 00                	push   $0x0
  pushl $122
8010707a:	6a 7a                	push   $0x7a
  jmp alltraps
8010707c:	e9 6d f5 ff ff       	jmp    801065ee <alltraps>
...
80107081:	6a 00                	push   $0x0
  pushl $123
80107083:	6a 7b                	push   $0x7b
  jmp alltraps
80107085:	e9 64 f5 ff ff       	jmp    801065ee <alltraps>
...
8010708a:	6a 00                	push   $0x0
  pushl $124
8010708c:	6a 7c                	push   $0x7c
  jmp alltraps
8010708e:	e9 5b f5 ff ff       	jmp    801065ee <alltraps>
...
80107093:	6a 00                	push   $0x0
  pushl $125
80107095:	6a 7d                	push   $0x7d
  jmp alltraps
80107097:	e9 52 f5 ff ff       	jmp    801065ee <alltraps>
...
8010709c:	6a 00                	push   $0x0
  pushl $126
8010709e:	6a 7e                	push   $0x7e
  jmp alltraps
801070a0:	e9 49 f5 ff ff       	jmp    801065ee <alltraps>
...
801070a5:	6a 00                	push   $0x0
  pushl $127
801070a7:	6a 7f                	push   $0x7f
  jmp alltraps
801070a9:	e9 40 f5 ff ff       	jmp    801065ee <alltraps>
...
801070ae:	6a 00                	push   $0x0
  pushl $128
801070b0:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801070b5:	e9 34 f5 ff ff       	jmp    801065ee <alltraps>
...
801070ba:	6a 00                	push   $0x0
  pushl $129
801070bc:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801070c1:	e9 28 f5 ff ff       	jmp    801065ee <alltraps>
...
801070c6:	6a 00                	push   $0x0
  pushl $130
801070c8:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801070cd:	e9 1c f5 ff ff       	jmp    801065ee <alltraps>
...
801070d2:	6a 00                	push   $0x0
  pushl $131
801070d4:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801070d9:	e9 10 f5 ff ff       	jmp    801065ee <alltraps>
...
801070de:	6a 00                	push   $0x0
  pushl $132
801070e0:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801070e5:	e9 04 f5 ff ff       	jmp    801065ee <alltraps>
...
801070ea:	6a 00                	push   $0x0
  pushl $133
801070ec:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801070f1:	e9 f8 f4 ff ff       	jmp    801065ee <alltraps>
...
801070f6:	6a 00                	push   $0x0
  pushl $134
801070f8:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801070fd:	e9 ec f4 ff ff       	jmp    801065ee <alltraps>
...
80107102:	6a 00                	push   $0x0
  pushl $135
80107104:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107109:	e9 e0 f4 ff ff       	jmp    801065ee <alltraps>
...
8010710e:	6a 00                	push   $0x0
  pushl $136
80107110:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107115:	e9 d4 f4 ff ff       	jmp    801065ee <alltraps>
...
8010711a:	6a 00                	push   $0x0
  pushl $137
8010711c:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107121:	e9 c8 f4 ff ff       	jmp    801065ee <alltraps>
...
80107126:	6a 00                	push   $0x0
  pushl $138
80107128:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010712d:	e9 bc f4 ff ff       	jmp    801065ee <alltraps>
...
80107132:	6a 00                	push   $0x0
  pushl $139
80107134:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107139:	e9 b0 f4 ff ff       	jmp    801065ee <alltraps>
...
8010713e:	6a 00                	push   $0x0
  pushl $140
80107140:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107145:	e9 a4 f4 ff ff       	jmp    801065ee <alltraps>
...
8010714a:	6a 00                	push   $0x0
  pushl $141
8010714c:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107151:	e9 98 f4 ff ff       	jmp    801065ee <alltraps>
...
80107156:	6a 00                	push   $0x0
  pushl $142
80107158:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010715d:	e9 8c f4 ff ff       	jmp    801065ee <alltraps>
...
80107162:	6a 00                	push   $0x0
  pushl $143
80107164:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107169:	e9 80 f4 ff ff       	jmp    801065ee <alltraps>
...
8010716e:	6a 00                	push   $0x0
  pushl $144
80107170:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107175:	e9 74 f4 ff ff       	jmp    801065ee <alltraps>
...
8010717a:	6a 00                	push   $0x0
  pushl $145
8010717c:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107181:	e9 68 f4 ff ff       	jmp    801065ee <alltraps>
...
80107186:	6a 00                	push   $0x0
  pushl $146
80107188:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010718d:	e9 5c f4 ff ff       	jmp    801065ee <alltraps>
...
80107192:	6a 00                	push   $0x0
  pushl $147
80107194:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107199:	e9 50 f4 ff ff       	jmp    801065ee <alltraps>
...
8010719e:	6a 00                	push   $0x0
  pushl $148
801071a0:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801071a5:	e9 44 f4 ff ff       	jmp    801065ee <alltraps>
...
801071aa:	6a 00                	push   $0x0
  pushl $149
801071ac:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801071b1:	e9 38 f4 ff ff       	jmp    801065ee <alltraps>
...
801071b6:	6a 00                	push   $0x0
  pushl $150
801071b8:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801071bd:	e9 2c f4 ff ff       	jmp    801065ee <alltraps>
...
801071c2:	6a 00                	push   $0x0
  pushl $151
801071c4:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801071c9:	e9 20 f4 ff ff       	jmp    801065ee <alltraps>
...
801071ce:	6a 00                	push   $0x0
  pushl $152
801071d0:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801071d5:	e9 14 f4 ff ff       	jmp    801065ee <alltraps>
...
801071da:	6a 00                	push   $0x0
  pushl $153
801071dc:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801071e1:	e9 08 f4 ff ff       	jmp    801065ee <alltraps>
...
801071e6:	6a 00                	push   $0x0
  pushl $154
801071e8:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801071ed:	e9 fc f3 ff ff       	jmp    801065ee <alltraps>
...
801071f2:	6a 00                	push   $0x0
  pushl $155
801071f4:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801071f9:	e9 f0 f3 ff ff       	jmp    801065ee <alltraps>
...
801071fe:	6a 00                	push   $0x0
  pushl $156
80107200:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107205:	e9 e4 f3 ff ff       	jmp    801065ee <alltraps>
...
8010720a:	6a 00                	push   $0x0
  pushl $157
8010720c:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107211:	e9 d8 f3 ff ff       	jmp    801065ee <alltraps>
...
80107216:	6a 00                	push   $0x0
  pushl $158
80107218:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010721d:	e9 cc f3 ff ff       	jmp    801065ee <alltraps>
...
80107222:	6a 00                	push   $0x0
  pushl $159
80107224:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107229:	e9 c0 f3 ff ff       	jmp    801065ee <alltraps>
...
8010722e:	6a 00                	push   $0x0
  pushl $160
80107230:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107235:	e9 b4 f3 ff ff       	jmp    801065ee <alltraps>
...
8010723a:	6a 00                	push   $0x0
  pushl $161
8010723c:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107241:	e9 a8 f3 ff ff       	jmp    801065ee <alltraps>
...
80107246:	6a 00                	push   $0x0
  pushl $162
80107248:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010724d:	e9 9c f3 ff ff       	jmp    801065ee <alltraps>
...
80107252:	6a 00                	push   $0x0
  pushl $163
80107254:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107259:	e9 90 f3 ff ff       	jmp    801065ee <alltraps>
...
8010725e:	6a 00                	push   $0x0
  pushl $164
80107260:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107265:	e9 84 f3 ff ff       	jmp    801065ee <alltraps>
...
8010726a:	6a 00                	push   $0x0
  pushl $165
8010726c:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107271:	e9 78 f3 ff ff       	jmp    801065ee <alltraps>
...
80107276:	6a 00                	push   $0x0
  pushl $166
80107278:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010727d:	e9 6c f3 ff ff       	jmp    801065ee <alltraps>
...
80107282:	6a 00                	push   $0x0
  pushl $167
80107284:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107289:	e9 60 f3 ff ff       	jmp    801065ee <alltraps>
...
8010728e:	6a 00                	push   $0x0
  pushl $168
80107290:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107295:	e9 54 f3 ff ff       	jmp    801065ee <alltraps>
...
8010729a:	6a 00                	push   $0x0
  pushl $169
8010729c:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801072a1:	e9 48 f3 ff ff       	jmp    801065ee <alltraps>
...
801072a6:	6a 00                	push   $0x0
  pushl $170
801072a8:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801072ad:	e9 3c f3 ff ff       	jmp    801065ee <alltraps>
...
801072b2:	6a 00                	push   $0x0
  pushl $171
801072b4:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801072b9:	e9 30 f3 ff ff       	jmp    801065ee <alltraps>
...
801072be:	6a 00                	push   $0x0
  pushl $172
801072c0:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801072c5:	e9 24 f3 ff ff       	jmp    801065ee <alltraps>
...
801072ca:	6a 00                	push   $0x0
  pushl $173
801072cc:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801072d1:	e9 18 f3 ff ff       	jmp    801065ee <alltraps>
...
801072d6:	6a 00                	push   $0x0
  pushl $174
801072d8:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801072dd:	e9 0c f3 ff ff       	jmp    801065ee <alltraps>
...
801072e2:	6a 00                	push   $0x0
  pushl $175
801072e4:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801072e9:	e9 00 f3 ff ff       	jmp    801065ee <alltraps>
...
801072ee:	6a 00                	push   $0x0
  pushl $176
801072f0:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801072f5:	e9 f4 f2 ff ff       	jmp    801065ee <alltraps>
...
801072fa:	6a 00                	push   $0x0
  pushl $177
801072fc:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107301:	e9 e8 f2 ff ff       	jmp    801065ee <alltraps>
...
80107306:	6a 00                	push   $0x0
  pushl $178
80107308:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010730d:	e9 dc f2 ff ff       	jmp    801065ee <alltraps>
...
80107312:	6a 00                	push   $0x0
  pushl $179
80107314:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107319:	e9 d0 f2 ff ff       	jmp    801065ee <alltraps>
...
8010731e:	6a 00                	push   $0x0
  pushl $180
80107320:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107325:	e9 c4 f2 ff ff       	jmp    801065ee <alltraps>
...
8010732a:	6a 00                	push   $0x0
  pushl $181
8010732c:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107331:	e9 b8 f2 ff ff       	jmp    801065ee <alltraps>
...
80107336:	6a 00                	push   $0x0
  pushl $182
80107338:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010733d:	e9 ac f2 ff ff       	jmp    801065ee <alltraps>
...
80107342:	6a 00                	push   $0x0
  pushl $183
80107344:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107349:	e9 a0 f2 ff ff       	jmp    801065ee <alltraps>
...
8010734e:	6a 00                	push   $0x0
  pushl $184
80107350:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107355:	e9 94 f2 ff ff       	jmp    801065ee <alltraps>
...
8010735a:	6a 00                	push   $0x0
  pushl $185
8010735c:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107361:	e9 88 f2 ff ff       	jmp    801065ee <alltraps>
...
80107366:	6a 00                	push   $0x0
  pushl $186
80107368:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010736d:	e9 7c f2 ff ff       	jmp    801065ee <alltraps>
...
80107372:	6a 00                	push   $0x0
  pushl $187
80107374:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107379:	e9 70 f2 ff ff       	jmp    801065ee <alltraps>
...
8010737e:	6a 00                	push   $0x0
  pushl $188
80107380:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107385:	e9 64 f2 ff ff       	jmp    801065ee <alltraps>
...
8010738a:	6a 00                	push   $0x0
  pushl $189
8010738c:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107391:	e9 58 f2 ff ff       	jmp    801065ee <alltraps>
...
80107396:	6a 00                	push   $0x0
  pushl $190
80107398:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010739d:	e9 4c f2 ff ff       	jmp    801065ee <alltraps>
...
801073a2:	6a 00                	push   $0x0
  pushl $191
801073a4:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801073a9:	e9 40 f2 ff ff       	jmp    801065ee <alltraps>
...
801073ae:	6a 00                	push   $0x0
  pushl $192
801073b0:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801073b5:	e9 34 f2 ff ff       	jmp    801065ee <alltraps>
...
801073ba:	6a 00                	push   $0x0
  pushl $193
801073bc:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801073c1:	e9 28 f2 ff ff       	jmp    801065ee <alltraps>
...
801073c6:	6a 00                	push   $0x0
  pushl $194
801073c8:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801073cd:	e9 1c f2 ff ff       	jmp    801065ee <alltraps>
...
801073d2:	6a 00                	push   $0x0
  pushl $195
801073d4:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801073d9:	e9 10 f2 ff ff       	jmp    801065ee <alltraps>
...
801073de:	6a 00                	push   $0x0
  pushl $196
801073e0:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801073e5:	e9 04 f2 ff ff       	jmp    801065ee <alltraps>
...
801073ea:	6a 00                	push   $0x0
  pushl $197
801073ec:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801073f1:	e9 f8 f1 ff ff       	jmp    801065ee <alltraps>
...
801073f6:	6a 00                	push   $0x0
  pushl $198
801073f8:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801073fd:	e9 ec f1 ff ff       	jmp    801065ee <alltraps>
...
80107402:	6a 00                	push   $0x0
  pushl $199
80107404:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107409:	e9 e0 f1 ff ff       	jmp    801065ee <alltraps>
...
8010740e:	6a 00                	push   $0x0
  pushl $200
80107410:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107415:	e9 d4 f1 ff ff       	jmp    801065ee <alltraps>
...
8010741a:	6a 00                	push   $0x0
  pushl $201
8010741c:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107421:	e9 c8 f1 ff ff       	jmp    801065ee <alltraps>
...
80107426:	6a 00                	push   $0x0
  pushl $202
80107428:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010742d:	e9 bc f1 ff ff       	jmp    801065ee <alltraps>
...
80107432:	6a 00                	push   $0x0
  pushl $203
80107434:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107439:	e9 b0 f1 ff ff       	jmp    801065ee <alltraps>
...
8010743e:	6a 00                	push   $0x0
  pushl $204
80107440:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107445:	e9 a4 f1 ff ff       	jmp    801065ee <alltraps>
...
8010744a:	6a 00                	push   $0x0
  pushl $205
8010744c:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107451:	e9 98 f1 ff ff       	jmp    801065ee <alltraps>
...
80107456:	6a 00                	push   $0x0
  pushl $206
80107458:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010745d:	e9 8c f1 ff ff       	jmp    801065ee <alltraps>
...
80107462:	6a 00                	push   $0x0
  pushl $207
80107464:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107469:	e9 80 f1 ff ff       	jmp    801065ee <alltraps>
...
8010746e:	6a 00                	push   $0x0
  pushl $208
80107470:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107475:	e9 74 f1 ff ff       	jmp    801065ee <alltraps>
...
8010747a:	6a 00                	push   $0x0
  pushl $209
8010747c:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107481:	e9 68 f1 ff ff       	jmp    801065ee <alltraps>
...
80107486:	6a 00                	push   $0x0
  pushl $210
80107488:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010748d:	e9 5c f1 ff ff       	jmp    801065ee <alltraps>
...
80107492:	6a 00                	push   $0x0
  pushl $211
80107494:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107499:	e9 50 f1 ff ff       	jmp    801065ee <alltraps>
...
8010749e:	6a 00                	push   $0x0
  pushl $212
801074a0:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801074a5:	e9 44 f1 ff ff       	jmp    801065ee <alltraps>
...
801074aa:	6a 00                	push   $0x0
  pushl $213
801074ac:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801074b1:	e9 38 f1 ff ff       	jmp    801065ee <alltraps>
...
801074b6:	6a 00                	push   $0x0
  pushl $214
801074b8:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801074bd:	e9 2c f1 ff ff       	jmp    801065ee <alltraps>
...
801074c2:	6a 00                	push   $0x0
  pushl $215
801074c4:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801074c9:	e9 20 f1 ff ff       	jmp    801065ee <alltraps>
...
801074ce:	6a 00                	push   $0x0
  pushl $216
801074d0:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801074d5:	e9 14 f1 ff ff       	jmp    801065ee <alltraps>
...
801074da:	6a 00                	push   $0x0
  pushl $217
801074dc:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801074e1:	e9 08 f1 ff ff       	jmp    801065ee <alltraps>
...
801074e6:	6a 00                	push   $0x0
  pushl $218
801074e8:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801074ed:	e9 fc f0 ff ff       	jmp    801065ee <alltraps>
...
801074f2:	6a 00                	push   $0x0
  pushl $219
801074f4:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801074f9:	e9 f0 f0 ff ff       	jmp    801065ee <alltraps>
...
801074fe:	6a 00                	push   $0x0
  pushl $220
80107500:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107505:	e9 e4 f0 ff ff       	jmp    801065ee <alltraps>
...
8010750a:	6a 00                	push   $0x0
  pushl $221
8010750c:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107511:	e9 d8 f0 ff ff       	jmp    801065ee <alltraps>
...
80107516:	6a 00                	push   $0x0
  pushl $222
80107518:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010751d:	e9 cc f0 ff ff       	jmp    801065ee <alltraps>
...
80107522:	6a 00                	push   $0x0
  pushl $223
80107524:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107529:	e9 c0 f0 ff ff       	jmp    801065ee <alltraps>
...
8010752e:	6a 00                	push   $0x0
  pushl $224
80107530:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107535:	e9 b4 f0 ff ff       	jmp    801065ee <alltraps>
...
8010753a:	6a 00                	push   $0x0
  pushl $225
8010753c:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107541:	e9 a8 f0 ff ff       	jmp    801065ee <alltraps>
...
80107546:	6a 00                	push   $0x0
  pushl $226
80107548:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010754d:	e9 9c f0 ff ff       	jmp    801065ee <alltraps>
...
80107552:	6a 00                	push   $0x0
  pushl $227
80107554:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107559:	e9 90 f0 ff ff       	jmp    801065ee <alltraps>
...
8010755e:	6a 00                	push   $0x0
  pushl $228
80107560:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107565:	e9 84 f0 ff ff       	jmp    801065ee <alltraps>
...
8010756a:	6a 00                	push   $0x0
  pushl $229
8010756c:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107571:	e9 78 f0 ff ff       	jmp    801065ee <alltraps>
...
80107576:	6a 00                	push   $0x0
  pushl $230
80107578:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010757d:	e9 6c f0 ff ff       	jmp    801065ee <alltraps>
...
80107582:	6a 00                	push   $0x0
  pushl $231
80107584:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107589:	e9 60 f0 ff ff       	jmp    801065ee <alltraps>
...
8010758e:	6a 00                	push   $0x0
  pushl $232
80107590:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107595:	e9 54 f0 ff ff       	jmp    801065ee <alltraps>
...
8010759a:	6a 00                	push   $0x0
  pushl $233
8010759c:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801075a1:	e9 48 f0 ff ff       	jmp    801065ee <alltraps>
...
801075a6:	6a 00                	push   $0x0
  pushl $234
801075a8:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801075ad:	e9 3c f0 ff ff       	jmp    801065ee <alltraps>
...
801075b2:	6a 00                	push   $0x0
  pushl $235
801075b4:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801075b9:	e9 30 f0 ff ff       	jmp    801065ee <alltraps>
...
801075be:	6a 00                	push   $0x0
  pushl $236
801075c0:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801075c5:	e9 24 f0 ff ff       	jmp    801065ee <alltraps>
...
801075ca:	6a 00                	push   $0x0
  pushl $237
801075cc:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801075d1:	e9 18 f0 ff ff       	jmp    801065ee <alltraps>
...
801075d6:	6a 00                	push   $0x0
  pushl $238
801075d8:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801075dd:	e9 0c f0 ff ff       	jmp    801065ee <alltraps>
...
801075e2:	6a 00                	push   $0x0
  pushl $239
801075e4:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801075e9:	e9 00 f0 ff ff       	jmp    801065ee <alltraps>
...
801075ee:	6a 00                	push   $0x0
  pushl $240
801075f0:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801075f5:	e9 f4 ef ff ff       	jmp    801065ee <alltraps>
...
801075fa:	6a 00                	push   $0x0
  pushl $241
801075fc:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107601:	e9 e8 ef ff ff       	jmp    801065ee <alltraps>
...
80107606:	6a 00                	push   $0x0
  pushl $242
80107608:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010760d:	e9 dc ef ff ff       	jmp    801065ee <alltraps>
...
80107612:	6a 00                	push   $0x0
  pushl $243
80107614:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107619:	e9 d0 ef ff ff       	jmp    801065ee <alltraps>
...
8010761e:	6a 00                	push   $0x0
  pushl $244
80107620:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107625:	e9 c4 ef ff ff       	jmp    801065ee <alltraps>
...
8010762a:	6a 00                	push   $0x0
  pushl $245
8010762c:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107631:	e9 b8 ef ff ff       	jmp    801065ee <alltraps>
...
80107636:	6a 00                	push   $0x0
  pushl $246
80107638:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010763d:	e9 ac ef ff ff       	jmp    801065ee <alltraps>
...
80107642:	6a 00                	push   $0x0
  pushl $247
80107644:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107649:	e9 a0 ef ff ff       	jmp    801065ee <alltraps>
...
8010764e:	6a 00                	push   $0x0
  pushl $248
80107650:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107655:	e9 94 ef ff ff       	jmp    801065ee <alltraps>
...
8010765a:	6a 00                	push   $0x0
  pushl $249
8010765c:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107661:	e9 88 ef ff ff       	jmp    801065ee <alltraps>
...
80107666:	6a 00                	push   $0x0
  pushl $250
80107668:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010766d:	e9 7c ef ff ff       	jmp    801065ee <alltraps>
...
80107672:	6a 00                	push   $0x0
  pushl $251
80107674:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107679:	e9 70 ef ff ff       	jmp    801065ee <alltraps>
...
8010767e:	6a 00                	push   $0x0
  pushl $252
80107680:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107685:	e9 64 ef ff ff       	jmp    801065ee <alltraps>
...
8010768a:	6a 00                	push   $0x0
  pushl $253
8010768c:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107691:	e9 58 ef ff ff       	jmp    801065ee <alltraps>
...
80107696:	6a 00                	push   $0x0
  pushl $254
80107698:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010769d:	e9 4c ef ff ff       	jmp    801065ee <alltraps>
...
801076a2:	6a 00                	push   $0x0
  pushl $255
801076a4:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801076a9:	e9 40 ef ff ff       	jmp    801065ee <alltraps>

801076ae <lgdt>:
{
801076ae:	55                   	push   %ebp
801076af:	89 e5                	mov    %esp,%ebp
801076b1:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
801076b4:	8b 45 0c             	mov    0xc(%ebp),%eax
801076b7:	83 e8 01             	sub    $0x1,%eax
801076ba:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801076be:	8b 45 08             	mov    0x8(%ebp),%eax
801076c1:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801076c5:	8b 45 08             	mov    0x8(%ebp),%eax
801076c8:	c1 e8 10             	shr    $0x10,%eax
801076cb:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801076cf:	8d 45 fa             	lea    -0x6(%ebp),%eax
801076d2:	0f 01 10             	lgdtl  (%eax)
}
801076d5:	c9                   	leave  
801076d6:	c3                   	ret    
...
801076e4:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801076e8:	0f 00 d8             	ltr    %ax
}
801076eb:	c9                   	leave  
801076ec:	c3                   	ret    
...
801076fb:	83 ec 28             	sub    $0x28,%esp
  ...
  c = &cpus[cpuid()];
801076fe:	e8 c7 c9 ff ff       	call   801040ca <cpuid>
80107703:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80107709:	05 00 38 11 80       	add    $0x80113800,%eax
8010770e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107711:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107714:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
8010771a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010771d:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107723:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107726:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
8010772a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010772d:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107731:	83 e2 f0             	and    $0xfffffff0,%edx
80107734:	83 ca 0a             	or     $0xa,%edx
80107737:	88 50 7d             	mov    %dl,0x7d(%eax)
8010773a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010773d:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
...
8010774e:	83 e2 9f             	and    $0xffffff9f,%edx
...
801077a5:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801077a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ac:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
801077b3:	ff ff 
801077b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077b8:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
801077bf:	00 00 
801077c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c4:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
801077cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ce:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801077d5:	83 e2 f0             	and    $0xfffffff0,%edx
801077d8:	83 ca 02             	or     $0x2,%edx
...
801077f7:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801077fe:	83 e2 9f             	and    $0xffffff9f,%edx
80107801:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107807:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010780a:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107811:	83 ca 80             	or     $0xffffff80,%edx
80107814:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
...
80107856:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010785d:	83 ca 40             	or     $0x40,%edx
80107860:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
...
8010787c:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107883:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107886:	66 c7 80 88 00 00 00 	movw   $0xffff,0x88(%eax)
8010788d:	ff ff 
8010788f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107892:	66 c7 80 8a 00 00 00 	movw   $0x0,0x8a(%eax)
80107899:	00 00 
8010789b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010789e:	c6 80 8c 00 00 00 00 	movb   $0x0,0x8c(%eax)
801078a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078a8:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801078af:	83 e2 f0             	and    $0xfffffff0,%edx
801078b2:	83 ca 0a             	or     $0xa,%edx
801078b5:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801078bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078be:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801078c5:	83 ca 10             	or     $0x10,%edx
801078c8:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801078ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078d1:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801078d8:	83 ca 60             	or     $0x60,%edx
801078db:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801078e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078e4:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801078eb:	83 ca 80             	or     $0xffffff80,%edx
801078ee:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801078f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078f7:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
801078fe:	83 ca 0f             	or     $0xf,%edx
80107901:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107907:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010790a:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107911:	83 e2 ef             	and    $0xffffffef,%edx
80107914:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
8010791a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010791d:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107924:	83 e2 df             	and    $0xffffffdf,%edx
80107927:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
8010792d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107930:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107937:	83 ca 40             	or     $0x40,%edx
8010793a:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
...
80107956:	c6 80 8f 00 00 00 00 	movb   $0x0,0x8f(%eax)
...
80107a3a:	83 c0 70             	add    $0x70,%eax
80107a3d:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
80107a44:	00 
80107a45:	89 04 24             	mov    %eax,(%esp)
80107a48:	e8 61 fc ff ff       	call   801076ae <lgdt>
}
80107a4d:	c9                   	leave  
80107a4e:	c3                   	ret    
...
80107a58:	c1 e8 16             	shr    $0x16,%eax
80107a5b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107a62:	8b 45 08             	mov    0x8(%ebp),%eax
80107a65:	01 d0                	add    %edx,%eax
80107a67:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107a6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a6d:	8b 00                	mov    (%eax),%eax
80107a6f:	83 e0 01             	and    $0x1,%eax
80107a72:	85 c0                	test   %eax,%eax
80107a74:	74 14                	je     80107a8a <walkpgdir+0x3b>
...
80107a88:	eb 48                	jmp    80107ad2 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107a8a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107a8e:	74 0e                	je     80107a9e <walkpgdir+0x4f>
80107a90:	e8 14 b1 ff ff       	call   80102ba9 <kalloc>
80107a95:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107a98:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107a9c:	75 07                	jne    80107aa5 <walkpgdir+0x56>
      return 0;
80107a9e:	b8 00 00 00 00       	mov    $0x0,%eax
80107aa3:	eb 44                	jmp    80107ae9 <walkpgdir+0x9a>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107aa5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107aac:	00 
80107aad:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107ab4:	00 
80107ab5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ab8:	89 04 24             	mov    %eax,(%esp)
80107abb:	e8 67 d7 ff ff       	call   80105227 <memset>
...
80107ac8:	83 c8 07             	or     $0x7,%eax
80107acb:	89 c2                	mov    %eax,%edx
80107acd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ad0:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107ad2:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ad5:	c1 e8 0c             	shr    $0xc,%eax
80107ad8:	25 ff 03 00 00       	and    $0x3ff,%eax
80107add:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107aee:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80107af1:	8b 45 0c             	mov    0xc(%ebp),%eax
80107af4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107af9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107afc:	8b 55 0c             	mov    0xc(%ebp),%edx
80107aff:	8b 45 10             	mov    0x10(%ebp),%eax
80107b02:	01 d0                	add    %edx,%eax
80107b04:	83 e8 01             	sub    $0x1,%eax
80107b07:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107b0c:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107b0f:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107b16:	00 
80107b17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b1a:	89 44 24 04          	mov    %eax,0x4(%esp)
80107b1e:	8b 45 08             	mov    0x8(%ebp),%eax
80107b21:	89 04 24             	mov    %eax,(%esp)
80107b24:	e8 26 ff ff ff       	call   80107a4f <walkpgdir>
80107b29:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107b2c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107b30:	75 07                	jne    80107b39 <mappages+0x4e>
      return -1;
80107b32:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107b37:	eb 48                	jmp    80107b81 <mappages+0x96>
    if(*pte & PTE_P)
80107b39:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107b3c:	8b 00                	mov    (%eax),%eax
80107b3e:	83 e0 01             	and    $0x1,%eax
80107b41:	85 c0                	test   %eax,%eax
80107b43:	74 0c                	je     80107b51 <mappages+0x66>
      panic("remap");
80107b45:	c7 04 24 7c 8a 10 80 	movl   $0x80108a7c,(%esp)
80107b4c:	e8 11 8a ff ff       	call   80100562 <panic>
    *pte = pa | perm | PTE_P;
...
80107b67:	75 08                	jne    80107b71 <mappages+0x86>
      break;
80107b69:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
  ...
  return 0;
80107b6a:	b8 00 00 00 00       	mov    $0x0,%eax
80107b6f:	eb 10                	jmp    80107b81 <mappages+0x96>
    a += PGSIZE;
80107b71:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107b78:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107b7f:	eb 8e                	jmp    80107b0f <mappages+0x24>
}
80107b81:	c9                   	leave  
80107b82:	c3                   	ret    
...
80107b86:	53                   	push   %ebx
80107b87:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107b8a:	e8 1a b0 ff ff       	call   80102ba9 <kalloc>
80107b8f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107b92:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107b96:	75 0a                	jne    80107ba2 <setupkvm+0x1f>
    return 0;
80107b98:	b8 00 00 00 00       	mov    $0x0,%eax
80107b9d:	e9 84 00 00 00       	jmp    80107c26 <setupkvm+0xa3>
  memset(pgdir, 0, PGSIZE);
80107ba2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107ba9:	00 
80107baa:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107bb1:	00 
80107bb2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107bb5:	89 04 24             	mov    %eax,(%esp)
80107bb8:	e8 6a d6 ff ff       	call   80105227 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107bbd:	c7 45 f4 80 b4 10 80 	movl   $0x8010b480,-0xc(%ebp)
80107bc4:	eb 54                	jmp    80107c1a <setupkvm+0x97>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80107bc6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bc9:	8b 48 0c             	mov    0xc(%eax),%ecx
80107bcc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bcf:	8b 50 04             	mov    0x4(%eax),%edx
80107bd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bd5:	8b 58 08             	mov    0x8(%eax),%ebx
80107bd8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bdb:	8b 40 04             	mov    0x4(%eax),%eax
80107bde:	29 c3                	sub    %eax,%ebx
80107be0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107be3:	8b 00                	mov    (%eax),%eax
80107be5:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107be9:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107bed:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107bf1:	89 44 24 04          	mov    %eax,0x4(%esp)
80107bf5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107bf8:	89 04 24             	mov    %eax,(%esp)
80107bfb:	e8 eb fe ff ff       	call   80107aeb <mappages>
80107c00:	85 c0                	test   %eax,%eax
80107c02:	79 12                	jns    80107c16 <setupkvm+0x93>
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80107c04:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c07:	89 04 24             	mov    %eax,(%esp)
80107c0a:	e8 26 05 00 00       	call   80108135 <freevm>
      return 0;
80107c0f:	b8 00 00 00 00       	mov    $0x0,%eax
80107c14:	eb 10                	jmp    80107c26 <setupkvm+0xa3>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c16:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107c1a:	81 7d f4 c0 b4 10 80 	cmpl   $0x8010b4c0,-0xc(%ebp)
80107c21:	72 a3                	jb     80107bc6 <setupkvm+0x43>
    }
  return pgdir;
80107c23:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80107c26:	83 c4 34             	add    $0x34,%esp
80107c29:	5b                   	pop    %ebx
80107c2a:	5d                   	pop    %ebp
80107c2b:	c3                   	ret    
...
80107c2f:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107c32:	e8 4c ff ff ff       	call   80107b83 <setupkvm>
80107c37:	a3 24 67 11 80       	mov    %eax,0x80116724
  switchkvm();
80107c3c:	e8 02 00 00 00       	call   80107c43 <switchkvm>
}
80107c41:	c9                   	leave  
80107c42:	c3                   	ret    
...
80107c49:	a1 24 67 11 80       	mov    0x80116724,%eax
80107c4e:	05 00 00 00 80       	add    $0x80000000,%eax
80107c53:	89 04 24             	mov    %eax,(%esp)
80107c56:	e8 92 fa ff ff       	call   801076ed <lcr3>
}
80107c5b:	c9                   	leave  
80107c5c:	c3                   	ret    
...
80107c60:	57                   	push   %edi
80107c61:	56                   	push   %esi
80107c62:	53                   	push   %ebx
80107c63:	83 ec 1c             	sub    $0x1c,%esp
  if(p == 0)
80107c66:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107c6a:	75 0c                	jne    80107c78 <switchuvm+0x1b>
    panic("switchuvm: no process");
80107c6c:	c7 04 24 82 8a 10 80 	movl   $0x80108a82,(%esp)
80107c73:	e8 ea 88 ff ff       	call   80100562 <panic>
  if(p->kstack == 0)
80107c78:	8b 45 08             	mov    0x8(%ebp),%eax
80107c7b:	8b 40 08             	mov    0x8(%eax),%eax
80107c7e:	85 c0                	test   %eax,%eax
80107c80:	75 0c                	jne    80107c8e <switchuvm+0x31>
    panic("switchuvm: no kstack");
80107c82:	c7 04 24 98 8a 10 80 	movl   $0x80108a98,(%esp)
80107c89:	e8 d4 88 ff ff       	call   80100562 <panic>
  if(p->pgdir == 0)
80107c8e:	8b 45 08             	mov    0x8(%ebp),%eax
80107c91:	8b 40 04             	mov    0x4(%eax),%eax
80107c94:	85 c0                	test   %eax,%eax
80107c96:	75 0c                	jne    80107ca4 <switchuvm+0x47>
    panic("switchuvm: no pgdir");
80107c98:	c7 04 24 ad 8a 10 80 	movl   $0x80108aad,(%esp)
80107c9f:	e8 be 88 ff ff       	call   80100562 <panic>

  pushcli();
80107ca4:	e8 79 d4 ff ff       	call   80105122 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107ca9:	e8 3d c4 ff ff       	call   801040eb <mycpu>
80107cae:	89 c3                	mov    %eax,%ebx
80107cb0:	e8 36 c4 ff ff       	call   801040eb <mycpu>
80107cb5:	83 c0 08             	add    $0x8,%eax
80107cb8:	89 c7                	mov    %eax,%edi
80107cba:	e8 2c c4 ff ff       	call   801040eb <mycpu>
80107cbf:	83 c0 08             	add    $0x8,%eax
80107cc2:	c1 e8 10             	shr    $0x10,%eax
80107cc5:	89 c6                	mov    %eax,%esi
80107cc7:	e8 1f c4 ff ff       	call   801040eb <mycpu>
80107ccc:	83 c0 08             	add    $0x8,%eax
80107ccf:	c1 e8 18             	shr    $0x18,%eax
80107cd2:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80107cd9:	67 00 
80107cdb:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107ce2:	89 f1                	mov    %esi,%ecx
80107ce4:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107cea:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107cf1:	83 e2 f0             	and    $0xfffffff0,%edx
80107cf4:	83 ca 09             	or     $0x9,%edx
80107cf7:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107cfd:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107d04:	83 ca 10             	or     $0x10,%edx
80107d07:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107d0d:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107d14:	83 e2 9f             	and    $0xffffff9f,%edx
80107d17:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107d1d:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107d24:	83 ca 80             	or     $0xffffff80,%edx
80107d27:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107d2d:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107d34:	83 e2 f0             	and    $0xfffffff0,%edx
80107d37:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107d3d:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107d44:	83 e2 ef             	and    $0xffffffef,%edx
80107d47:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107d4d:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107d54:	83 e2 df             	and    $0xffffffdf,%edx
80107d57:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107d5d:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107d64:	83 ca 40             	or     $0x40,%edx
80107d67:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107d6d:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107d74:	83 e2 7f             	and    $0x7f,%edx
80107d77:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107d7d:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80107d83:	e8 63 c3 ff ff       	call   801040eb <mycpu>
...
80107d98:	e8 4e c3 ff ff       	call   801040eb <mycpu>
80107d9d:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107da3:	e8 43 c3 ff ff       	call   801040eb <mycpu>
80107da8:	8b 55 08             	mov    0x8(%ebp),%edx
80107dab:	8b 52 08             	mov    0x8(%edx),%edx
80107dae:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107db4:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107db7:	e8 2f c3 ff ff       	call   801040eb <mycpu>
80107dbc:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  ltr(SEG_TSS << 3);
80107dc2:	c7 04 24 28 00 00 00 	movl   $0x28,(%esp)
80107dc9:	e8 09 f9 ff ff       	call   801076d7 <ltr>
  lcr3(V2P(p->pgdir));  // switch to process's address space
80107dce:	8b 45 08             	mov    0x8(%ebp),%eax
80107dd1:	8b 40 04             	mov    0x4(%eax),%eax
80107dd4:	05 00 00 00 80       	add    $0x80000000,%eax
80107dd9:	89 04 24             	mov    %eax,(%esp)
80107ddc:	e8 0c f9 ff ff       	call   801076ed <lcr3>
  popcli();
80107de1:	e8 88 d3 ff ff       	call   8010516e <popcli>
}
80107de6:	83 c4 1c             	add    $0x1c,%esp
80107de9:	5b                   	pop    %ebx
80107dea:	5e                   	pop    %esi
80107deb:	5f                   	pop    %edi
80107dec:	5d                   	pop    %ebp
...
80107df1:	83 ec 38             	sub    $0x38,%esp
  char *mem;

  if(sz >= PGSIZE)
80107df4:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107dfb:	76 0c                	jbe    80107e09 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107dfd:	c7 04 24 c1 8a 10 80 	movl   $0x80108ac1,(%esp)
80107e04:	e8 59 87 ff ff       	call   80100562 <panic>
  mem = kalloc();
80107e09:	e8 9b ad ff ff       	call   80102ba9 <kalloc>
80107e0e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80107e11:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e18:	00 
80107e19:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e20:	00 
80107e21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e24:	89 04 24             	mov    %eax,(%esp)
80107e27:	e8 fb d3 ff ff       	call   80105227 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107e2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e2f:	05 00 00 00 80       	add    $0x80000000,%eax
...
80107e47:	00 
80107e48:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e4f:	00 
80107e50:	8b 45 08             	mov    0x8(%ebp),%eax
80107e53:	89 04 24             	mov    %eax,(%esp)
80107e56:	e8 90 fc ff ff       	call   80107aeb <mappages>
  memmove(mem, init, sz);
80107e5b:	8b 45 10             	mov    0x10(%ebp),%eax
80107e5e:	89 44 24 08          	mov    %eax,0x8(%esp)
80107e62:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e65:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e6c:	89 04 24             	mov    %eax,(%esp)
80107e6f:	e8 82 d4 ff ff       	call   801052f6 <memmove>
}
80107e74:	c9                   	leave  
80107e75:	c3                   	ret    
...
80107e79:	83 ec 28             	sub    $0x28,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107e7c:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e7f:	25 ff 0f 00 00       	and    $0xfff,%eax
80107e84:	85 c0                	test   %eax,%eax
80107e86:	74 0c                	je     80107e94 <loaduvm+0x1e>
    panic("loaduvm: addr must be page aligned");
80107e88:	c7 04 24 dc 8a 10 80 	movl   $0x80108adc,(%esp)
80107e8f:	e8 ce 86 ff ff       	call   80100562 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107e94:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107e9b:	e9 a6 00 00 00       	jmp    80107f46 <loaduvm+0xd0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107ea0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ea3:	8b 55 0c             	mov    0xc(%ebp),%edx
80107ea6:	01 d0                	add    %edx,%eax
80107ea8:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107eaf:	00 
80107eb0:	89 44 24 04          	mov    %eax,0x4(%esp)
80107eb4:	8b 45 08             	mov    0x8(%ebp),%eax
80107eb7:	89 04 24             	mov    %eax,(%esp)
80107eba:	e8 90 fb ff ff       	call   80107a4f <walkpgdir>
80107ebf:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107ec2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107ec6:	75 0c                	jne    80107ed4 <loaduvm+0x5e>
      panic("loaduvm: address should exist");
80107ec8:	c7 04 24 ff 8a 10 80 	movl   $0x80108aff,(%esp)
80107ecf:	e8 8e 86 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
80107ed4:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107ed7:	8b 00                	mov    (%eax),%eax
80107ed9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107ede:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107ee1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ee4:	8b 55 18             	mov    0x18(%ebp),%edx
80107ee7:	29 c2                	sub    %eax,%edx
80107ee9:	89 d0                	mov    %edx,%eax
80107eeb:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107ef0:	77 0f                	ja     80107f01 <loaduvm+0x8b>
      n = sz - i;
80107ef2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ef5:	8b 55 18             	mov    0x18(%ebp),%edx
80107ef8:	29 c2                	sub    %eax,%edx
80107efa:	89 d0                	mov    %edx,%eax
80107efc:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107eff:	eb 07                	jmp    80107f08 <loaduvm+0x92>
    else
      n = PGSIZE;
80107f01:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107f08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f0b:	8b 55 14             	mov    0x14(%ebp),%edx
80107f0e:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80107f11:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107f14:	05 00 00 00 80       	add    $0x80000000,%eax
80107f19:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107f1c:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107f20:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107f24:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f28:	8b 45 10             	mov    0x10(%ebp),%eax
80107f2b:	89 04 24             	mov    %eax,(%esp)
80107f2e:	e8 c7 9e ff ff       	call   80101dfa <readi>
80107f33:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107f36:	74 07                	je     80107f3f <loaduvm+0xc9>
      return -1;
80107f38:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107f3d:	eb 18                	jmp    80107f57 <loaduvm+0xe1>
  for(i = 0; i < sz; i += PGSIZE){
80107f3f:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107f46:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f49:	3b 45 18             	cmp    0x18(%ebp),%eax
80107f4c:	0f 82 4e ff ff ff    	jb     80107ea0 <loaduvm+0x2a>
  }
  return 0;
...
80107f5c:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107f6b:	e9 fd 00 00 00       	jmp    8010806d <allocuvm+0x114>
  if(newsz < oldsz)
...
80107f7b:	e9 ed 00 00 00       	jmp    8010806d <allocuvm+0x114>
...
80107f90:	e9 c9 00 00 00       	jmp    8010805e <allocuvm+0x105>
    mem = kalloc();
80107f95:	e8 0f ac ff ff       	call   80102ba9 <kalloc>
80107f9a:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107f9d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107fa1:	75 2f                	jne    80107fd2 <allocuvm+0x79>
      cprintf("allocuvm out of memory\n");
80107fa3:	c7 04 24 1d 8b 10 80 	movl   $0x80108b1d,(%esp)
80107faa:	e8 19 84 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107faf:	8b 45 0c             	mov    0xc(%ebp),%eax
80107fb2:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107fc3:	e8 a7 00 00 00       	call   8010806f <deallocuvm>
      return 0;
80107fc8:	b8 00 00 00 00       	mov    $0x0,%eax
80107fcd:	e9 9b 00 00 00       	jmp    8010806d <allocuvm+0x114>
    }
    memset(mem, 0, PGSIZE);
...
80107fe8:	e8 3a d2 ff ff       	call   80105227 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107fed:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ff0:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80107ff6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff9:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108000:	00 
80108001:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108005:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010800c:	00 
8010800d:	89 44 24 04          	mov    %eax,0x4(%esp)
80108011:	8b 45 08             	mov    0x8(%ebp),%eax
80108014:	89 04 24             	mov    %eax,(%esp)
80108017:	e8 cf fa ff ff       	call   80107aeb <mappages>
8010801c:	85 c0                	test   %eax,%eax
8010801e:	79 37                	jns    80108057 <allocuvm+0xfe>
      cprintf("allocuvm out of memory (2)\n");
80108020:	c7 04 24 35 8b 10 80 	movl   $0x80108b35,(%esp)
80108027:	e8 9c 83 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010802c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010802f:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108040:	e8 2a 00 00 00       	call   8010806f <deallocuvm>
      kfree(mem);
80108045:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108048:	89 04 24             	mov    %eax,(%esp)
8010804b:	e8 c3 aa ff ff       	call   80102b13 <kfree>
      return 0;
80108050:	b8 00 00 00 00       	mov    $0x0,%eax
80108055:	eb 16                	jmp    8010806d <allocuvm+0x114>
  for(; a < newsz; a += PGSIZE){
80108057:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010805e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108061:	3b 45 10             	cmp    0x10(%ebp),%eax
80108064:	0f 82 2b ff ff ff    	jb     80107f95 <allocuvm+0x3c>
    }
  }
  return newsz;
...
80108072:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
8010807b:	72 08                	jb     80108085 <deallocuvm+0x16>
    return oldsz;
8010807d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108080:	e9 ae 00 00 00       	jmp    80108133 <deallocuvm+0xc4>
...
80108095:	e9 8a 00 00 00       	jmp    80108124 <deallocuvm+0xb5>
...
801080af:	e8 9b f9 ff ff       	call   80107a4f <walkpgdir>
801080b4:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801080b7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801080bb:	75 16                	jne    801080d3 <deallocuvm+0x64>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801080bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080c0:	c1 e8 16             	shr    $0x16,%eax
801080c3:	83 c0 01             	add    $0x1,%eax
801080c6:	c1 e0 16             	shl    $0x16,%eax
801080c9:	2d 00 10 00 00       	sub    $0x1000,%eax
801080ce:	89 45 f4             	mov    %eax,-0xc(%ebp)
801080d1:	eb 4a                	jmp    8010811d <deallocuvm+0xae>
    else if((*pte & PTE_P) != 0){
801080d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080d6:	8b 00                	mov    (%eax),%eax
801080d8:	83 e0 01             	and    $0x1,%eax
801080db:	85 c0                	test   %eax,%eax
801080dd:	74 3e                	je     8010811d <deallocuvm+0xae>
      pa = PTE_ADDR(*pte);
801080df:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080e2:	8b 00                	mov    (%eax),%eax
801080e4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801080e9:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
801080ec:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801080f0:	75 0c                	jne    801080fe <deallocuvm+0x8f>
        panic("kfree");
801080f2:	c7 04 24 51 8b 10 80 	movl   $0x80108b51,(%esp)
801080f9:	e8 64 84 ff ff       	call   80100562 <panic>
      char *v = P2V(pa);
801080fe:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108101:	05 00 00 00 80       	add    $0x80000000,%eax
80108106:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108109:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010810c:	89 04 24             	mov    %eax,(%esp)
8010810f:	e8 ff a9 ff ff       	call   80102b13 <kfree>
      *pte = 0;
80108114:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108117:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
8010811d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108124:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108127:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010812a:	0f 82 6a ff ff ff    	jb     8010809a <deallocuvm+0x2b>
    }
  }
  return newsz;
...
80108138:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
8010813b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010813f:	75 0c                	jne    8010814d <freevm+0x18>
    panic("freevm: no pgdir");
80108141:	c7 04 24 57 8b 10 80 	movl   $0x80108b57,(%esp)
80108148:	e8 15 84 ff ff       	call   80100562 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
8010814d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108154:	00 
80108155:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
8010815c:	80 
8010815d:	8b 45 08             	mov    0x8(%ebp),%eax
80108160:	89 04 24             	mov    %eax,(%esp)
80108163:	e8 07 ff ff ff       	call   8010806f <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108168:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010816f:	eb 45                	jmp    801081b6 <freevm+0x81>
    if(pgdir[i] & PTE_P){
...
80108187:	74 29                	je     801081b2 <freevm+0x7d>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80108189:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010818c:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108193:	8b 45 08             	mov    0x8(%ebp),%eax
80108196:	01 d0                	add    %edx,%eax
80108198:	8b 00                	mov    (%eax),%eax
8010819a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
...
801081ad:	e8 61 a9 ff ff       	call   80102b13 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
801081b2:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801081b6:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801081bd:	76 b2                	jbe    80108171 <freevm+0x3c>
    }
  }
  kfree((char*)pgdir);
801081bf:	8b 45 08             	mov    0x8(%ebp),%eax
801081c2:	89 04 24             	mov    %eax,(%esp)
801081c5:	e8 49 a9 ff ff       	call   80102b13 <kfree>
}
801081ca:	c9                   	leave  
801081cb:	c3                   	ret    
...
80108215:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108218:	e8 66 f9 ff ff       	call   80107b83 <setupkvm>
8010821d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108220:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108224:	75 0a                	jne    80108230 <copyuvm+0x1e>
    return 0;
80108226:	b8 00 00 00 00       	mov    $0x0,%eax
8010822b:	e9 03 01 00 00       	jmp    80108333 <copyuvm+0x121>
  for(i = 0; i < sz; i += PGSIZE){
80108230:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108237:	e9 d6 00 00 00       	jmp    80108312 <copyuvm+0x100>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010823c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010823f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108246:	00 
80108247:	89 44 24 04          	mov    %eax,0x4(%esp)
8010824b:	8b 45 08             	mov    0x8(%ebp),%eax
8010824e:	89 04 24             	mov    %eax,(%esp)
80108251:	e8 f9 f7 ff ff       	call   80107a4f <walkpgdir>
80108256:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108259:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010825d:	75 0c                	jne    8010826b <copyuvm+0x59>
      panic("copyuvm: pte should exist");
8010825f:	c7 04 24 72 8b 10 80 	movl   $0x80108b72,(%esp)
80108266:	e8 f7 82 ff ff       	call   80100562 <panic>
    if(!(*pte & PTE_P))
8010826b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010826e:	8b 00                	mov    (%eax),%eax
80108270:	83 e0 01             	and    $0x1,%eax
80108273:	85 c0                	test   %eax,%eax
80108275:	75 0c                	jne    80108283 <copyuvm+0x71>
      panic("copyuvm: page not present");
80108277:	c7 04 24 8c 8b 10 80 	movl   $0x80108b8c,(%esp)
8010827e:	e8 df 82 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
80108283:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108286:	8b 00                	mov    (%eax),%eax
80108288:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010828d:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
80108290:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108293:	8b 00                	mov    (%eax),%eax
80108295:	25 ff 0f 00 00       	and    $0xfff,%eax
8010829a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
8010829d:	e8 07 a9 ff ff       	call   80102ba9 <kalloc>
801082a2:	89 45 e0             	mov    %eax,-0x20(%ebp)
801082a5:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801082a9:	75 02                	jne    801082ad <copyuvm+0x9b>
      goto bad;
801082ab:	eb 76                	jmp    80108323 <copyuvm+0x111>
    memmove(mem, (char*)P2V(pa), PGSIZE);
801082ad:	8b 45 e8             	mov    -0x18(%ebp),%eax
801082b0:	05 00 00 00 80       	add    $0x80000000,%eax
801082b5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801082bc:	00 
801082bd:	89 44 24 04          	mov    %eax,0x4(%esp)
801082c1:	8b 45 e0             	mov    -0x20(%ebp),%eax
801082c4:	89 04 24             	mov    %eax,(%esp)
801082c7:	e8 2a d0 ff ff       	call   801052f6 <memmove>
...
801082db:	89 54 24 10          	mov    %edx,0x10(%esp)
801082df:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801082e3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801082ea:	00 
801082eb:	89 44 24 04          	mov    %eax,0x4(%esp)
801082ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
801082f2:	89 04 24             	mov    %eax,(%esp)
801082f5:	e8 f1 f7 ff ff       	call   80107aeb <mappages>
801082fa:	85 c0                	test   %eax,%eax
801082fc:	79 0d                	jns    8010830b <copyuvm+0xf9>
      kfree(mem);
801082fe:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108301:	89 04 24             	mov    %eax,(%esp)
80108304:	e8 0a a8 ff ff       	call   80102b13 <kfree>
      goto bad;
80108309:	eb 18                	jmp    80108323 <copyuvm+0x111>
  for(i = 0; i < sz; i += PGSIZE){
8010830b:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108312:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108315:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108318:	0f 82 1e ff ff ff    	jb     8010823c <copyuvm+0x2a>
    }
  }
  return d;
8010831e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108321:	eb 10                	jmp    80108333 <copyuvm+0x121>

bad:
  freevm(d);
80108323:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108326:	89 04 24             	mov    %eax,(%esp)
80108329:	e8 07 fe ff ff       	call   80108135 <freevm>
  return 0;
...
80108350:	e8 fa f6 ff ff       	call   80107a4f <walkpgdir>
...
80108369:	eb 22                	jmp    8010838d <uva2ka+0x58>
  if((*pte & PTE_U) == 0)
...
8010837c:	eb 0f                	jmp    8010838d <uva2ka+0x58>
...
801083b8:	e8 78 ff ff ff       	call   80108335 <uva2ka>
...
8010840b:	e8 e6 ce ff ff       	call   801052f6 <memmove>
    len -= n;
