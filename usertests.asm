...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 04 66 00 00       	mov    0x6604,%eax
       b:	c7 44 24 04 66 46 00 	movl   $0x4666,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 66 42 00 00       	call   4281 <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 71 46 00 00 	movl   $0x4671,(%esp)
      22:	e8 3a 41 00 00       	call   4161 <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 04 66 00 00       	mov    0x6604,%eax
      30:	c7 44 24 04 79 46 00 	movl   $0x4679,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 41 42 00 00       	call   4281 <printf>
    exit();
      40:	e8 b4 40 00 00       	call   40f9 <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 71 46 00 00 	movl   $0x4671,(%esp)
      4c:	e8 18 41 00 00       	call   4169 <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 04 66 00 00       	mov    0x6604,%eax
      5a:	c7 44 24 04 87 46 00 	movl   $0x4687,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 17 42 00 00       	call   4281 <printf>
    exit();
      6a:	e8 8a 40 00 00       	call   40f9 <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 9d 46 00 00 	movl   $0x469d,(%esp)
      76:	e8 ce 40 00 00       	call   4149 <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 04 66 00 00       	mov    0x6604,%eax
      84:	c7 44 24 04 a8 46 00 	movl   $0x46a8,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 ed 41 00 00       	call   4281 <printf>
    exit();
      94:	e8 60 40 00 00       	call   40f9 <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 c2 46 00 00 	movl   $0x46c2,(%esp)
      a0:	e8 c4 40 00 00       	call   4169 <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 04 66 00 00       	mov    0x6604,%eax
      ae:	c7 44 24 04 c4 46 00 	movl   $0x46c4,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 c3 41 00 00       	call   4281 <printf>
    exit();
      be:	e8 36 40 00 00       	call   40f9 <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 04 66 00 00       	mov    0x6604,%eax
      c8:	c7 44 24 04 d4 46 00 	movl   $0x46d4,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 a9 41 00 00       	call   4281 <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 04 66 00 00       	mov    0x6604,%eax
      e5:	c7 44 24 04 e2 46 00 	movl   $0x46e2,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 8c 41 00 00       	call   4281 <printf>

  pid = fork();
      f5:	e8 f7 3f 00 00       	call   40f1 <fork>
      fa:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pid < 0){
      fd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     101:	79 1a                	jns    11d <exitiputtest+0x43>
    printf(stdout, "fork failed\n");
     103:	a1 04 66 00 00       	mov    0x6604,%eax
     108:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 69 41 00 00       	call   4281 <printf>
    exit();
     118:	e8 dc 3f 00 00       	call   40f9 <exit>
  }
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     12e:	e8 2e 40 00 00       	call   4161 <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 04 66 00 00       	mov    0x6604,%eax
     13c:	c7 44 24 04 79 46 00 	movl   $0x4679,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 35 41 00 00       	call   4281 <printf>
      exit();
     14c:	e8 a8 3f 00 00       	call   40f9 <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 71 46 00 00 	movl   $0x4671,(%esp)
     158:	e8 0c 40 00 00       	call   4169 <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 04 66 00 00       	mov    0x6604,%eax
     166:	c7 44 24 04 fe 46 00 	movl   $0x46fe,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 0b 41 00 00       	call   4281 <printf>
      exit();
     176:	e8 7e 3f 00 00       	call   40f9 <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 9d 46 00 00 	movl   $0x469d,(%esp)
     182:	e8 c2 3f 00 00       	call   4149 <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 04 66 00 00       	mov    0x6604,%eax
     190:	c7 44 24 04 a8 46 00 	movl   $0x46a8,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 e1 40 00 00       	call   4281 <printf>
      exit();
     1a0:	e8 54 3f 00 00       	call   40f9 <exit>
    }
    exit();
     1a5:	e8 4f 3f 00 00       	call   40f9 <exit>
  }
  wait();
     1aa:	e8 52 3f 00 00       	call   4101 <wait>
  printf(stdout, "exitiput test ok\n");
     1af:	a1 04 66 00 00       	mov    0x6604,%eax
     1b4:	c7 44 24 04 12 47 00 	movl   $0x4712,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 bd 40 00 00       	call   4281 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
writetest(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 04 66 00 00       	mov    0x6604,%eax
     3d0:	c7 44 24 04 1e 48 00 	movl   $0x481e,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 a1 3e 00 00       	call   4281 <printf>
    exit();
     3e0:	e8 14 3d 00 00       	call   40f9 <exit>
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3fb:	e8 19 3d 00 00       	call   4119 <write>
     400:	83 f8 0a             	cmp    $0xa,%eax
     403:	74 21                	je     426 <writetest+0xb4>
      printf(stdout, "error: write aa %d new file failed\n", i);
     405:	a1 04 66 00 00       	mov    0x6604,%eax
     ...
     41c:	e8 60 3e 00 00       	call   4281 <printf>
      exit();
     421:	e8 d3 3c 00 00       	call   40f9 <exit>
    }
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     43c:	e8 d8 3c 00 00       	call   4119 <write>
     441:	83 f8 0a             	cmp    $0xa,%eax
     444:	74 21                	je     467 <writetest+0xf5>
      printf(stdout, "error: write bb %d new file failed\n", i);
     446:	a1 04 66 00 00       	mov    0x6604,%eax
     ...
     45d:	e8 1f 3e 00 00       	call   4281 <printf>
      exit();
     462:	e8 92 3c 00 00       	call   40f9 <exit>
  for(i = 0; i < 100; i++){
  ...
  i = read(fd, buf, 2000);
     ...
     4ce:	00 
     4cf:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
     4d6:	00 
     4d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
     4da:	89 04 24             	mov    %eax,(%esp)
     4dd:	e8 2f 3c 00 00       	call   4111 <read>
...
writetest1(void)
{
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     68d:	00 
     68e:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
     695:	00 
     696:	8b 45 ec             	mov    -0x14(%ebp),%eax
     699:	89 04 24             	mov    %eax,(%esp)
     69c:	e8 70 3a 00 00       	call   4111 <read>
    ...
    if(i == 0){
     ...
     6b3:	a1 04 66 00 00       	mov    0x6604,%eax
     6b8:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bb:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bf:	c7 44 24 04 89 49 00 	movl   $0x4989,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 b2 3b 00 00       	call   4281 <printf>
        exit();
     6cf:	e8 25 3a 00 00       	call   40f9 <exit>
      }
      break;
     6d4:	90                   	nop
             n, ((int*)buf)[0]);
  ...
  close(fd);
     ...
     6db:	e8 41 3a 00 00       	call   4121 <close>
  if(unlink("big") < 0){
     6e0:	c7 04 24 34 49 00 00 	movl   $0x4934,(%esp)
     6e7:	e8 5d 3a 00 00       	call   4149 <unlink>
     ...
     6ff:	a1 04 66 00 00       	mov    0x6604,%eax
     704:	8b 55 f4             	mov    -0xc(%ebp),%edx
     707:	89 54 24 08          	mov    %edx,0x8(%esp)
     70b:	c7 44 24 04 a6 49 00 	movl   $0x49a6,0x4(%esp)
     712:	00 
     713:	89 04 24             	mov    %eax,(%esp)
     716:	e8 66 3b 00 00       	call   4281 <printf>
      exit();
     71b:	e8 d9 39 00 00       	call   40f9 <exit>
    if(((int*)buf)[0] != n){
     720:	b8 e0 8d 00 00       	mov    $0x8de0,%eax
     725:	8b 00                	mov    (%eax),%eax
     727:	3b 45 f0             	cmp    -0x10(%ebp),%eax
     72a:	74 2c                	je     758 <writetest1+0x1d1>
             n, ((int*)buf)[0]);
     72c:	b8 e0 8d 00 00       	mov    $0x8de0,%eax
      printf(stdout, "read content of block %d is %d\n",
     731:	8b 10                	mov    (%eax),%edx
     733:	a1 04 66 00 00       	mov    0x6604,%eax
     738:	89 54 24 0c          	mov    %edx,0xc(%esp)
     73c:	8b 55 f0             	mov    -0x10(%ebp),%edx
     73f:	89 54 24 08          	mov    %edx,0x8(%esp)
     743:	c7 44 24 04 b8 49 00 	movl   $0x49b8,0x4(%esp)
     74a:	00 
     74b:	89 04 24             	mov    %eax,(%esp)
     74e:	e8 2e 3b 00 00       	call   4281 <printf>
      exit();
     753:	e8 a1 39 00 00       	call   40f9 <exit>
    n++;
     758:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  }
     75c:	e9 25 ff ff ff       	jmp    686 <writetest1+0xff>
    printf(stdout, "unlink big failed\n");
     761:	a1 04 66 00 00       	mov    0x6604,%eax
     766:	c7 44 24 04 d8 49 00 	movl   $0x49d8,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 0b 3b 00 00       	call   4281 <printf>
    exit();
     776:	e8 7e 39 00 00       	call   40f9 <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 04 66 00 00       	mov    0x6604,%eax
     780:	c7 44 24 04 eb 49 00 	movl   $0x49eb,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 f1 3a 00 00       	call   4281 <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     798:	a1 04 66 00 00       	mov    0x6604,%eax
     79d:	c7 44 24 04 fc 49 00 	movl   $0x49fc,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 d4 3a 00 00       	call   4281 <printf>

  name[0] = 'a';
     7ad:	c6 05 e0 ad 00 00 61 	movb   $0x61,0xade0
  name[2] = '\0';
     7b4:	c6 05 e2 ad 00 00 00 	movb   $0x0,0xade2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     7ca:	a2 e1 ad 00 00       	mov    %al,0xade1
    fd = open(name, O_CREATE|O_RDWR);
     7cf:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     7d6:	00 
     7d7:	c7 04 24 e0 ad 00 00 	movl   $0xade0,(%esp)
     7de:	e8 56 39 00 00       	call   4139 <open>
     7e3:	89 45 f0             	mov    %eax,-0x10(%ebp)
    close(fd);
     7e6:	8b 45 f0             	mov    -0x10(%ebp),%eax
     7e9:	89 04 24             	mov    %eax,(%esp)
     7ec:	e8 30 39 00 00       	call   4121 <close>
  for(i = 0; i < 52; i++){
  ...
  name[0] = 'a';
     7fb:	c6 05 e0 ad 00 00 61 	movb   $0x61,0xade0
  name[2] = '\0';
     802:	c6 05 e2 ad 00 00 00 	movb   $0x0,0xade2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     818:	a2 e1 ad 00 00       	mov    %al,0xade1
    unlink(name);
     81d:	c7 04 24 e0 ad 00 00 	movl   $0xade0,(%esp)
     824:	e8 20 39 00 00       	call   4149 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     833:	a1 04 66 00 00       	mov    0x6604,%eax
     838:	c7 44 24 04 24 4a 00 	movl   $0x4a24,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 39 3a 00 00       	call   4281 <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     850:	a1 04 66 00 00       	mov    0x6604,%eax
     855:	c7 44 24 04 4a 4a 00 	movl   $0x4a4a,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 1c 3a 00 00       	call   4281 <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 56 4a 00 00 	movl   $0x4a56,(%esp)
     86c:	e8 f0 38 00 00       	call   4161 <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 04 66 00 00       	mov    0x6604,%eax
     87a:	c7 44 24 04 79 46 00 	movl   $0x4679,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 f7 39 00 00       	call   4281 <printf>
    exit();
     88a:	e8 6a 38 00 00       	call   40f9 <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 56 4a 00 00 	movl   $0x4a56,(%esp)
     896:	e8 ce 38 00 00       	call   4169 <chdir>
     89b:	85 c0                	test   %eax,%eax
     89d:	79 1a                	jns    8b9 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89f:	a1 04 66 00 00       	mov    0x6604,%eax
     8a4:	c7 44 24 04 5b 4a 00 	movl   $0x4a5b,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 cd 39 00 00       	call   4281 <printf>
    exit();
     8b4:	e8 40 38 00 00       	call   40f9 <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 6e 4a 00 00 	movl   $0x4a6e,(%esp)
     8c0:	e8 a4 38 00 00       	call   4169 <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 04 66 00 00       	mov    0x6604,%eax
     8ce:	c7 44 24 04 71 4a 00 	movl   $0x4a71,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 a3 39 00 00       	call   4281 <printf>
    exit();
     8de:	e8 16 38 00 00       	call   40f9 <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 56 4a 00 00 	movl   $0x4a56,(%esp)
     8ea:	e8 5a 38 00 00       	call   4149 <unlink>
     8ef:	85 c0                	test   %eax,%eax
     8f1:	79 1a                	jns    90d <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f3:	a1 04 66 00 00       	mov    0x6604,%eax
     8f8:	c7 44 24 04 82 4a 00 	movl   $0x4a82,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 79 39 00 00       	call   4281 <printf>
    exit();
     908:	e8 ec 37 00 00       	call   40f9 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 04 66 00 00       	mov    0x6604,%eax
     912:	c7 44 24 04 96 4a 00 	movl   $0x4a96,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 5f 39 00 00       	call   4281 <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     92a:	a1 04 66 00 00       	mov    0x6604,%eax
     92f:	c7 44 24 04 a5 4a 00 	movl   $0x4aa5,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 42 39 00 00       	call   4281 <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 f0 65 00 	movl   $0x65f0,0x4(%esp)
     946:	00 
     947:	c7 04 24 50 46 00 00 	movl   $0x4650,(%esp)
     94e:	e8 de 37 00 00       	call   4131 <exec>
     953:	85 c0                	test   %eax,%eax
     955:	79 1a                	jns    971 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     957:	a1 04 66 00 00       	mov    0x6604,%eax
     95c:	c7 44 24 04 b0 4a 00 	movl   $0x4ab0,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 15 39 00 00       	call   4281 <printf>
    exit();
     96c:	e8 88 37 00 00       	call   40f9 <exit>
  }
}
     971:	c9                   	leave  
     972:	c3                   	ret    
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
     ...
     97f:	e8 85 37 00 00       	call   4109 <pipe>
     984:	85 c0                	test   %eax,%eax
     986:	74 19                	je     9a1 <pipe1+0x2e>
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 c2 4a 00 	movl   $0x4ac2,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 e5 38 00 00       	call   4281 <printf>
    exit();
     99c:	e8 58 37 00 00       	call   40f9 <exit>
  }
  pid = fork();
     9a1:	e8 4b 37 00 00       	call   40f1 <fork>
  ...
  if(pid == 0){
    ...
    close(fds[0]);
     ...
     9c0:	e8 5c 37 00 00       	call   4121 <close>
    for(n = 0; n < 5; n++){
     ...
     9e3:	81 c2 e0 8d 00 00    	add    $0x8de0,%edx
     ...
     a02:	00 
     a03:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
     a0a:	00 
     a0b:	89 04 24             	mov    %eax,(%esp)
     a0e:	e8 06 37 00 00       	call   4119 <write>
     a13:	3d 09 04 00 00       	cmp    $0x409,%eax
     a18:	74 19                	je     a33 <pipe1+0xc0>
        printf(1, "pipe1 oops 1\n");
     a1a:	c7 44 24 04 d1 4a 00 	movl   $0x4ad1,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 53 38 00 00       	call   4281 <printf>
        exit();
     a2e:	e8 c6 36 00 00       	call   40f9 <exit>
    for(n = 0; n < 5; n++){
    ...
    exit();
     a3d:	e8 b7 36 00 00       	call   40f9 <exit>
  } else if(pid > 0){
    ...
    close(fds[1]);
     ...
     a52:	e8 ca 36 00 00       	call   4121 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a73:	05 e0 8d 00 00       	add    $0x8de0,%eax
     ...
     a90:	c7 44 24 04 df 4a 00 	movl   $0x4adf,0x4(%esp)
     a97:	00 
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ad9:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
     ae0:	00 
     ae1:	89 04 24             	mov    %eax,(%esp)
     ae4:	e8 28 36 00 00       	call   4111 <read>
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 ed 4a 00 	movl   $0x4aed,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 67 37 00 00       	call   4281 <printf>
      exit();
     b1a:	e8 da 35 00 00       	call   40f9 <exit>
    }
    close(fds[0]);
     b1f:	8b 45 d8             	mov    -0x28(%ebp),%eax
     b22:	89 04 24             	mov    %eax,(%esp)
     b25:	e8 f7 35 00 00       	call   4121 <close>
    wait();
     b2a:	e8 d2 35 00 00       	call   4101 <wait>
  } else {
    printf(1, "fork() failed\n");
    exit();
  }
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 13 4b 00 	movl   $0x4b13,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 3e 37 00 00       	call   4281 <printf>
     b43:	eb 19                	jmp    b5e <pipe1+0x1eb>
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 04 4b 00 	movl   $0x4b04,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 28 37 00 00       	call   4281 <printf>
    exit();
     b59:	e8 9b 35 00 00       	call   40f9 <exit>
}
     b5e:	c9                   	leave  
     b5f:	c3                   	ret    
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 1d 4b 00 	movl   $0x4b1d,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 07 37 00 00       	call   4281 <printf>
  pid1 = fork();
     b7a:	e8 72 35 00 00       	call   40f1 <fork>
  ...
  pid2 = fork();
     b8a:	e8 62 35 00 00       	call   40f1 <fork>
  ...
  pipe(pfds);
     ...
     ba0:	e8 64 35 00 00       	call   4109 <pipe>
  pid3 = fork();
     ba5:	e8 47 35 00 00       	call   40f1 <fork>
  ...
  close(pfds[0]);
     ...
     c46:	e8 d6 34 00 00       	call   4121 <close>
  printf(1, "kill... ");
     c4b:	c7 44 24 04 50 4b 00 	movl   $0x4b50,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 22 36 00 00       	call   4281 <printf>
  kill(pid1);
     c5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
     c62:	89 04 24             	mov    %eax,(%esp)
     c65:	e8 bf 34 00 00       	call   4129 <kill>
  kill(pid2);
     c6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
     c6d:	89 04 24             	mov    %eax,(%esp)
     c70:	e8 b4 34 00 00       	call   4129 <kill>
  kill(pid3);
     c75:	8b 45 ec             	mov    -0x14(%ebp),%eax
     c78:	89 04 24             	mov    %eax,(%esp)
     c7b:	e8 a9 34 00 00       	call   4129 <kill>
  printf(1, "wait... ");
     c80:	c7 44 24 04 59 4b 00 	movl   $0x4b59,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 ed 35 00 00       	call   4281 <printf>
  wait();
     c94:	e8 68 34 00 00       	call   4101 <wait>
  wait();
     c99:	e8 63 34 00 00       	call   4101 <wait>
  wait();
     c9e:	e8 5e 34 00 00       	call   4101 <wait>
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 62 4b 00 	movl   $0x4b62,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 ca 35 00 00       	call   4281 <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid){
     ...
     cf0:	74 20                	je     d12 <exitwait+0x59>
      if(wait() != pid){
     cf2:	e8 0a 34 00 00       	call   4101 <wait>
     cf7:	3b 45 f0             	cmp    -0x10(%ebp),%eax
     cfa:	74 1b                	je     d17 <exitwait+0x5e>
        printf(1, "wait wrong pid\n");
     cfc:	c7 44 24 04 6e 4b 00 	movl   $0x4b6e,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 71 35 00 00       	call   4281 <printf>
        return;
     d10:	eb 23                	jmp    d35 <exitwait+0x7c>
      }
    } else {
      exit();
     d12:	e8 e2 33 00 00       	call   40f9 <exit>
  for(i = 0; i < 100; i++){
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 7e 4b 00 	movl   $0x4b7e,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 4c 35 00 00       	call   4281 <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 8b 4b 00 	movl   $0x4b8b,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 30 35 00 00       	call   4281 <printf>
  ppid = getpid();
     d51:	e8 23 34 00 00       	call   4179 <getpid>
     d56:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if((pid = fork()) == 0){
     d59:	e8 93 33 00 00       	call   40f1 <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 df 37 00 00       	call   456d <malloc>
    ...
    while(m1){
     ...
     da7:	e8 88 36 00 00       	call   4434 <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     dbf:	e8 a9 37 00 00       	call   456d <malloc>
     dc4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(m1 == 0){
     dc7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     dcb:	75 24                	jne    df1 <mem+0xba>
      printf(1, "couldn't allocate mem?!!\n");
     dcd:	c7 44 24 04 95 4b 00 	movl   $0x4b95,0x4(%esp)
     dd4:	00 
     dd5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ddc:	e8 a0 34 00 00       	call   4281 <printf>
      kill(ppid);
     de1:	8b 45 f0             	mov    -0x10(%ebp),%eax
     de4:	89 04 24             	mov    %eax,(%esp)
     de7:	e8 3d 33 00 00       	call   4129 <kill>
      exit();
     dec:	e8 08 33 00 00       	call   40f9 <exit>
    }
    free(m1);
     df1:	8b 45 f4             	mov    -0xc(%ebp),%eax
     df4:	89 04 24             	mov    %eax,(%esp)
     df7:	e8 38 36 00 00       	call   4434 <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 af 4b 00 	movl   $0x4baf,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 71 34 00 00       	call   4281 <printf>
    exit();
     e10:	e8 e4 32 00 00       	call   40f9 <exit>
  } else {
    wait();
     e15:	e8 e7 32 00 00       	call   4101 <wait>
  }
}
     e1a:	c9                   	leave  
     e1b:	c3                   	ret    
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 b7 4b 00 	movl   $0x4bb7,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 4b 34 00 00       	call   4281 <printf>

  unlink("sharedfd");
     e36:	c7 04 24 c6 4b 00 00 	movl   $0x4bc6,(%esp)
     e3d:	e8 07 33 00 00       	call   4149 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 c6 4b 00 00 	movl   $0x4bc6,(%esp)
     e51:	e8 e3 32 00 00       	call   4139 <open>
     e56:	89 45 e8             	mov    %eax,-0x18(%ebp)
  if(fd < 0){
     e59:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
     e5d:	79 19                	jns    e78 <sharedfd+0x5c>
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 d0 4b 00 	movl   $0x4bd0,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 0e 34 00 00       	call   4281 <printf>
    return;
     e73:	e9 a0 01 00 00       	jmp    1018 <sharedfd+0x1fc>
  }
  pid = fork();
     e78:	e8 74 32 00 00       	call   40f1 <fork>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ec7:	e8 4d 32 00 00       	call   4119 <write>
     ecc:	83 f8 0a             	cmp    $0xa,%eax
     ecf:	74 16                	je     ee7 <sharedfd+0xcb>
      printf(1, "fstests: write sharedfd failed\n");
     ed1:	c7 44 24 04 fc 4b 00 	movl   $0x4bfc,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 9c 33 00 00       	call   4281 <printf>
      break;
  ...
  if(pid == 0)
    ...
    exit();
     efa:	e8 fa 31 00 00       	call   40f9 <exit>
  else
    wait();
     eff:	e8 fd 31 00 00       	call   4101 <wait>
  close(fd);
     f04:	8b 45 e8             	mov    -0x18(%ebp),%eax
     f07:	89 04 24             	mov    %eax,(%esp)
     f0a:	e8 12 32 00 00       	call   4121 <close>
  fd = open("sharedfd", 0);
     f0f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     f16:	00 
     f17:	c7 04 24 c6 4b 00 00 	movl   $0x4bc6,(%esp)
     f1e:	e8 16 32 00 00       	call   4139 <open>
     f23:	89 45 e8             	mov    %eax,-0x18(%ebp)
  if(fd < 0){
     f26:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
     f2a:	79 19                	jns    f45 <sharedfd+0x129>
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 1c 4c 00 	movl   $0x4c1c,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 41 33 00 00       	call   4281 <printf>
    return;
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fa4:	e8 68 31 00 00       	call   4111 <read>
  ...
  close(fd);
     ...
     fb8:	e8 64 31 00 00       	call   4121 <close>
  unlink("sharedfd");
     fbd:	c7 04 24 c6 4b 00 00 	movl   $0x4bc6,(%esp)
     fc4:	e8 80 31 00 00       	call   4149 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 47 4c 00 	movl   $0x4c47,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 92 32 00 00       	call   4281 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 54 4c 00 	movl   $0x4c54,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 6e 32 00 00       	call   4281 <printf>
    exit();
    1013:	e8 e1 30 00 00       	call   40f9 <exit>
  }
}
    1018:	c9                   	leave  
    1019:	c3                   	ret    
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 69 4c 00 00 	movl   $0x4c69,-0x38(%ebp)
    1027:	c7 45 cc 6c 4c 00 00 	movl   $0x4c6c,-0x34(%ebp)
    102e:	c7 45 d0 6f 4c 00 00 	movl   $0x4c6f,-0x30(%ebp)
    1035:	c7 45 d4 72 4c 00 00 	movl   $0x4c72,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 75 4c 00 	movl   $0x4c75,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 31 32 00 00       	call   4281 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    106c:	e8 d8 30 00 00       	call   4149 <unlink>

    pid = fork();
    1071:	e8 7b 30 00 00       	call   40f1 <fork>
    1076:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if(pid < 0){
    1079:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 ee 31 00 00       	call   4281 <printf>
      exit();
    1093:	e8 61 30 00 00       	call   40f9 <exit>
    }
    ...
    10b0:	e8 84 30 00 00       	call   4139 <open>
    10b5:	89 45 dc             	mov    %eax,-0x24(%ebp)
      if(fd < 0){
    10b8:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
    10bc:	79 19                	jns    10d7 <fourfiles+0xbd>
        printf(1, "create failed\n");
    10be:	c7 44 24 04 85 4c 00 	movl   $0x4c85,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 af 31 00 00       	call   4281 <printf>
        exit();
    10d2:	e8 22 30 00 00       	call   40f9 <exit>
      }
    ...
    10e9:	c7 04 24 e0 8d 00 00 	movl   $0x8de0,(%esp)
    ...
    1105:	00 
    1106:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
    110d:	00 
    110e:	8b 45 dc             	mov    -0x24(%ebp),%eax
    1111:	89 04 24             	mov    %eax,(%esp)
    1114:	e8 00 30 00 00       	call   4119 <write>
    ...
    112c:	c7 44 24 04 94 4c 00 	movl   $0x4c94,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 41 31 00 00       	call   4281 <printf>
          exit();
    1140:	e8 b4 2f 00 00       	call   40f9 <exit>
      for(i = 0; i < 12; i++){
    ...
    114d:	7e af                	jle    10fe <fourfiles+0xe4>
      ...
      exit();
    114f:	e8 a5 2f 00 00       	call   40f9 <exit>
  for(pi = 0; pi < 4; pi++){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    116b:	e8 91 2f 00 00       	call   4101 <wait>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < 2; i++){
    ...
    119e:	e8 96 2f 00 00       	call   4139 <open>
    ...
    11bb:	05 e0 8d 00 00       	add    $0x8de0,%eax
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 a5 4c 00 	movl   $0x4ca5,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 9d 30 00 00       	call   4281 <printf>
          exit();
    11e4:	e8 10 2f 00 00       	call   40f9 <exit>
      for(j = 0; j < n; j++){
    ...
    1202:	00 
    1203:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
    120a:	00 
    120b:	8b 45 dc             	mov    -0x24(%ebp),%eax
    120e:	89 04 24             	mov    %eax,(%esp)
    1211:	e8 fb 2e 00 00       	call   4111 <read>
    ...
    1225:	e8 f7 2e 00 00       	call   4121 <close>
    if(total != 12*500){
    ...
    123a:	c7 44 24 04 b1 4c 00 	movl   $0x4cb1,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 33 30 00 00       	call   4281 <printf>
      exit();
    124e:	e8 a6 2e 00 00       	call   40f9 <exit>
    }
    unlink(fname);
    1253:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1256:	89 04 24             	mov    %eax,(%esp)
    1259:	e8 eb 2e 00 00       	call   4149 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 c2 4c 00 	movl   $0x4cc2,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 01 30 00 00       	call   4281 <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1363:	e8 e1 2d 00 00       	call   4149 <unlink>
    1368:	85 c0                	test   %eax,%eax
    136a:	79 19                	jns    1385 <createdelete+0x103>
            printf(1, "unlink failed\n");
    136c:	c7 44 24 04 74 47 00 	movl   $0x4774,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 01 2f 00 00       	call   4281 <printf>
            exit();
    1380:	e8 74 2d 00 00       	call   40f9 <exit>
      for(i = 0; i < N; i++){
    ...
    138d:	0f 8e 5f ff ff ff    	jle    12f2 <createdelete+0x70>
      ...
      exit();
    1393:	e8 61 2d 00 00       	call   40f9 <exit>
  for(pi = 0; pi < 4; pi++){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    13af:	e8 4d 2d 00 00       	call   4101 <wait>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    1408:	e8 2c 2d 00 00       	call   4139 <open>
    ...
    1429:	c7 44 24 04 e4 4c 00 	movl   $0x4ce4,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 44 2e 00 00       	call   4281 <printf>
        exit();
    143d:	e8 b7 2c 00 00       	call   40f9 <exit>
    ...
    145b:	c7 44 24 04 08 4d 00 	movl   $0x4d08,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 12 2e 00 00       	call   4281 <printf>
        exit();
    146f:	e8 85 2c 00 00       	call   40f9 <exit>
      }
      if(fd >= 0)
    ...
    1480:	e8 9c 2c 00 00       	call   4121 <close>
    for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    14cb:	e8 79 2c 00 00       	call   4149 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 28 4d 00 	movl   $0x4d28,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 89 2d 00 00       	call   4281 <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 39 4d 00 	movl   $0x4d39,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 6d 2d 00 00       	call   4281 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 4a 4d 00 00 	movl   $0x4d4a,(%esp)
    1523:	e8 11 2c 00 00       	call   4139 <open>
    1528:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    152b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    152f:	79 19                	jns    154a <unlinkread+0x50>
    printf(1, "create unlinkread failed\n");
    1531:	c7 44 24 04 55 4d 00 	movl   $0x4d55,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 3c 2d 00 00       	call   4281 <printf>
    exit();
    1545:	e8 af 2b 00 00       	call   40f9 <exit>
  }
  write(fd, "hello", 5);
    154a:	c7 44 24 08 05 00 00 	movl   $0x5,0x8(%esp)
    1551:	00 
    1552:	c7 44 24 04 6f 4d 00 	movl   $0x4d6f,0x4(%esp)
    1559:	00 
    155a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    155d:	89 04 24             	mov    %eax,(%esp)
    1560:	e8 b4 2b 00 00       	call   4119 <write>
  close(fd);
    1565:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1568:	89 04 24             	mov    %eax,(%esp)
    156b:	e8 b1 2b 00 00       	call   4121 <close>

  fd = open("unlinkread", O_RDWR);
    1570:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
    1577:	00 
    1578:	c7 04 24 4a 4d 00 00 	movl   $0x4d4a,(%esp)
    157f:	e8 b5 2b 00 00       	call   4139 <open>
    1584:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1587:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    158b:	79 19                	jns    15a6 <unlinkread+0xac>
    printf(1, "open unlinkread failed\n");
    158d:	c7 44 24 04 75 4d 00 	movl   $0x4d75,0x4(%esp)
    1594:	00 
    1595:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    159c:	e8 e0 2c 00 00       	call   4281 <printf>
    exit();
    15a1:	e8 53 2b 00 00       	call   40f9 <exit>
  }
  if(unlink("unlinkread") != 0){
    15a6:	c7 04 24 4a 4d 00 00 	movl   $0x4d4a,(%esp)
    15ad:	e8 97 2b 00 00       	call   4149 <unlink>
    15b2:	85 c0                	test   %eax,%eax
    15b4:	74 19                	je     15cf <unlinkread+0xd5>
    printf(1, "unlink unlinkread failed\n");
    15b6:	c7 44 24 04 8d 4d 00 	movl   $0x4d8d,0x4(%esp)
    15bd:	00 
    15be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15c5:	e8 b7 2c 00 00       	call   4281 <printf>
    exit();
    15ca:	e8 2a 2b 00 00       	call   40f9 <exit>
  }

  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    15cf:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    15d6:	00 
    15d7:	c7 04 24 4a 4d 00 00 	movl   $0x4d4a,(%esp)
    15de:	e8 56 2b 00 00       	call   4139 <open>
    15e3:	89 45 f0             	mov    %eax,-0x10(%ebp)
  write(fd1, "yyy", 3);
    15e6:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    15ed:	00 
    15ee:	c7 44 24 04 a7 4d 00 	movl   $0x4da7,0x4(%esp)
    15f5:	00 
    15f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    15f9:	89 04 24             	mov    %eax,(%esp)
    15fc:	e8 18 2b 00 00       	call   4119 <write>
  close(fd1);
    1601:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1604:	89 04 24             	mov    %eax,(%esp)
    1607:	e8 15 2b 00 00       	call   4121 <close>

  if(read(fd, buf, sizeof(buf)) != 5){
    160c:	c7 44 24 08 00 20 00 	movl   $0x2000,0x8(%esp)
    1613:	00 
    1614:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
    161b:	00 
    161c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    161f:	89 04 24             	mov    %eax,(%esp)
    1622:	e8 ea 2a 00 00       	call   4111 <read>
    1627:	83 f8 05             	cmp    $0x5,%eax
    162a:	74 19                	je     1645 <unlinkread+0x14b>
    printf(1, "unlinkread read failed");
    162c:	c7 44 24 04 ab 4d 00 	movl   $0x4dab,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 41 2c 00 00       	call   4281 <printf>
    exit();
    1640:	e8 b4 2a 00 00       	call   40f9 <exit>
  }
  if(buf[0] != 'h'){
    1645:	0f b6 05 e0 8d 00 00 	movzbl 0x8de0,%eax
    164c:	3c 68                	cmp    $0x68,%al
    164e:	74 19                	je     1669 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    1650:	c7 44 24 04 c2 4d 00 	movl   $0x4dc2,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 1d 2c 00 00       	call   4281 <printf>
    exit();
    1664:	e8 90 2a 00 00       	call   40f9 <exit>
  }
  if(write(fd, buf, 10) != 10){
    1669:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    1670:	00 
    1671:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
    1678:	00 
    1679:	8b 45 f4             	mov    -0xc(%ebp),%eax
    167c:	89 04 24             	mov    %eax,(%esp)
    167f:	e8 95 2a 00 00       	call   4119 <write>
    1684:	83 f8 0a             	cmp    $0xa,%eax
    1687:	74 19                	je     16a2 <unlinkread+0x1a8>
    printf(1, "unlinkread write failed\n");
    1689:	c7 44 24 04 d9 4d 00 	movl   $0x4dd9,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 e4 2b 00 00       	call   4281 <printf>
    exit();
    169d:	e8 57 2a 00 00       	call   40f9 <exit>
  }
  close(fd);
    16a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    16a5:	89 04 24             	mov    %eax,(%esp)
    16a8:	e8 74 2a 00 00       	call   4121 <close>
  unlink("unlinkread");
    16ad:	c7 04 24 4a 4d 00 00 	movl   $0x4d4a,(%esp)
    16b4:	e8 90 2a 00 00       	call   4149 <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 f2 4d 00 	movl   $0x4df2,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 b4 2b 00 00       	call   4281 <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 01 4e 00 	movl   $0x4e01,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 98 2b 00 00       	call   4281 <printf>

  unlink("lf1");
    16e9:	c7 04 24 0b 4e 00 00 	movl   $0x4e0b,(%esp)
    16f0:	e8 54 2a 00 00       	call   4149 <unlink>
  unlink("lf2");
    16f5:	c7 04 24 0f 4e 00 00 	movl   $0x4e0f,(%esp)
    16fc:	e8 48 2a 00 00       	call   4149 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 0b 4e 00 00 	movl   $0x4e0b,(%esp)
    1710:	e8 24 2a 00 00       	call   4139 <open>
    1715:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1718:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    171c:	79 19                	jns    1737 <linktest+0x68>
    printf(1, "create lf1 failed\n");
    171e:	c7 44 24 04 13 4e 00 	movl   $0x4e13,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 4f 2b 00 00       	call   4281 <printf>
    exit();
    1732:	e8 c2 29 00 00       	call   40f9 <exit>
  }
  if(write(fd, "hello", 5) != 5){
    1737:	c7 44 24 08 05 00 00 	movl   $0x5,0x8(%esp)
    173e:	00 
    173f:	c7 44 24 04 6f 4d 00 	movl   $0x4d6f,0x4(%esp)
    1746:	00 
    1747:	8b 45 f4             	mov    -0xc(%ebp),%eax
    174a:	89 04 24             	mov    %eax,(%esp)
    174d:	e8 c7 29 00 00       	call   4119 <write>
    1752:	83 f8 05             	cmp    $0x5,%eax
    1755:	74 19                	je     1770 <linktest+0xa1>
    printf(1, "write lf1 failed\n");
    1757:	c7 44 24 04 26 4e 00 	movl   $0x4e26,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 16 2b 00 00       	call   4281 <printf>
    exit();
    176b:	e8 89 29 00 00       	call   40f9 <exit>
  }
  close(fd);
    1770:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1773:	89 04 24             	mov    %eax,(%esp)
    1776:	e8 a6 29 00 00       	call   4121 <close>

  if(link("lf1", "lf2") < 0){
    177b:	c7 44 24 04 0f 4e 00 	movl   $0x4e0f,0x4(%esp)
    1782:	00 
    1783:	c7 04 24 0b 4e 00 00 	movl   $0x4e0b,(%esp)
    178a:	e8 ca 29 00 00       	call   4159 <link>
    178f:	85 c0                	test   %eax,%eax
    1791:	79 19                	jns    17ac <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    1793:	c7 44 24 04 38 4e 00 	movl   $0x4e38,0x4(%esp)
    179a:	00 
    179b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17a2:	e8 da 2a 00 00       	call   4281 <printf>
    exit();
    17a7:	e8 4d 29 00 00       	call   40f9 <exit>
  }
  unlink("lf1");
    17ac:	c7 04 24 0b 4e 00 00 	movl   $0x4e0b,(%esp)
    17b3:	e8 91 29 00 00       	call   4149 <unlink>

  if(open("lf1", 0) >= 0){
    17b8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    17bf:	00 
    17c0:	c7 04 24 0b 4e 00 00 	movl   $0x4e0b,(%esp)
    17c7:	e8 6d 29 00 00       	call   4139 <open>
    17cc:	85 c0                	test   %eax,%eax
    17ce:	78 19                	js     17e9 <linktest+0x11a>
    printf(1, "unlinked lf1 but it is still there!\n");
    17d0:	c7 44 24 04 50 4e 00 	movl   $0x4e50,0x4(%esp)
    17d7:	00 
    17d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17df:	e8 9d 2a 00 00       	call   4281 <printf>
    exit();
    17e4:	e8 10 29 00 00       	call   40f9 <exit>
  }

  fd = open("lf2", 0);
    17e9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    17f0:	00 
    17f1:	c7 04 24 0f 4e 00 00 	movl   $0x4e0f,(%esp)
    17f8:	e8 3c 29 00 00       	call   4139 <open>
    17fd:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1800:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1804:	79 19                	jns    181f <linktest+0x150>
    printf(1, "open lf2 failed\n");
    1806:	c7 44 24 04 75 4e 00 	movl   $0x4e75,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 67 2a 00 00       	call   4281 <printf>
    exit();
    181a:	e8 da 28 00 00       	call   40f9 <exit>
  }
  if(read(fd, buf, sizeof(buf)) != 5){
    181f:	c7 44 24 08 00 20 00 	movl   $0x2000,0x8(%esp)
    1826:	00 
    1827:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
    182e:	00 
    182f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1832:	89 04 24             	mov    %eax,(%esp)
    1835:	e8 d7 28 00 00       	call   4111 <read>
    183a:	83 f8 05             	cmp    $0x5,%eax
    183d:	74 19                	je     1858 <linktest+0x189>
    printf(1, "read lf2 failed\n");
    183f:	c7 44 24 04 86 4e 00 	movl   $0x4e86,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 2e 2a 00 00       	call   4281 <printf>
    exit();
    1853:	e8 a1 28 00 00       	call   40f9 <exit>
  }
  close(fd);
    1858:	8b 45 f4             	mov    -0xc(%ebp),%eax
    185b:	89 04 24             	mov    %eax,(%esp)
    185e:	e8 be 28 00 00       	call   4121 <close>

  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 0f 4e 00 	movl   $0x4e0f,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 0f 4e 00 00 	movl   $0x4e0f,(%esp)
    1872:	e8 e2 28 00 00       	call   4159 <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 97 4e 00 	movl   $0x4e97,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 f2 29 00 00       	call   4281 <printf>
    exit();
    188f:	e8 65 28 00 00       	call   40f9 <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 0f 4e 00 00 	movl   $0x4e0f,(%esp)
    189b:	e8 a9 28 00 00       	call   4149 <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 0b 4e 00 	movl   $0x4e0b,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 0f 4e 00 00 	movl   $0x4e0f,(%esp)
    18af:	e8 a5 28 00 00       	call   4159 <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 b8 4e 00 	movl   $0x4eb8,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 b5 29 00 00       	call   4281 <printf>
    exit();
    18cc:	e8 28 28 00 00       	call   40f9 <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 0b 4e 00 	movl   $0x4e0b,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 db 4e 00 00 	movl   $0x4edb,(%esp)
    18e0:	e8 74 28 00 00       	call   4159 <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 dd 4e 00 	movl   $0x4edd,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 84 29 00 00       	call   4281 <printf>
    exit();
    18fd:	e8 f7 27 00 00       	call   40f9 <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 f9 4e 00 	movl   $0x4ef9,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 6b 29 00 00       	call   4281 <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 06 4f 00 	movl   $0x4f06,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 4f 29 00 00       	call   4281 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1955:	e8 ef 27 00 00       	call   4149 <unlink>
    pid = fork();
    195a:	e8 92 27 00 00       	call   40f1 <fork>
    ...
    1991:	c7 04 24 16 4f 00 00 	movl   $0x4f16,(%esp)
    1998:	e8 bc 27 00 00       	call   4159 <link>
    ...
    19d4:	c7 04 24 16 4f 00 00 	movl   $0x4f16,(%esp)
    19db:	e8 79 27 00 00       	call   4159 <link>
    ...
    19f0:	e8 44 27 00 00       	call   4139 <open>
    ...
    1a05:	c7 44 24 04 19 4f 00 	movl   $0x4f19,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 68 28 00 00       	call   4281 <printf>
        exit();
    1a19:	e8 db 26 00 00       	call   40f9 <exit>
      }
      close(fd);
    1a1e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1a21:	89 04 24             	mov    %eax,(%esp)
    1a24:	e8 f8 26 00 00       	call   4121 <close>
    }
    if(pid == 0)
    1a29:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1a2d:	75 05                	jne    1a34 <concreate+0x11c>
      exit();
    1a2f:	e8 c5 26 00 00       	call   40f9 <exit>
    else
      wait();
    1a34:	e8 c8 26 00 00       	call   4101 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    1a69:	00 
    1a6a:	c7 04 24 db 4e 00 00 	movl   $0x4edb,(%esp)
    1a71:	e8 c3 26 00 00       	call   4139 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 35 4f 00 	movl   $0x4f35,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 a1 27 00 00       	call   4281 <printf>
        exit();
    1ae0:	e8 14 26 00 00       	call   40f9 <exit>
      }
      if(fa[i]){
    ...
    1afe:	c7 44 24 04 4e 4f 00 	movl   $0x4f4e,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 6f 27 00 00       	call   4281 <printf>
        exit();
    1b12:	e8 e2 25 00 00       	call   40f9 <exit>
      }
      fa[i] = 1;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1b3b:	e8 d1 25 00 00       	call   4111 <read>
  ...
  close(fd);
    ...
    1b4e:	e8 ce 25 00 00       	call   4121 <close>

  if(n != 40){
    1b53:	83 7d f0 28          	cmpl   $0x28,-0x10(%ebp)
    1b57:	74 19                	je     1b72 <concreate+0x25a>
    printf(1, "concreate not enough files in directory listing\n");
    1b59:	c7 44 24 04 6c 4f 00 	movl   $0x4f6c,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 14 27 00 00       	call   4281 <printf>
    exit();
    1b6d:	e8 87 25 00 00       	call   40f9 <exit>
  }
  ...
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    1b87:	e8 65 25 00 00       	call   40f1 <fork>
    1b8c:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(pid < 0){
    1b8f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 d8 26 00 00       	call   4281 <printf>
      exit();
    1ba9:	e8 4b 25 00 00       	call   40f9 <exit>
    }
    if(((i % 3) == 0 && pid == 0) ||
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 9d 4f 00 	movl   $0x4f9d,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 b8 25 00 00       	call   4281 <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 ab 4f 00 	movl   $0x4fab,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 9c 25 00 00       	call   4281 <printf>

  unlink("x");
    1ce5:	c7 04 24 27 4b 00 00 	movl   $0x4b27,(%esp)
    1cec:	e8 58 24 00 00       	call   4149 <unlink>
  pid = fork();
    1cf1:	e8 fb 23 00 00       	call   40f1 <fork>
    1cf6:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(pid < 0){
    1cf9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1cfd:	79 19                	jns    1d18 <linkunlink+0x4d>
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 6e 25 00 00       	call   4281 <printf>
    exit();
    1d13:	e8 e1 23 00 00       	call   40f9 <exit>
  }
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 27 4b 00 00 	movl   $0x4b27,(%esp)
    1d75:	e8 bf 23 00 00       	call   4139 <open>
    1d7a:	89 04 24             	mov    %eax,(%esp)
    1d7d:	e8 9f 23 00 00       	call   4121 <close>
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 27 4b 00 	movl   $0x4b27,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 bc 4f 00 00 	movl   $0x4fbc,(%esp)
    1db0:	e8 a4 23 00 00       	call   4159 <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 27 4b 00 00 	movl   $0x4b27,(%esp)
    1dbe:	e8 86 23 00 00       	call   4149 <unlink>
  for(i = 0; i < 100; i++){
  ...
  if(pid)
    ...
    wait();
    1dd7:	e8 25 23 00 00       	call   4101 <wait>
    1ddc:	eb 05                	jmp    1de3 <linkunlink+0x118>
  else
    exit();
    1dde:	e8 16 23 00 00       	call   40f9 <exit>

  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 c0 4f 00 	movl   $0x4fc0,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 8a 24 00 00       	call   4281 <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 cf 4f 00 	movl   $0x4fcf,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 6e 24 00 00       	call   4281 <printf>
  unlink("bd");
    1e13:	c7 04 24 dc 4f 00 00 	movl   $0x4fdc,(%esp)
    1e1a:	e8 2a 23 00 00       	call   4149 <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 dc 4f 00 00 	movl   $0x4fdc,(%esp)
    1e2e:	e8 06 23 00 00       	call   4139 <open>
    1e33:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(fd < 0){
    1e36:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1e3a:	79 19                	jns    1e55 <bigdir+0x5c>
    printf(1, "bigdir create failed\n");
    1e3c:	c7 44 24 04 df 4f 00 	movl   $0x4fdf,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 31 24 00 00       	call   4281 <printf>
    exit();
    1e50:	e8 a4 22 00 00       	call   40f9 <exit>
  }
  close(fd);
    1e55:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1e58:	89 04 24             	mov    %eax,(%esp)
    1e5b:	e8 c1 22 00 00       	call   4121 <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    1ea0:	c7 04 24 dc 4f 00 00 	movl   $0x4fdc,(%esp)
    1ea7:	e8 ad 22 00 00       	call   4159 <link>
    1eac:	85 c0                	test   %eax,%eax
    1eae:	74 19                	je     1ec9 <bigdir+0xd0>
      printf(1, "bigdir link failed\n");
    1eb0:	c7 44 24 04 f5 4f 00 	movl   $0x4ff5,0x4(%esp)
    1eb7:	00 
    1eb8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ebf:	e8 bd 23 00 00       	call   4281 <printf>
      exit();
    1ec4:	e8 30 22 00 00       	call   40f9 <exit>
  for(i = 0; i < 500; i++){
  ...
  unlink("bd");
    1ed6:	c7 04 24 dc 4f 00 00 	movl   $0x4fdc,(%esp)
    1edd:	e8 67 22 00 00       	call   4149 <unlink>
  for(i = 0; i < 500; i++){
    ...
    1f21:	e8 23 22 00 00       	call   4149 <unlink>
    1f26:	85 c0                	test   %eax,%eax
    1f28:	74 19                	je     1f43 <bigdir+0x14a>
      printf(1, "bigdir unlink failed");
    1f2a:	c7 44 24 04 09 50 00 	movl   $0x5009,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 43 23 00 00       	call   4281 <printf>
      exit();
    1f3e:	e8 b6 21 00 00       	call   40f9 <exit>
  for(i = 0; i < 500; i++){
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 1e 50 00 	movl   $0x501e,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 1d 23 00 00       	call   4281 <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 29 50 00 	movl   $0x5029,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 01 23 00 00       	call   4281 <printf>

  unlink("ff");
    1f80:	c7 04 24 36 50 00 00 	movl   $0x5036,(%esp)
    1f87:	e8 bd 21 00 00       	call   4149 <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 39 50 00 00 	movl   $0x5039,(%esp)
    1f93:	e8 c9 21 00 00       	call   4161 <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 3c 50 00 	movl   $0x503c,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 d1 22 00 00       	call   4281 <printf>
    exit();
    1fb0:	e8 44 21 00 00       	call   40f9 <exit>
  }

  fd = open("dd/ff", O_CREATE | O_RDWR);
    1fb5:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1fbc:	00 
    1fbd:	c7 04 24 54 50 00 00 	movl   $0x5054,(%esp)
    1fc4:	e8 70 21 00 00       	call   4139 <open>
    1fc9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1fcc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1fd0:	79 19                	jns    1feb <subdir+0x85>
    printf(1, "create dd/ff failed\n");
    1fd2:	c7 44 24 04 5a 50 00 	movl   $0x505a,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 9b 22 00 00       	call   4281 <printf>
    exit();
    1fe6:	e8 0e 21 00 00       	call   40f9 <exit>
  }
  write(fd, "ff", 2);
    1feb:	c7 44 24 08 02 00 00 	movl   $0x2,0x8(%esp)
    1ff2:	00 
    1ff3:	c7 44 24 04 36 50 00 	movl   $0x5036,0x4(%esp)
    1ffa:	00 
    1ffb:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1ffe:	89 04 24             	mov    %eax,(%esp)
    2001:	e8 13 21 00 00       	call   4119 <write>
  close(fd);
    2006:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2009:	89 04 24             	mov    %eax,(%esp)
    200c:	e8 10 21 00 00       	call   4121 <close>

  if(unlink("dd") >= 0){
    2011:	c7 04 24 39 50 00 00 	movl   $0x5039,(%esp)
    2018:	e8 2c 21 00 00       	call   4149 <unlink>
    201d:	85 c0                	test   %eax,%eax
    201f:	78 19                	js     203a <subdir+0xd4>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    2021:	c7 44 24 04 70 50 00 	movl   $0x5070,0x4(%esp)
    2028:	00 
    2029:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2030:	e8 4c 22 00 00       	call   4281 <printf>
    exit();
    2035:	e8 bf 20 00 00       	call   40f9 <exit>
  }

  if(mkdir("/dd/dd") != 0){
    203a:	c7 04 24 96 50 00 00 	movl   $0x5096,(%esp)
    2041:	e8 1b 21 00 00       	call   4161 <mkdir>
    2046:	85 c0                	test   %eax,%eax
    2048:	74 19                	je     2063 <subdir+0xfd>
    printf(1, "subdir mkdir dd/dd failed\n");
    204a:	c7 44 24 04 9d 50 00 	movl   $0x509d,0x4(%esp)
    2051:	00 
    2052:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2059:	e8 23 22 00 00       	call   4281 <printf>
    exit();
    205e:	e8 96 20 00 00       	call   40f9 <exit>
  }

  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    2063:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    206a:	00 
    206b:	c7 04 24 b8 50 00 00 	movl   $0x50b8,(%esp)
    2072:	e8 c2 20 00 00       	call   4139 <open>
    2077:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    207a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    207e:	79 19                	jns    2099 <subdir+0x133>
    printf(1, "create dd/dd/ff failed\n");
    2080:	c7 44 24 04 c1 50 00 	movl   $0x50c1,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 ed 21 00 00       	call   4281 <printf>
    exit();
    2094:	e8 60 20 00 00       	call   40f9 <exit>
  }
  write(fd, "FF", 2);
    2099:	c7 44 24 08 02 00 00 	movl   $0x2,0x8(%esp)
    20a0:	00 
    20a1:	c7 44 24 04 d9 50 00 	movl   $0x50d9,0x4(%esp)
    20a8:	00 
    20a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20ac:	89 04 24             	mov    %eax,(%esp)
    20af:	e8 65 20 00 00       	call   4119 <write>
  close(fd);
    20b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20b7:	89 04 24             	mov    %eax,(%esp)
    20ba:	e8 62 20 00 00       	call   4121 <close>

  fd = open("dd/dd/../ff", 0);
    20bf:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    20c6:	00 
    20c7:	c7 04 24 dc 50 00 00 	movl   $0x50dc,(%esp)
    20ce:	e8 66 20 00 00       	call   4139 <open>
    20d3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    20d6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    20da:	79 19                	jns    20f5 <subdir+0x18f>
    printf(1, "open dd/dd/../ff failed\n");
    20dc:	c7 44 24 04 e8 50 00 	movl   $0x50e8,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 91 21 00 00       	call   4281 <printf>
    exit();
    20f0:	e8 04 20 00 00       	call   40f9 <exit>
  }
  cc = read(fd, buf, sizeof(buf));
    20f5:	c7 44 24 08 00 20 00 	movl   $0x2000,0x8(%esp)
    20fc:	00 
    20fd:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
    2104:	00 
    2105:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2108:	89 04 24             	mov    %eax,(%esp)
    210b:	e8 01 20 00 00       	call   4111 <read>
    2110:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(cc != 2 || buf[0] != 'f'){
    2113:	83 7d f0 02          	cmpl   $0x2,-0x10(%ebp)
    2117:	75 0b                	jne    2124 <subdir+0x1be>
    2119:	0f b6 05 e0 8d 00 00 	movzbl 0x8de0,%eax
    2120:	3c 66                	cmp    $0x66,%al
    2122:	74 19                	je     213d <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    2124:	c7 44 24 04 01 51 00 	movl   $0x5101,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 49 21 00 00       	call   4281 <printf>
    exit();
    2138:	e8 bc 1f 00 00       	call   40f9 <exit>
  }
  close(fd);
    213d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2140:	89 04 24             	mov    %eax,(%esp)
    2143:	e8 d9 1f 00 00       	call   4121 <close>

  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    2148:	c7 44 24 04 1c 51 00 	movl   $0x511c,0x4(%esp)
    214f:	00 
    2150:	c7 04 24 b8 50 00 00 	movl   $0x50b8,(%esp)
    2157:	e8 fd 1f 00 00       	call   4159 <link>
    215c:	85 c0                	test   %eax,%eax
    215e:	74 19                	je     2179 <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2160:	c7 44 24 04 28 51 00 	movl   $0x5128,0x4(%esp)
    2167:	00 
    2168:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    216f:	e8 0d 21 00 00       	call   4281 <printf>
    exit();
    2174:	e8 80 1f 00 00       	call   40f9 <exit>
  }

  if(unlink("dd/dd/ff") != 0){
    2179:	c7 04 24 b8 50 00 00 	movl   $0x50b8,(%esp)
    2180:	e8 c4 1f 00 00       	call   4149 <unlink>
    2185:	85 c0                	test   %eax,%eax
    2187:	74 19                	je     21a2 <subdir+0x23c>
    printf(1, "unlink dd/dd/ff failed\n");
    2189:	c7 44 24 04 49 51 00 	movl   $0x5149,0x4(%esp)
    2190:	00 
    2191:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2198:	e8 e4 20 00 00       	call   4281 <printf>
    exit();
    219d:	e8 57 1f 00 00       	call   40f9 <exit>
  }
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    21a2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    21a9:	00 
    21aa:	c7 04 24 b8 50 00 00 	movl   $0x50b8,(%esp)
    21b1:	e8 83 1f 00 00       	call   4139 <open>
    21b6:	85 c0                	test   %eax,%eax
    21b8:	78 19                	js     21d3 <subdir+0x26d>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    21ba:	c7 44 24 04 64 51 00 	movl   $0x5164,0x4(%esp)
    21c1:	00 
    21c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    21c9:	e8 b3 20 00 00       	call   4281 <printf>
    exit();
    21ce:	e8 26 1f 00 00       	call   40f9 <exit>
  }

  if(chdir("dd") != 0){
    21d3:	c7 04 24 39 50 00 00 	movl   $0x5039,(%esp)
    21da:	e8 8a 1f 00 00       	call   4169 <chdir>
    21df:	85 c0                	test   %eax,%eax
    21e1:	74 19                	je     21fc <subdir+0x296>
    printf(1, "chdir dd failed\n");
    21e3:	c7 44 24 04 88 51 00 	movl   $0x5188,0x4(%esp)
    21ea:	00 
    21eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    21f2:	e8 8a 20 00 00       	call   4281 <printf>
    exit();
    21f7:	e8 fd 1e 00 00       	call   40f9 <exit>
  }
  if(chdir("dd/../../dd") != 0){
    21fc:	c7 04 24 99 51 00 00 	movl   $0x5199,(%esp)
    2203:	e8 61 1f 00 00       	call   4169 <chdir>
    2208:	85 c0                	test   %eax,%eax
    220a:	74 19                	je     2225 <subdir+0x2bf>
    printf(1, "chdir dd/../../dd failed\n");
    220c:	c7 44 24 04 a5 51 00 	movl   $0x51a5,0x4(%esp)
    2213:	00 
    2214:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    221b:	e8 61 20 00 00       	call   4281 <printf>
    exit();
    2220:	e8 d4 1e 00 00       	call   40f9 <exit>
  }
  if(chdir("dd/../../../dd") != 0){
    2225:	c7 04 24 bf 51 00 00 	movl   $0x51bf,(%esp)
    222c:	e8 38 1f 00 00       	call   4169 <chdir>
    2231:	85 c0                	test   %eax,%eax
    2233:	74 19                	je     224e <subdir+0x2e8>
    printf(1, "chdir dd/../../dd failed\n");
    2235:	c7 44 24 04 a5 51 00 	movl   $0x51a5,0x4(%esp)
    223c:	00 
    223d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2244:	e8 38 20 00 00       	call   4281 <printf>
    exit();
    2249:	e8 ab 1e 00 00       	call   40f9 <exit>
  }
  if(chdir("./..") != 0){
    224e:	c7 04 24 ce 51 00 00 	movl   $0x51ce,(%esp)
    2255:	e8 0f 1f 00 00       	call   4169 <chdir>
    225a:	85 c0                	test   %eax,%eax
    225c:	74 19                	je     2277 <subdir+0x311>
    printf(1, "chdir ./.. failed\n");
    225e:	c7 44 24 04 d3 51 00 	movl   $0x51d3,0x4(%esp)
    2265:	00 
    2266:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    226d:	e8 0f 20 00 00       	call   4281 <printf>
    exit();
    2272:	e8 82 1e 00 00       	call   40f9 <exit>
  }

  fd = open("dd/dd/ffff", 0);
    2277:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    227e:	00 
    227f:	c7 04 24 1c 51 00 00 	movl   $0x511c,(%esp)
    2286:	e8 ae 1e 00 00       	call   4139 <open>
    228b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    228e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2292:	79 19                	jns    22ad <subdir+0x347>
    printf(1, "open dd/dd/ffff failed\n");
    2294:	c7 44 24 04 e6 51 00 	movl   $0x51e6,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 d9 1f 00 00       	call   4281 <printf>
    exit();
    22a8:	e8 4c 1e 00 00       	call   40f9 <exit>
  }
  if(read(fd, buf, sizeof(buf)) != 2){
    22ad:	c7 44 24 08 00 20 00 	movl   $0x2000,0x8(%esp)
    22b4:	00 
    22b5:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
    22bc:	00 
    22bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    22c0:	89 04 24             	mov    %eax,(%esp)
    22c3:	e8 49 1e 00 00       	call   4111 <read>
    22c8:	83 f8 02             	cmp    $0x2,%eax
    22cb:	74 19                	je     22e6 <subdir+0x380>
    printf(1, "read dd/dd/ffff wrong len\n");
    22cd:	c7 44 24 04 fe 51 00 	movl   $0x51fe,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 a0 1f 00 00       	call   4281 <printf>
    exit();
    22e1:	e8 13 1e 00 00       	call   40f9 <exit>
  }
  close(fd);
    22e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    22e9:	89 04 24             	mov    %eax,(%esp)
    22ec:	e8 30 1e 00 00       	call   4121 <close>

  if(open("dd/dd/ff", O_RDONLY) >= 0){
    22f1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    22f8:	00 
    22f9:	c7 04 24 b8 50 00 00 	movl   $0x50b8,(%esp)
    2300:	e8 34 1e 00 00       	call   4139 <open>
    2305:	85 c0                	test   %eax,%eax
    2307:	78 19                	js     2322 <subdir+0x3bc>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2309:	c7 44 24 04 1c 52 00 	movl   $0x521c,0x4(%esp)
    2310:	00 
    2311:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2318:	e8 64 1f 00 00       	call   4281 <printf>
    exit();
    231d:	e8 d7 1d 00 00       	call   40f9 <exit>
  }

  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    2322:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2329:	00 
    232a:	c7 04 24 41 52 00 00 	movl   $0x5241,(%esp)
    2331:	e8 03 1e 00 00       	call   4139 <open>
    2336:	85 c0                	test   %eax,%eax
    2338:	78 19                	js     2353 <subdir+0x3ed>
    printf(1, "create dd/ff/ff succeeded!\n");
    233a:	c7 44 24 04 4a 52 00 	movl   $0x524a,0x4(%esp)
    2341:	00 
    2342:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2349:	e8 33 1f 00 00       	call   4281 <printf>
    exit();
    234e:	e8 a6 1d 00 00       	call   40f9 <exit>
  }
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    2353:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    235a:	00 
    235b:	c7 04 24 66 52 00 00 	movl   $0x5266,(%esp)
    2362:	e8 d2 1d 00 00       	call   4139 <open>
    2367:	85 c0                	test   %eax,%eax
    2369:	78 19                	js     2384 <subdir+0x41e>
    printf(1, "create dd/xx/ff succeeded!\n");
    236b:	c7 44 24 04 6f 52 00 	movl   $0x526f,0x4(%esp)
    2372:	00 
    2373:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    237a:	e8 02 1f 00 00       	call   4281 <printf>
    exit();
    237f:	e8 75 1d 00 00       	call   40f9 <exit>
  }
  if(open("dd", O_CREATE) >= 0){
    2384:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    238b:	00 
    238c:	c7 04 24 39 50 00 00 	movl   $0x5039,(%esp)
    2393:	e8 a1 1d 00 00       	call   4139 <open>
    2398:	85 c0                	test   %eax,%eax
    239a:	78 19                	js     23b5 <subdir+0x44f>
    printf(1, "create dd succeeded!\n");
    239c:	c7 44 24 04 8b 52 00 	movl   $0x528b,0x4(%esp)
    23a3:	00 
    23a4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23ab:	e8 d1 1e 00 00       	call   4281 <printf>
    exit();
    23b0:	e8 44 1d 00 00       	call   40f9 <exit>
  }
  if(open("dd", O_RDWR) >= 0){
    23b5:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
    23bc:	00 
    23bd:	c7 04 24 39 50 00 00 	movl   $0x5039,(%esp)
    23c4:	e8 70 1d 00 00       	call   4139 <open>
    23c9:	85 c0                	test   %eax,%eax
    23cb:	78 19                	js     23e6 <subdir+0x480>
    printf(1, "open dd rdwr succeeded!\n");
    23cd:	c7 44 24 04 a1 52 00 	movl   $0x52a1,0x4(%esp)
    23d4:	00 
    23d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23dc:	e8 a0 1e 00 00       	call   4281 <printf>
    exit();
    23e1:	e8 13 1d 00 00       	call   40f9 <exit>
  }
  if(open("dd", O_WRONLY) >= 0){
    23e6:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
    23ed:	00 
    23ee:	c7 04 24 39 50 00 00 	movl   $0x5039,(%esp)
    23f5:	e8 3f 1d 00 00       	call   4139 <open>
    23fa:	85 c0                	test   %eax,%eax
    23fc:	78 19                	js     2417 <subdir+0x4b1>
    printf(1, "open dd wronly succeeded!\n");
    23fe:	c7 44 24 04 ba 52 00 	movl   $0x52ba,0x4(%esp)
    2405:	00 
    2406:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    240d:	e8 6f 1e 00 00       	call   4281 <printf>
    exit();
    2412:	e8 e2 1c 00 00       	call   40f9 <exit>
  }
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2417:	c7 44 24 04 d5 52 00 	movl   $0x52d5,0x4(%esp)
    241e:	00 
    241f:	c7 04 24 41 52 00 00 	movl   $0x5241,(%esp)
    2426:	e8 2e 1d 00 00       	call   4159 <link>
    242b:	85 c0                	test   %eax,%eax
    242d:	75 19                	jne    2448 <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    242f:	c7 44 24 04 e0 52 00 	movl   $0x52e0,0x4(%esp)
    2436:	00 
    2437:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    243e:	e8 3e 1e 00 00       	call   4281 <printf>
    exit();
    2443:	e8 b1 1c 00 00       	call   40f9 <exit>
  }
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    2448:	c7 44 24 04 d5 52 00 	movl   $0x52d5,0x4(%esp)
    244f:	00 
    2450:	c7 04 24 66 52 00 00 	movl   $0x5266,(%esp)
    2457:	e8 fd 1c 00 00       	call   4159 <link>
    245c:	85 c0                	test   %eax,%eax
    245e:	75 19                	jne    2479 <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2460:	c7 44 24 04 04 53 00 	movl   $0x5304,0x4(%esp)
    2467:	00 
    2468:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    246f:	e8 0d 1e 00 00       	call   4281 <printf>
    exit();
    2474:	e8 80 1c 00 00       	call   40f9 <exit>
  }
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2479:	c7 44 24 04 1c 51 00 	movl   $0x511c,0x4(%esp)
    2480:	00 
    2481:	c7 04 24 54 50 00 00 	movl   $0x5054,(%esp)
    2488:	e8 cc 1c 00 00       	call   4159 <link>
    248d:	85 c0                	test   %eax,%eax
    248f:	75 19                	jne    24aa <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2491:	c7 44 24 04 28 53 00 	movl   $0x5328,0x4(%esp)
    2498:	00 
    2499:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24a0:	e8 dc 1d 00 00       	call   4281 <printf>
    exit();
    24a5:	e8 4f 1c 00 00       	call   40f9 <exit>
  }
  if(mkdir("dd/ff/ff") == 0){
    24aa:	c7 04 24 41 52 00 00 	movl   $0x5241,(%esp)
    24b1:	e8 ab 1c 00 00       	call   4161 <mkdir>
    24b6:	85 c0                	test   %eax,%eax
    24b8:	75 19                	jne    24d3 <subdir+0x56d>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    24ba:	c7 44 24 04 4a 53 00 	movl   $0x534a,0x4(%esp)
    24c1:	00 
    24c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24c9:	e8 b3 1d 00 00       	call   4281 <printf>
    exit();
    24ce:	e8 26 1c 00 00       	call   40f9 <exit>
  }
  if(mkdir("dd/xx/ff") == 0){
    24d3:	c7 04 24 66 52 00 00 	movl   $0x5266,(%esp)
    24da:	e8 82 1c 00 00       	call   4161 <mkdir>
    24df:	85 c0                	test   %eax,%eax
    24e1:	75 19                	jne    24fc <subdir+0x596>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    24e3:	c7 44 24 04 65 53 00 	movl   $0x5365,0x4(%esp)
    24ea:	00 
    24eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24f2:	e8 8a 1d 00 00       	call   4281 <printf>
    exit();
    24f7:	e8 fd 1b 00 00       	call   40f9 <exit>
  }
  if(mkdir("dd/dd/ffff") == 0){
    24fc:	c7 04 24 1c 51 00 00 	movl   $0x511c,(%esp)
    2503:	e8 59 1c 00 00       	call   4161 <mkdir>
    2508:	85 c0                	test   %eax,%eax
    250a:	75 19                	jne    2525 <subdir+0x5bf>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    250c:	c7 44 24 04 80 53 00 	movl   $0x5380,0x4(%esp)
    2513:	00 
    2514:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251b:	e8 61 1d 00 00       	call   4281 <printf>
    exit();
    2520:	e8 d4 1b 00 00       	call   40f9 <exit>
  }
  if(unlink("dd/xx/ff") == 0){
    2525:	c7 04 24 66 52 00 00 	movl   $0x5266,(%esp)
    252c:	e8 18 1c 00 00       	call   4149 <unlink>
    2531:	85 c0                	test   %eax,%eax
    2533:	75 19                	jne    254e <subdir+0x5e8>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2535:	c7 44 24 04 9d 53 00 	movl   $0x539d,0x4(%esp)
    253c:	00 
    253d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2544:	e8 38 1d 00 00       	call   4281 <printf>
    exit();
    2549:	e8 ab 1b 00 00       	call   40f9 <exit>
  }
  if(unlink("dd/ff/ff") == 0){
    254e:	c7 04 24 41 52 00 00 	movl   $0x5241,(%esp)
    2555:	e8 ef 1b 00 00       	call   4149 <unlink>
    255a:	85 c0                	test   %eax,%eax
    255c:	75 19                	jne    2577 <subdir+0x611>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    255e:	c7 44 24 04 b9 53 00 	movl   $0x53b9,0x4(%esp)
    2565:	00 
    2566:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    256d:	e8 0f 1d 00 00       	call   4281 <printf>
    exit();
    2572:	e8 82 1b 00 00       	call   40f9 <exit>
  }
  if(chdir("dd/ff") == 0){
    2577:	c7 04 24 54 50 00 00 	movl   $0x5054,(%esp)
    257e:	e8 e6 1b 00 00       	call   4169 <chdir>
    2583:	85 c0                	test   %eax,%eax
    2585:	75 19                	jne    25a0 <subdir+0x63a>
    printf(1, "chdir dd/ff succeeded!\n");
    2587:	c7 44 24 04 d5 53 00 	movl   $0x53d5,0x4(%esp)
    258e:	00 
    258f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2596:	e8 e6 1c 00 00       	call   4281 <printf>
    exit();
    259b:	e8 59 1b 00 00       	call   40f9 <exit>
  }
  if(chdir("dd/xx") == 0){
    25a0:	c7 04 24 ed 53 00 00 	movl   $0x53ed,(%esp)
    25a7:	e8 bd 1b 00 00       	call   4169 <chdir>
    25ac:	85 c0                	test   %eax,%eax
    25ae:	75 19                	jne    25c9 <subdir+0x663>
    printf(1, "chdir dd/xx succeeded!\n");
    25b0:	c7 44 24 04 f3 53 00 	movl   $0x53f3,0x4(%esp)
    25b7:	00 
    25b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25bf:	e8 bd 1c 00 00       	call   4281 <printf>
    exit();
    25c4:	e8 30 1b 00 00       	call   40f9 <exit>
  }

  if(unlink("dd/dd/ffff") != 0){
    25c9:	c7 04 24 1c 51 00 00 	movl   $0x511c,(%esp)
    25d0:	e8 74 1b 00 00       	call   4149 <unlink>
    25d5:	85 c0                	test   %eax,%eax
    25d7:	74 19                	je     25f2 <subdir+0x68c>
    printf(1, "unlink dd/dd/ff failed\n");
    25d9:	c7 44 24 04 49 51 00 	movl   $0x5149,0x4(%esp)
    25e0:	00 
    25e1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25e8:	e8 94 1c 00 00       	call   4281 <printf>
    exit();
    25ed:	e8 07 1b 00 00       	call   40f9 <exit>
  }
  if(unlink("dd/ff") != 0){
    25f2:	c7 04 24 54 50 00 00 	movl   $0x5054,(%esp)
    25f9:	e8 4b 1b 00 00       	call   4149 <unlink>
    25fe:	85 c0                	test   %eax,%eax
    2600:	74 19                	je     261b <subdir+0x6b5>
    printf(1, "unlink dd/ff failed\n");
    2602:	c7 44 24 04 0b 54 00 	movl   $0x540b,0x4(%esp)
    2609:	00 
    260a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2611:	e8 6b 1c 00 00       	call   4281 <printf>
    exit();
    2616:	e8 de 1a 00 00       	call   40f9 <exit>
  }
  if(unlink("dd") == 0){
    261b:	c7 04 24 39 50 00 00 	movl   $0x5039,(%esp)
    2622:	e8 22 1b 00 00       	call   4149 <unlink>
    2627:	85 c0                	test   %eax,%eax
    2629:	75 19                	jne    2644 <subdir+0x6de>
    printf(1, "unlink non-empty dd succeeded!\n");
    262b:	c7 44 24 04 20 54 00 	movl   $0x5420,0x4(%esp)
    2632:	00 
    2633:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    263a:	e8 42 1c 00 00       	call   4281 <printf>
    exit();
    263f:	e8 b5 1a 00 00       	call   40f9 <exit>
  }
  if(unlink("dd/dd") < 0){
    2644:	c7 04 24 40 54 00 00 	movl   $0x5440,(%esp)
    264b:	e8 f9 1a 00 00       	call   4149 <unlink>
    2650:	85 c0                	test   %eax,%eax
    2652:	79 19                	jns    266d <subdir+0x707>
    printf(1, "unlink dd/dd failed\n");
    2654:	c7 44 24 04 46 54 00 	movl   $0x5446,0x4(%esp)
    265b:	00 
    265c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2663:	e8 19 1c 00 00       	call   4281 <printf>
    exit();
    2668:	e8 8c 1a 00 00       	call   40f9 <exit>
  }
  if(unlink("dd") < 0){
    266d:	c7 04 24 39 50 00 00 	movl   $0x5039,(%esp)
    2674:	e8 d0 1a 00 00       	call   4149 <unlink>
    2679:	85 c0                	test   %eax,%eax
    267b:	79 19                	jns    2696 <subdir+0x730>
    printf(1, "unlink dd failed\n");
    267d:	c7 44 24 04 5b 54 00 	movl   $0x545b,0x4(%esp)
    2684:	00 
    2685:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    268c:	e8 f0 1b 00 00       	call   4281 <printf>
    exit();
    2691:	e8 63 1a 00 00       	call   40f9 <exit>
  }

  printf(1, "subdir ok\n");
    2696:	c7 44 24 04 6d 54 00 	movl   $0x546d,0x4(%esp)
    269d:	00 
    269e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26a5:	e8 d7 1b 00 00       	call   4281 <printf>
}
    26aa:	c9                   	leave  
    26ab:	c3                   	ret    
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 78 54 00 	movl   $0x5478,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 bb 1b 00 00       	call   4281 <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 87 54 00 00 	movl   $0x5487,(%esp)
    26cd:	e8 77 1a 00 00       	call   4149 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 87 54 00 00 	movl   $0x5487,(%esp)
    26ed:	e8 47 1a 00 00       	call   4139 <open>
    26f2:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(fd < 0){
    26f5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    26f9:	79 19                	jns    2714 <bigwrite+0x68>
      printf(1, "cannot create bigwrite\n");
    26fb:	c7 44 24 04 90 54 00 	movl   $0x5490,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 72 1b 00 00       	call   4281 <printf>
      exit();
    270f:	e8 e5 19 00 00       	call   40f9 <exit>
    }
    int i;
    for(i = 0; i < 2; i++){
    ...
    2724:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
    272b:	00 
    272c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    272f:	89 04 24             	mov    %eax,(%esp)
    2732:	e8 e2 19 00 00       	call   4119 <write>
    ...
    2750:	c7 44 24 04 a8 54 00 	movl   $0x54a8,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 1d 1b 00 00       	call   4281 <printf>
        exit();
    2764:	e8 90 19 00 00       	call   40f9 <exit>
    for(i = 0; i < 2; i++){
    ...
    2779:	e8 a3 19 00 00       	call   4121 <close>
    unlink("bigwrite");
    277e:	c7 04 24 87 54 00 00 	movl   $0x5487,(%esp)
    2785:	e8 bf 19 00 00       	call   4149 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 ba 54 00 	movl   $0x54ba,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 cf 1a 00 00       	call   4281 <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 c7 54 00 	movl   $0x54c7,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 b3 1a 00 00       	call   4281 <printf>

  unlink("bigfile");
    27ce:	c7 04 24 d5 54 00 00 	movl   $0x54d5,(%esp)
    27d5:	e8 6f 19 00 00       	call   4149 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 d5 54 00 00 	movl   $0x54d5,(%esp)
    27e9:	e8 4b 19 00 00       	call   4139 <open>
    27ee:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    27f1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    27f5:	79 19                	jns    2810 <bigfile+0x5c>
    printf(1, "cannot create bigfile");
    27f7:	c7 44 24 04 dd 54 00 	movl   $0x54dd,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 76 1a 00 00       	call   4281 <printf>
    exit();
    280b:	e8 e9 18 00 00       	call   40f9 <exit>
  }
  for(i = 0; i < 20; i++){
  ...
  close(fd);
    ...
    287f:	e8 9d 18 00 00       	call   4121 <close>

  fd = open("bigfile", 0);
    2884:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    288b:	00 
    288c:	c7 04 24 d5 54 00 00 	movl   $0x54d5,(%esp)
    2893:	e8 a1 18 00 00       	call   4139 <open>
    2898:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    289b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    289f:	79 19                	jns    28ba <bigfile+0x106>
    printf(1, "cannot open bigfile\n");
    28a1:	c7 44 24 04 09 55 00 	movl   $0x5509,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 cc 19 00 00       	call   4281 <printf>
    exit();
    28b5:	e8 3f 18 00 00       	call   40f9 <exit>
  }
  total = 0;
  ...
  close(fd);
    ...
    2912:	e8 0a 18 00 00       	call   4121 <close>
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 33 55 00 	movl   $0x5533,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 3e 19 00 00       	call   4281 <printf>
      exit();
    2943:	e8 b1 17 00 00       	call   40f9 <exit>
    if(buf[0] != i/2 || buf[299] != i/2){
    2948:	0f b6 05 e0 8d 00 00 	movzbl 0x8de0,%eax
    ...
    2962:	0f b6 05 0b 8f 00 00 	movzbl 0x8f0b,%eax
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 47 55 00 	movl   $0x5547,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 f1 18 00 00       	call   4281 <printf>
      exit();
    2990:	e8 64 17 00 00       	call   40f9 <exit>
    total += cc;
  ...
  for(i = 0; ; i++){
    ...
    29a4:	c7 44 24 04 60 55 00 	movl   $0x5560,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 c9 18 00 00       	call   4281 <printf>
    exit();
    29b8:	e8 3c 17 00 00       	call   40f9 <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 d5 54 00 00 	movl   $0x54d5,(%esp)
    29c4:	e8 80 17 00 00       	call   4149 <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 7a 55 00 	movl   $0x557a,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 a4 18 00 00       	call   4281 <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    29e5:	c7 44 24 04 8b 55 00 	movl   $0x558b,0x4(%esp)
    29ec:	00 
    29ed:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29f4:	e8 88 18 00 00       	call   4281 <printf>

  if(mkdir("12345678901234") != 0){
    29f9:	c7 04 24 9a 55 00 00 	movl   $0x559a,(%esp)
    2a00:	e8 5c 17 00 00       	call   4161 <mkdir>
    2a05:	85 c0                	test   %eax,%eax
    2a07:	74 19                	je     2a22 <fourteen+0x43>
    printf(1, "mkdir 12345678901234 failed\n");
    2a09:	c7 44 24 04 a9 55 00 	movl   $0x55a9,0x4(%esp)
    2a10:	00 
    2a11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a18:	e8 64 18 00 00       	call   4281 <printf>
    exit();
    2a1d:	e8 d7 16 00 00       	call   40f9 <exit>
  }
  if(mkdir("12345678901234/123456789012345") != 0){
    2a22:	c7 04 24 c8 55 00 00 	movl   $0x55c8,(%esp)
    2a29:	e8 33 17 00 00       	call   4161 <mkdir>
    2a2e:	85 c0                	test   %eax,%eax
    2a30:	74 19                	je     2a4b <fourteen+0x6c>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    2a32:	c7 44 24 04 e8 55 00 	movl   $0x55e8,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a41:	e8 3b 18 00 00       	call   4281 <printf>
    exit();
    2a46:	e8 ae 16 00 00       	call   40f9 <exit>
  }
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    2a4b:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a52:	00 
    2a53:	c7 04 24 18 56 00 00 	movl   $0x5618,(%esp)
    2a5a:	e8 da 16 00 00       	call   4139 <open>
    2a5f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    2a62:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2a66:	79 19                	jns    2a81 <fourteen+0xa2>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    2a68:	c7 44 24 04 48 56 00 	movl   $0x5648,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 05 18 00 00       	call   4281 <printf>
    exit();
    2a7c:	e8 78 16 00 00       	call   40f9 <exit>
  }
  close(fd);
    2a81:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2a84:	89 04 24             	mov    %eax,(%esp)
    2a87:	e8 95 16 00 00       	call   4121 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2a8c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    2a93:	00 
    2a94:	c7 04 24 88 56 00 00 	movl   $0x5688,(%esp)
    2a9b:	e8 99 16 00 00       	call   4139 <open>
    2aa0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    2aa3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2aa7:	79 19                	jns    2ac2 <fourteen+0xe3>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2aa9:	c7 44 24 04 b8 56 00 	movl   $0x56b8,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 c4 17 00 00       	call   4281 <printf>
    exit();
    2abd:	e8 37 16 00 00       	call   40f9 <exit>
  }
  close(fd);
    2ac2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ac5:	89 04 24             	mov    %eax,(%esp)
    2ac8:	e8 54 16 00 00       	call   4121 <close>

  if(mkdir("12345678901234/12345678901234") == 0){
    2acd:	c7 04 24 f2 56 00 00 	movl   $0x56f2,(%esp)
    2ad4:	e8 88 16 00 00       	call   4161 <mkdir>
    2ad9:	85 c0                	test   %eax,%eax
    2adb:	75 19                	jne    2af6 <fourteen+0x117>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2add:	c7 44 24 04 10 57 00 	movl   $0x5710,0x4(%esp)
    2ae4:	00 
    2ae5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2aec:	e8 90 17 00 00       	call   4281 <printf>
    exit();
    2af1:	e8 03 16 00 00       	call   40f9 <exit>
  }
  if(mkdir("123456789012345/12345678901234") == 0){
    2af6:	c7 04 24 40 57 00 00 	movl   $0x5740,(%esp)
    2afd:	e8 5f 16 00 00       	call   4161 <mkdir>
    2b02:	85 c0                	test   %eax,%eax
    2b04:	75 19                	jne    2b1f <fourteen+0x140>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2b06:	c7 44 24 04 60 57 00 	movl   $0x5760,0x4(%esp)
    2b0d:	00 
    2b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b15:	e8 67 17 00 00       	call   4281 <printf>
    exit();
    2b1a:	e8 da 15 00 00       	call   40f9 <exit>
  }

  printf(1, "fourteen ok\n");
    2b1f:	c7 44 24 04 91 57 00 	movl   $0x5791,0x4(%esp)
    2b26:	00 
    2b27:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b2e:	e8 4e 17 00 00       	call   4281 <printf>
}
    2b33:	c9                   	leave  
    2b34:	c3                   	ret    
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    2b3b:	c7 44 24 04 9e 57 00 	movl   $0x579e,0x4(%esp)
    2b42:	00 
    2b43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b4a:	e8 32 17 00 00       	call   4281 <printf>
  if(mkdir("dots") != 0){
    2b4f:	c7 04 24 aa 57 00 00 	movl   $0x57aa,(%esp)
    2b56:	e8 06 16 00 00       	call   4161 <mkdir>
    2b5b:	85 c0                	test   %eax,%eax
    2b5d:	74 19                	je     2b78 <rmdot+0x43>
    printf(1, "mkdir dots failed\n");
    2b5f:	c7 44 24 04 af 57 00 	movl   $0x57af,0x4(%esp)
    2b66:	00 
    2b67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b6e:	e8 0e 17 00 00       	call   4281 <printf>
    exit();
    2b73:	e8 81 15 00 00       	call   40f9 <exit>
  }
  if(chdir("dots") != 0){
    2b78:	c7 04 24 aa 57 00 00 	movl   $0x57aa,(%esp)
    2b7f:	e8 e5 15 00 00       	call   4169 <chdir>
    2b84:	85 c0                	test   %eax,%eax
    2b86:	74 19                	je     2ba1 <rmdot+0x6c>
    printf(1, "chdir dots failed\n");
    2b88:	c7 44 24 04 c2 57 00 	movl   $0x57c2,0x4(%esp)
    2b8f:	00 
    2b90:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b97:	e8 e5 16 00 00       	call   4281 <printf>
    exit();
    2b9c:	e8 58 15 00 00       	call   40f9 <exit>
  }
  if(unlink(".") == 0){
    2ba1:	c7 04 24 db 4e 00 00 	movl   $0x4edb,(%esp)
    2ba8:	e8 9c 15 00 00       	call   4149 <unlink>
    2bad:	85 c0                	test   %eax,%eax
    2baf:	75 19                	jne    2bca <rmdot+0x95>
    printf(1, "rm . worked!\n");
    2bb1:	c7 44 24 04 d5 57 00 	movl   $0x57d5,0x4(%esp)
    2bb8:	00 
    2bb9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2bc0:	e8 bc 16 00 00       	call   4281 <printf>
    exit();
    2bc5:	e8 2f 15 00 00       	call   40f9 <exit>
  }
  if(unlink("..") == 0){
    2bca:	c7 04 24 6e 4a 00 00 	movl   $0x4a6e,(%esp)
    2bd1:	e8 73 15 00 00       	call   4149 <unlink>
    2bd6:	85 c0                	test   %eax,%eax
    2bd8:	75 19                	jne    2bf3 <rmdot+0xbe>
    printf(1, "rm .. worked!\n");
    2bda:	c7 44 24 04 e3 57 00 	movl   $0x57e3,0x4(%esp)
    2be1:	00 
    2be2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be9:	e8 93 16 00 00       	call   4281 <printf>
    exit();
    2bee:	e8 06 15 00 00       	call   40f9 <exit>
  }
  if(chdir("/") != 0){
    2bf3:	c7 04 24 c2 46 00 00 	movl   $0x46c2,(%esp)
    2bfa:	e8 6a 15 00 00       	call   4169 <chdir>
    2bff:	85 c0                	test   %eax,%eax
    2c01:	74 19                	je     2c1c <rmdot+0xe7>
    printf(1, "chdir / failed\n");
    2c03:	c7 44 24 04 c4 46 00 	movl   $0x46c4,0x4(%esp)
    2c0a:	00 
    2c0b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c12:	e8 6a 16 00 00       	call   4281 <printf>
    exit();
    2c17:	e8 dd 14 00 00       	call   40f9 <exit>
  }
  if(unlink("dots/.") == 0){
    2c1c:	c7 04 24 f2 57 00 00 	movl   $0x57f2,(%esp)
    2c23:	e8 21 15 00 00       	call   4149 <unlink>
    2c28:	85 c0                	test   %eax,%eax
    2c2a:	75 19                	jne    2c45 <rmdot+0x110>
    printf(1, "unlink dots/. worked!\n");
    2c2c:	c7 44 24 04 f9 57 00 	movl   $0x57f9,0x4(%esp)
    2c33:	00 
    2c34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c3b:	e8 41 16 00 00       	call   4281 <printf>
    exit();
    2c40:	e8 b4 14 00 00       	call   40f9 <exit>
  }
  if(unlink("dots/..") == 0){
    2c45:	c7 04 24 10 58 00 00 	movl   $0x5810,(%esp)
    2c4c:	e8 f8 14 00 00       	call   4149 <unlink>
    2c51:	85 c0                	test   %eax,%eax
    2c53:	75 19                	jne    2c6e <rmdot+0x139>
    printf(1, "unlink dots/.. worked!\n");
    2c55:	c7 44 24 04 18 58 00 	movl   $0x5818,0x4(%esp)
    2c5c:	00 
    2c5d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c64:	e8 18 16 00 00       	call   4281 <printf>
    exit();
    2c69:	e8 8b 14 00 00       	call   40f9 <exit>
  }
  if(unlink("dots") != 0){
    2c6e:	c7 04 24 aa 57 00 00 	movl   $0x57aa,(%esp)
    2c75:	e8 cf 14 00 00       	call   4149 <unlink>
    2c7a:	85 c0                	test   %eax,%eax
    2c7c:	74 19                	je     2c97 <rmdot+0x162>
    printf(1, "unlink dots failed!\n");
    2c7e:	c7 44 24 04 30 58 00 	movl   $0x5830,0x4(%esp)
    2c85:	00 
    2c86:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c8d:	e8 ef 15 00 00       	call   4281 <printf>
    exit();
    2c92:	e8 62 14 00 00       	call   40f9 <exit>
  }
  printf(1, "rmdot ok\n");
    2c97:	c7 44 24 04 45 58 00 	movl   $0x5845,0x4(%esp)
    2c9e:	00 
    2c9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ca6:	e8 d6 15 00 00       	call   4281 <printf>
}
    2cab:	c9                   	leave  
    2cac:	c3                   	ret    
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 4f 58 00 	movl   $0x584f,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 ba 15 00 00       	call   4281 <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 5c 58 00 00 	movl   $0x585c,(%esp)
    2cd6:	e8 5e 14 00 00       	call   4139 <open>
    2cdb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    2cde:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2ce2:	79 19                	jns    2cfd <dirfile+0x50>
    printf(1, "create dirfile failed\n");
    2ce4:	c7 44 24 04 64 58 00 	movl   $0x5864,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 89 15 00 00       	call   4281 <printf>
    exit();
    2cf8:	e8 fc 13 00 00       	call   40f9 <exit>
  }
  close(fd);
    2cfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2d00:	89 04 24             	mov    %eax,(%esp)
    2d03:	e8 19 14 00 00       	call   4121 <close>
  if(chdir("dirfile") == 0){
    2d08:	c7 04 24 5c 58 00 00 	movl   $0x585c,(%esp)
    2d0f:	e8 55 14 00 00       	call   4169 <chdir>
    2d14:	85 c0                	test   %eax,%eax
    2d16:	75 19                	jne    2d31 <dirfile+0x84>
    printf(1, "chdir dirfile succeeded!\n");
    2d18:	c7 44 24 04 7b 58 00 	movl   $0x587b,0x4(%esp)
    2d1f:	00 
    2d20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d27:	e8 55 15 00 00       	call   4281 <printf>
    exit();
    2d2c:	e8 c8 13 00 00       	call   40f9 <exit>
  }
  fd = open("dirfile/xx", 0);
    2d31:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    2d38:	00 
    2d39:	c7 04 24 95 58 00 00 	movl   $0x5895,(%esp)
    2d40:	e8 f4 13 00 00       	call   4139 <open>
    2d45:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2d48:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2d4c:	78 19                	js     2d67 <dirfile+0xba>
    printf(1, "create dirfile/xx succeeded!\n");
    2d4e:	c7 44 24 04 a0 58 00 	movl   $0x58a0,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 1f 15 00 00       	call   4281 <printf>
    exit();
    2d62:	e8 92 13 00 00       	call   40f9 <exit>
  }
  fd = open("dirfile/xx", O_CREATE);
    2d67:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2d6e:	00 
    2d6f:	c7 04 24 95 58 00 00 	movl   $0x5895,(%esp)
    2d76:	e8 be 13 00 00       	call   4139 <open>
    2d7b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2d7e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2d82:	78 19                	js     2d9d <dirfile+0xf0>
    printf(1, "create dirfile/xx succeeded!\n");
    2d84:	c7 44 24 04 a0 58 00 	movl   $0x58a0,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 e9 14 00 00       	call   4281 <printf>
    exit();
    2d98:	e8 5c 13 00 00       	call   40f9 <exit>
  }
  if(mkdir("dirfile/xx") == 0){
    2d9d:	c7 04 24 95 58 00 00 	movl   $0x5895,(%esp)
    2da4:	e8 b8 13 00 00       	call   4161 <mkdir>
    2da9:	85 c0                	test   %eax,%eax
    2dab:	75 19                	jne    2dc6 <dirfile+0x119>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2dad:	c7 44 24 04 be 58 00 	movl   $0x58be,0x4(%esp)
    2db4:	00 
    2db5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbc:	e8 c0 14 00 00       	call   4281 <printf>
    exit();
    2dc1:	e8 33 13 00 00       	call   40f9 <exit>
  }
  if(unlink("dirfile/xx") == 0){
    2dc6:	c7 04 24 95 58 00 00 	movl   $0x5895,(%esp)
    2dcd:	e8 77 13 00 00       	call   4149 <unlink>
    2dd2:	85 c0                	test   %eax,%eax
    2dd4:	75 19                	jne    2def <dirfile+0x142>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2dd6:	c7 44 24 04 db 58 00 	movl   $0x58db,0x4(%esp)
    2ddd:	00 
    2dde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de5:	e8 97 14 00 00       	call   4281 <printf>
    exit();
    2dea:	e8 0a 13 00 00       	call   40f9 <exit>
  }
  if(link("README", "dirfile/xx") == 0){
    2def:	c7 44 24 04 95 58 00 	movl   $0x5895,0x4(%esp)
    2df6:	00 
    2df7:	c7 04 24 f9 58 00 00 	movl   $0x58f9,(%esp)
    2dfe:	e8 56 13 00 00       	call   4159 <link>
    2e03:	85 c0                	test   %eax,%eax
    2e05:	75 19                	jne    2e20 <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2e07:	c7 44 24 04 00 59 00 	movl   $0x5900,0x4(%esp)
    2e0e:	00 
    2e0f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e16:	e8 66 14 00 00       	call   4281 <printf>
    exit();
    2e1b:	e8 d9 12 00 00       	call   40f9 <exit>
  }
  if(unlink("dirfile") != 0){
    2e20:	c7 04 24 5c 58 00 00 	movl   $0x585c,(%esp)
    2e27:	e8 1d 13 00 00       	call   4149 <unlink>
    2e2c:	85 c0                	test   %eax,%eax
    2e2e:	74 19                	je     2e49 <dirfile+0x19c>
    printf(1, "unlink dirfile failed!\n");
    2e30:	c7 44 24 04 1f 59 00 	movl   $0x591f,0x4(%esp)
    2e37:	00 
    2e38:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e3f:	e8 3d 14 00 00       	call   4281 <printf>
    exit();
    2e44:	e8 b0 12 00 00       	call   40f9 <exit>
  }

  fd = open(".", O_RDWR);
    2e49:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
    2e50:	00 
    2e51:	c7 04 24 db 4e 00 00 	movl   $0x4edb,(%esp)
    2e58:	e8 dc 12 00 00       	call   4139 <open>
    2e5d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2e60:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2e64:	78 19                	js     2e7f <dirfile+0x1d2>
    printf(1, "open . for writing succeeded!\n");
    2e66:	c7 44 24 04 38 59 00 	movl   $0x5938,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 07 14 00 00       	call   4281 <printf>
    exit();
    2e7a:	e8 7a 12 00 00       	call   40f9 <exit>
  }
  fd = open(".", 0);
    2e7f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    2e86:	00 
    2e87:	c7 04 24 db 4e 00 00 	movl   $0x4edb,(%esp)
    2e8e:	e8 a6 12 00 00       	call   4139 <open>
    2e93:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(write(fd, "x", 1) > 0){
    2e96:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    2e9d:	00 
    2e9e:	c7 44 24 04 27 4b 00 	movl   $0x4b27,0x4(%esp)
    2ea5:	00 
    2ea6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ea9:	89 04 24             	mov    %eax,(%esp)
    2eac:	e8 68 12 00 00       	call   4119 <write>
    2eb1:	85 c0                	test   %eax,%eax
    2eb3:	7e 19                	jle    2ece <dirfile+0x221>
    printf(1, "write . succeeded!\n");
    2eb5:	c7 44 24 04 57 59 00 	movl   $0x5957,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 b8 13 00 00       	call   4281 <printf>
    exit();
    2ec9:	e8 2b 12 00 00       	call   40f9 <exit>
  }
  close(fd);
    2ece:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ed1:	89 04 24             	mov    %eax,(%esp)
    2ed4:	e8 48 12 00 00       	call   4121 <close>

  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 6b 59 00 	movl   $0x596b,0x4(%esp)
    2ee0:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 7b 59 00 	movl   $0x597b,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 78 13 00 00       	call   4281 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    if(mkdir("irefd") != 0){
    2f15:	c7 04 24 8c 59 00 00 	movl   $0x598c,(%esp)
    2f1c:	e8 40 12 00 00       	call   4161 <mkdir>
    2f21:	85 c0                	test   %eax,%eax
    2f23:	74 19                	je     2f3e <iref+0x4f>
      printf(1, "mkdir irefd failed\n");
    2f25:	c7 44 24 04 92 59 00 	movl   $0x5992,0x4(%esp)
    2f2c:	00 
    2f2d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f34:	e8 48 13 00 00       	call   4281 <printf>
      exit();
    2f39:	e8 bb 11 00 00       	call   40f9 <exit>
    }
    if(chdir("irefd") != 0){
    2f3e:	c7 04 24 8c 59 00 00 	movl   $0x598c,(%esp)
    2f45:	e8 1f 12 00 00       	call   4169 <chdir>
    2f4a:	85 c0                	test   %eax,%eax
    2f4c:	74 19                	je     2f67 <iref+0x78>
      printf(1, "chdir irefd failed\n");
    2f4e:	c7 44 24 04 a6 59 00 	movl   $0x59a6,0x4(%esp)
    2f55:	00 
    2f56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f5d:	e8 1f 13 00 00       	call   4281 <printf>
      exit();
    2f62:	e8 92 11 00 00       	call   40f9 <exit>
    }

    mkdir("");
    2f67:	c7 04 24 ba 59 00 00 	movl   $0x59ba,(%esp)
    2f6e:	e8 ee 11 00 00       	call   4161 <mkdir>
    link("README", "");
    2f73:	c7 44 24 04 ba 59 00 	movl   $0x59ba,0x4(%esp)
    2f7a:	00 
    2f7b:	c7 04 24 f9 58 00 00 	movl   $0x58f9,(%esp)
    2f82:	e8 d2 11 00 00       	call   4159 <link>
    fd = open("", O_CREATE);
    2f87:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2f8e:	00 
    2f8f:	c7 04 24 ba 59 00 00 	movl   $0x59ba,(%esp)
    2f96:	e8 9e 11 00 00       	call   4139 <open>
    ...
    2faa:	e8 72 11 00 00       	call   4121 <close>
    fd = open("xx", O_CREATE);
    2faf:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2fb6:	00 
    2fb7:	c7 04 24 bb 59 00 00 	movl   $0x59bb,(%esp)
    2fbe:	e8 76 11 00 00       	call   4139 <open>
    ...
    2fd2:	e8 4a 11 00 00       	call   4121 <close>
    unlink("xx");
    2fd7:	c7 04 24 bb 59 00 00 	movl   $0x59bb,(%esp)
    2fde:	e8 66 11 00 00       	call   4149 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    2ff1:	c7 04 24 c2 46 00 00 	movl   $0x46c2,(%esp)
    2ff8:	e8 6c 11 00 00       	call   4169 <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 be 59 00 	movl   $0x59be,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 70 12 00 00       	call   4281 <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 d2 59 00 	movl   $0x59d2,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 54 12 00 00       	call   4281 <printf>

  for(n=0; n<1000; n++){
    302d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3034:	eb 1f                	jmp    3055 <forktest+0x42>
    pid = fork();
    3036:	e8 b6 10 00 00       	call   40f1 <fork>
    ...
    304a:	75 05                	jne    3051 <forktest+0x3e>
      exit();
    304c:	e8 a8 10 00 00       	call   40f9 <exit>
  for(n=0; n<1000; n++){
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 e0 59 00 	movl   $0x59e0,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 06 12 00 00       	call   4281 <printf>
    exit();
    307b:	e8 79 10 00 00       	call   40f9 <exit>
  }

  for(; n > 0; n--){
    3080:	eb 26                	jmp    30a8 <forktest+0x95>
    if(wait() < 0){
    3082:	e8 7a 10 00 00       	call   4101 <wait>
    3087:	85 c0                	test   %eax,%eax
    3089:	79 19                	jns    30a4 <forktest+0x91>
      printf(1, "wait stopped early\n");
    308b:	c7 44 24 04 02 5a 00 	movl   $0x5a02,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 e2 11 00 00       	call   4281 <printf>
      exit();
    309f:	e8 55 10 00 00       	call   40f9 <exit>
  for(; n > 0; n--){
  ...
  if(wait() != -1){
    30ae:	e8 4e 10 00 00       	call   4101 <wait>
    30b3:	83 f8 ff             	cmp    $0xffffffff,%eax
    30b6:	74 19                	je     30d1 <forktest+0xbe>
    printf(1, "wait got too many\n");
    30b8:	c7 44 24 04 16 5a 00 	movl   $0x5a16,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 b5 11 00 00       	call   4281 <printf>
    exit();
    30cc:	e8 28 10 00 00       	call   40f9 <exit>
  }

  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 29 5a 00 	movl   $0x5a29,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 9c 11 00 00       	call   4281 <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 04 66 00 00       	mov    0x6604,%eax
    30f6:	c7 44 24 04 37 5a 00 	movl   $0x5a37,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 7b 11 00 00       	call   4281 <printf>
  oldbrk = sbrk(0);
    3106:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    310d:	e8 6f 10 00 00       	call   4181 <sbrk>
    3112:	89 45 ec             	mov    %eax,-0x14(%ebp)

  // can one sbrk() less than a page?
  a = sbrk(0);
    3115:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    311c:	e8 60 10 00 00       	call   4181 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    3134:	e8 48 10 00 00       	call   4181 <sbrk>
    ...
    3144:	a1 04 66 00 00       	mov    0x6604,%eax
    ...
    315e:	c7 44 24 04 42 5a 00 	movl   $0x5a42,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 13 11 00 00       	call   4281 <printf>
      exit();
    316e:	e8 86 0f 00 00       	call   40f9 <exit>
    }
    *b = 1;
  ...
  pid = fork();
    318f:	e8 5d 0f 00 00       	call   40f1 <fork>
    3194:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(pid < 0){
    3197:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    319b:	79 1a                	jns    31b7 <sbrktest+0xd0>
    printf(stdout, "sbrk test fork failed\n");
    319d:	a1 04 66 00 00       	mov    0x6604,%eax
    31a2:	c7 44 24 04 5d 5a 00 	movl   $0x5a5d,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 cf 10 00 00       	call   4281 <printf>
    exit();
    31b2:	e8 42 0f 00 00       	call   40f9 <exit>
  }
  c = sbrk(1);
    31b7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31be:	e8 be 0f 00 00       	call   4181 <sbrk>
    31c3:	89 45 e0             	mov    %eax,-0x20(%ebp)
  c = sbrk(1);
    31c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31cd:	e8 af 0f 00 00       	call   4181 <sbrk>
  ...
  if(c != a + 1){
    ...
    31e0:	a1 04 66 00 00       	mov    0x6604,%eax
    31e5:	c7 44 24 04 74 5a 00 	movl   $0x5a74,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 8c 10 00 00       	call   4281 <printf>
    exit();
    31f5:	e8 ff 0e 00 00       	call   40f9 <exit>
  }
  if(pid == 0)
    31fa:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    31fe:	75 05                	jne    3205 <sbrktest+0x11e>
    exit();
    3200:	e8 f4 0e 00 00       	call   40f9 <exit>
  wait();
    3205:	e8 f7 0e 00 00       	call   4101 <wait>

  // can one grow address space to something big?
#define BIG (100*1024*1024)
  a = sbrk(0);
    320a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3211:	e8 6b 0f 00 00       	call   4181 <sbrk>
  ...
  p = sbrk(amt);
    ...
    322e:	e8 4e 0f 00 00       	call   4181 <sbrk>
  ...
  if (p != a) {
    ...
    323e:	a1 04 66 00 00       	mov    0x6604,%eax
    3243:	c7 44 24 04 90 5a 00 	movl   $0x5a90,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 2e 10 00 00       	call   4281 <printf>
    exit();
    3253:	e8 a1 0e 00 00       	call   40f9 <exit>
  }
  lastaddr = (char*) (BIG-1);
  ...
  *lastaddr = 99;
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 04 66 00 00       	mov    0x6604,%eax
    ...
    32d2:	c7 44 24 04 ec 5a 00 	movl   $0x5aec,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 9f 0f 00 00       	call   4281 <printf>
    exit();
    32e2:	e8 12 0e 00 00       	call   40f9 <exit>
  }

  // can one re-allocate that page?
  a = sbrk(0);
    32e7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    32ee:	e8 8e 0e 00 00       	call   4181 <sbrk>
    32f3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c = sbrk(4096);
    32f6:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    32fd:	e8 7f 0e 00 00       	call   4181 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3314:	e8 68 0e 00 00       	call   4181 <sbrk>
    ...
    3326:	a1 04 66 00 00       	mov    0x6604,%eax
    ...
    3339:	c7 44 24 04 24 5b 00 	movl   $0x5b24,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 38 0f 00 00       	call   4281 <printf>
    exit();
    3349:	e8 ab 0d 00 00       	call   40f9 <exit>
  }
  if(*lastaddr == 99){
    ...
    3358:	a1 04 66 00 00       	mov    0x6604,%eax
    335d:	c7 44 24 04 4c 5b 00 	movl   $0x5b4c,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 14 0f 00 00       	call   4281 <printf>
    exit();
    336d:	e8 87 0d 00 00       	call   40f9 <exit>
  }

  a = sbrk(0);
    3372:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3379:	e8 03 0e 00 00       	call   4181 <sbrk>
    337e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c = sbrk(-(sbrk(0) - oldbrk));
    3381:	8b 5d ec             	mov    -0x14(%ebp),%ebx
    3384:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    338b:	e8 f1 0d 00 00       	call   4181 <sbrk>
    3390:	29 c3                	sub    %eax,%ebx
    3392:	89 d8                	mov    %ebx,%eax
    3394:	89 04 24             	mov    %eax,(%esp)
    3397:	e8 e5 0d 00 00       	call   4181 <sbrk>
  ...
  if(c != a){
    ...
    33a7:	a1 04 66 00 00       	mov    0x6604,%eax
    ...
    33ba:	c7 44 24 04 7c 5b 00 	movl   $0x5b7c,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 b7 0e 00 00       	call   4281 <printf>
    exit();
    33ca:	e8 2a 0d 00 00       	call   40f9 <exit>
  }
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    33d8:	e8 9c 0d 00 00       	call   4179 <getpid>
    33dd:	89 45 d0             	mov    %eax,-0x30(%ebp)
    pid = fork();
    33e0:	e8 0c 0d 00 00       	call   40f1 <fork>
    33e5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(pid < 0){
    33e8:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 04 66 00 00       	mov    0x6604,%eax
    33f3:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 7e 0e 00 00       	call   4281 <printf>
      exit();
    3403:	e8 f1 0c 00 00       	call   40f9 <exit>
    }
    if(pid == 0){
    ...
    3417:	a1 04 66 00 00       	mov    0x6604,%eax
    341c:	89 54 24 0c          	mov    %edx,0xc(%esp)
    3420:	8b 55 f4             	mov    -0xc(%ebp),%edx
    3423:	89 54 24 08          	mov    %edx,0x8(%esp)
    3427:	c7 44 24 04 9d 5b 00 	movl   $0x5b9d,0x4(%esp)
    342e:	00 
    342f:	89 04 24             	mov    %eax,(%esp)
    3432:	e8 4a 0e 00 00       	call   4281 <printf>
      kill(ppid);
    3437:	8b 45 d0             	mov    -0x30(%ebp),%eax
    343a:	89 04 24             	mov    %eax,(%esp)
    343d:	e8 e7 0c 00 00       	call   4129 <kill>
      exit();
    3442:	e8 b2 0c 00 00       	call   40f9 <exit>
    }
    wait();
    3447:	e8 b5 0c 00 00       	call   4101 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3512:	e8 fa 0b 00 00       	call   4111 <read>
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
  ...
  c = sbrk(4096);
    ...
    352e:	e8 4e 0c 00 00       	call   4181 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3557:	e8 cd 0b 00 00       	call   4129 <kill>
    wait();
    355c:	e8 a0 0b 00 00       	call   4101 <wait>
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 04 66 00 00       	mov    0x6604,%eax
    3578:	c7 44 24 04 b6 5b 00 	movl   $0x5bb6,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 f9 0c 00 00       	call   4281 <printf>
    exit();
    3588:	e8 6c 0b 00 00       	call   40f9 <exit>
  }

  if(sbrk(0) > oldbrk)
    358d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3594:	e8 e8 0b 00 00       	call   4181 <sbrk>
    ...
    35a8:	e8 d4 0b 00 00       	call   4181 <sbrk>
    35ad:	29 c3                	sub    %eax,%ebx
    35af:	89 d8                	mov    %ebx,%eax
    35b1:	89 04 24             	mov    %eax,(%esp)
    35b4:	e8 c8 0b 00 00       	call   4181 <sbrk>

  printf(stdout, "sbrk test OK\n");
    35b9:	a1 04 66 00 00       	mov    0x6604,%eax
    35be:	c7 44 24 04 d1 5b 00 	movl   $0x5bd1,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 b3 0c 00 00       	call   4281 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 04 66 00 00       	mov    0x6604,%eax
    3604:	c7 44 24 04 df 5b 00 	movl   $0x5bdf,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 6d 0c 00 00       	call   4281 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    if((pid = fork()) == 0){
    3624:	e8 c8 0a 00 00       	call   40f1 <fork>
    ...
    3638:	e8 9a ff ff ff       	call   35d7 <validateint>
      exit();
    363d:	e8 b7 0a 00 00       	call   40f9 <exit>
    }
    sleep(0);
    3642:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3649:	e8 3b 0b 00 00       	call   4189 <sleep>
    sleep(0);
    364e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3655:	e8 2f 0b 00 00       	call   4189 <sleep>
    kill(pid);
    365a:	8b 45 ec             	mov    -0x14(%ebp),%eax
    365d:	89 04 24             	mov    %eax,(%esp)
    3660:	e8 c4 0a 00 00       	call   4129 <kill>
    wait();
    3665:	e8 97 0a 00 00       	call   4101 <wait>

    // try to crash the kernel by passing in a bad string pointer
    if(link("nosuchfile", (char*)p) != -1){
    366a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    366d:	89 44 24 04          	mov    %eax,0x4(%esp)
    3671:	c7 04 24 ee 5b 00 00 	movl   $0x5bee,(%esp)
    3678:	e8 dc 0a 00 00       	call   4159 <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 04 66 00 00       	mov    0x6604,%eax
    3687:	c7 44 24 04 f9 5b 00 	movl   $0x5bf9,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 ea 0b 00 00       	call   4281 <printf>
      exit();
    3697:	e8 5d 0a 00 00       	call   40f9 <exit>
  for(p = 0; p <= (uint)hi; p += 4096){
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 04 66 00 00       	mov    0x6604,%eax
    36b4:	c7 44 24 04 12 5c 00 	movl   $0x5c12,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 bd 0b 00 00       	call   4281 <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36cc:	a1 04 66 00 00       	mov    0x6604,%eax
    36d1:	c7 44 24 04 1f 5c 00 	movl   $0x5c1f,0x4(%esp)
    36d8:	00 
    36d9:	89 04 24             	mov    %eax,(%esp)
    36dc:	e8 a0 0b 00 00       	call   4281 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    36e1:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    36e8:	eb 2d                	jmp    3717 <bsstest+0x51>
    if(uninit[i] != '\0'){
    36ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
    36ed:	05 c0 66 00 00       	add    $0x66c0,%eax
    36f2:	0f b6 00             	movzbl (%eax),%eax
    36f5:	84 c0                	test   %al,%al
    36f7:	74 1a                	je     3713 <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    36f9:	a1 04 66 00 00       	mov    0x6604,%eax
    36fe:	c7 44 24 04 29 5c 00 	movl   $0x5c29,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 73 0b 00 00       	call   4281 <printf>
      exit();
    370e:	e8 e6 09 00 00       	call   40f9 <exit>
  for(i = 0; i < sizeof(uninit); i++){
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 04 66 00 00       	mov    0x6604,%eax
    3726:	c7 44 24 04 3a 5c 00 	movl   $0x5c3a,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 4b 0b 00 00       	call   4281 <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 47 5c 00 00 	movl   $0x5c47,(%esp)
    3745:	e8 ff 09 00 00       	call   4149 <unlink>
  pid = fork();
    374a:	e8 a2 09 00 00       	call   40f1 <fork>
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 20 66 00 00 	movl   $0x5c54,0x6620(,%eax,4)
    376f:	54 5c 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    args[MAXARG-1] = 0;
    377d:	c7 05 9c 66 00 00 00 	movl   $0x0,0x669c
    3784:	00 00 00 
    printf(stdout, "bigarg test\n");
    3787:	a1 04 66 00 00       	mov    0x6604,%eax
    378c:	c7 44 24 04 31 5d 00 	movl   $0x5d31,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 e5 0a 00 00       	call   4281 <printf>
    exec("echo", args);
    379c:	c7 44 24 04 20 66 00 	movl   $0x6620,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 50 46 00 00 	movl   $0x4650,(%esp)
    37ab:	e8 81 09 00 00       	call   4131 <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 04 66 00 00       	mov    0x6604,%eax
    37b5:	c7 44 24 04 3e 5d 00 	movl   $0x5d3e,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 bc 0a 00 00       	call   4281 <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 47 5c 00 00 	movl   $0x5c47,(%esp)
    37d4:	e8 60 09 00 00       	call   4139 <open>
    37d9:	89 45 ec             	mov    %eax,-0x14(%ebp)
    close(fd);
    37dc:	8b 45 ec             	mov    -0x14(%ebp),%eax
    37df:	89 04 24             	mov    %eax,(%esp)
    37e2:	e8 3a 09 00 00       	call   4121 <close>
    exit();
    37e7:	e8 0d 09 00 00       	call   40f9 <exit>
  } else if(pid < 0){
    37ec:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    37f0:	79 1a                	jns    380c <bigargtest+0xd4>
    printf(stdout, "bigargtest: fork failed\n");
    37f2:	a1 04 66 00 00       	mov    0x6604,%eax
    37f7:	c7 44 24 04 4e 5d 00 	movl   $0x5d4e,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 7a 0a 00 00       	call   4281 <printf>
    exit();
    3807:	e8 ed 08 00 00       	call   40f9 <exit>
  }
  wait();
    380c:	e8 f0 08 00 00       	call   4101 <wait>
  fd = open("bigarg-ok", 0);
    3811:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    3818:	00 
    3819:	c7 04 24 47 5c 00 00 	movl   $0x5c47,(%esp)
    3820:	e8 14 09 00 00       	call   4139 <open>
    3825:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    3828:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    382c:	79 1a                	jns    3848 <bigargtest+0x110>
    printf(stdout, "bigarg test failed!\n");
    382e:	a1 04 66 00 00       	mov    0x6604,%eax
    3833:	c7 44 24 04 67 5d 00 	movl   $0x5d67,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 3e 0a 00 00       	call   4281 <printf>
    exit();
    3843:	e8 b1 08 00 00       	call   40f9 <exit>
  }
  close(fd);
    3848:	8b 45 ec             	mov    -0x14(%ebp),%eax
    384b:	89 04 24             	mov    %eax,(%esp)
    384e:	e8 ce 08 00 00       	call   4121 <close>
  unlink("bigarg-ok");
    3853:	c7 04 24 47 5c 00 00 	movl   $0x5c47,(%esp)
    385a:	e8 ea 08 00 00       	call   4149 <unlink>
}
    385f:	c9                   	leave  
    3860:	c3                   	ret    
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 7c 5d 00 	movl   $0x5d7c,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 fe 09 00 00       	call   4281 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3990:	c7 44 24 04 95 5d 00 	movl   $0x5d95,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 dd 08 00 00       	call   4281 <printf>
      break;
    ...
    39b4:	00 
    39b5:	c7 44 24 04 e0 8d 00 	movl   $0x8de0,0x4(%esp)
    39bc:	00 
    39bd:	8b 45 e8             	mov    -0x18(%ebp),%eax
    39c0:	89 04 24             	mov    %eax,(%esp)
    39c3:	e8 51 07 00 00       	call   4119 <write>
    ...
    39dc:	c7 44 24 04 a5 5d 00 	movl   $0x5da5,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 91 08 00 00       	call   4281 <printf>
    close(fd);
    39f0:	8b 45 e8             	mov    -0x18(%ebp),%eax
    39f3:	89 04 24             	mov    %eax,(%esp)
    39f6:	e8 26 07 00 00       	call   4121 <close>
    if(total == 0)
  ...
  while(nfiles >= 0){
    ...
    3aed:	e8 57 06 00 00       	call   4149 <unlink>
    nfiles--;
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 b5 5d 00 	movl   $0x5db5,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 6d 07 00 00       	call   4281 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3b2a:	c7 44 24 04 cb 5d 00 	movl   $0x5dcb,0x4(%esp)
    3b31:	00 
    3b32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b39:	e8 43 07 00 00       	call   4281 <printf>
  pid = fork();
    3b3e:	e8 ae 05 00 00       	call   40f1 <fork>
  ...
  if(pid == 0){
    ...
    3b6f:	c7 44 24 04 d8 5d 00 	movl   $0x5dd8,0x4(%esp)
    3b76:	00 
    3b77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b7e:	e8 fe 06 00 00       	call   4281 <printf>
    exit();
    3b83:	e8 71 05 00 00       	call   40f9 <exit>
  } else if(pid < 0){
    3b88:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3b8c:	79 19                	jns    3ba7 <uio+0x8d>
    printf (1, "fork failed\n");
    3b8e:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
    3b95:	00 
    3b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b9d:	e8 df 06 00 00       	call   4281 <printf>
    exit();
    3ba2:	e8 52 05 00 00       	call   40f9 <exit>
  }
  wait();
    3ba7:	e8 55 05 00 00       	call   4101 <wait>
  printf(1, "uio test done\n");
    3bac:	c7 44 24 04 f9 5d 00 	movl   $0x5df9,0x4(%esp)
    3bb3:	00 
    3bb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3bbb:	e8 c1 06 00 00       	call   4281 <printf>
}
    3bc0:	c9                   	leave  
    3bc1:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3bcf:	00 
    3bd0:	c7 04 24 08 5e 00 00 	movl   $0x5e08,(%esp)
    3bd7:	e8 5d 05 00 00       	call   4139 <open>
    3bdc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if (fd < 0) {
    3bdf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3be3:	79 19                	jns    3bfe <argptest+0x3c>
    printf(2, "open failed\n");
    3be5:	c7 44 24 04 0d 5e 00 	movl   $0x5e0d,0x4(%esp)
    3bec:	00 
    3bed:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bf4:	e8 88 06 00 00       	call   4281 <printf>
    exit();
    3bf9:	e8 fb 04 00 00       	call   40f9 <exit>
  }
  read(fd, sbrk(0) - 1, -1);
    3bfe:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3c05:	e8 77 05 00 00       	call   4181 <sbrk>
    ...
    3c1f:	e8 ed 04 00 00       	call   4111 <read>
  close(fd);
    3c24:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3c27:	89 04 24             	mov    %eax,(%esp)
    3c2a:	e8 f2 04 00 00       	call   4121 <close>
  printf(1, "arg test passed\n");
    3c2f:	c7 44 24 04 1a 5e 00 	movl   $0x5e1a,0x4(%esp)
    3c36:	00 
    3c37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c3e:	e8 3e 06 00 00       	call   4281 <printf>
}
    3c43:	c9                   	leave  
    3c44:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c48:	a1 08 66 00 00       	mov    0x6608,%eax
    3c4d:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3c53:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3c58:	a3 08 66 00 00       	mov    %eax,0x6608
  return randstate;
    3c5d:	a1 08 66 00 00       	mov    0x6608,%eax
}
    3c62:	5d                   	pop    %ebp
    3c63:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    3c6d:	c7 44 24 04 2b 5e 00 	movl   $0x5e2b,0x4(%esp)
    3c74:	00 
    3c75:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c7c:	e8 00 06 00 00       	call   4281 <printf>

  if(open("usertests.ran", 0) >= 0){
    3c81:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    3c88:	00 
    3c89:	c7 04 24 3f 5e 00 00 	movl   $0x5e3f,(%esp)
    3c90:	e8 a4 04 00 00       	call   4139 <open>
    3c95:	85 c0                	test   %eax,%eax
    3c97:	78 19                	js     3cb2 <main+0x4e>
    printf(1, "already ran user tests -- rebuild fs.img\n");
    3c99:	c7 44 24 04 50 5e 00 	movl   $0x5e50,0x4(%esp)
    3ca0:	00 
    3ca1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3ca8:	e8 d4 05 00 00       	call   4281 <printf>
    exit();
    3cad:	e8 47 04 00 00       	call   40f9 <exit>
  }
  close(open("usertests.ran", O_CREATE));
    3cb2:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3cb9:	00 
    3cba:	c7 04 24 3f 5e 00 00 	movl   $0x5e3f,(%esp)
    3cc1:	e8 73 04 00 00       	call   4139 <open>
    3cc6:	89 04 24             	mov    %eax,(%esp)
    3cc9:	e8 53 04 00 00       	call   4121 <close>
  ...
  exit();
    3d7d:	e8 77 03 00 00       	call   40f9 <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    3eb9:	e8 53 02 00 00       	call   4111 <read>
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    3f1e:	e8 16 02 00 00       	call   4139 <open>
...
ps(void)
{
  ...
  printf(1, "PID\tTKTS\tTCKS\tSTAT\tNAME\n");
    3fee:	c7 44 24 04 7a 5e 00 	movl   $0x5e7a,0x4(%esp)
    3ff5:	00 
    3ff6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3ffd:	e8 7f 02 00 00       	call   4281 <printf>
  int i;
  for (i = 0; i < NPROC; i++)
    4002:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    4009:	e9 ce 00 00 00       	jmp    40dc <ps+0xfa>
  {
    if (psinfo[i].inuse)
    400e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    4011:	89 d0                	mov    %edx,%eax
    4013:	c1 e0 03             	shl    $0x3,%eax
    4016:	01 d0                	add    %edx,%eax
    4018:	c1 e0 02             	shl    $0x2,%eax
    401b:	8d 5d e8             	lea    -0x18(%ebp),%ebx
    401e:	01 d8                	add    %ebx,%eax
    4020:	2d 04 09 00 00       	sub    $0x904,%eax
    4025:	8b 00                	mov    (%eax),%eax
    4027:	85 c0                	test   %eax,%eax
    4029:	0f 84 a9 00 00 00    	je     40d8 <ps+0xf6>
       printf(1, "%d\t%d\t%d\t%c\t%s\n",
         psinfo[i].pid,
         psinfo[i].tickets,
         psinfo[i].ticks,
         psinfo[i].state,
         psinfo[i].name);
    402f:	8d 8d e4 f6 ff ff    	lea    -0x91c(%ebp),%ecx
    ...
    4042:	83 c0 10             	add    $0x10,%eax
    4045:	8d 3c 01             	lea    (%ecx,%eax,1),%edi
         psinfo[i].state,
    4048:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    404b:	89 d0                	mov    %edx,%eax
    404d:	c1 e0 03             	shl    $0x3,%eax
    4050:	01 d0                	add    %edx,%eax
    4052:	c1 e0 02             	shl    $0x2,%eax
    4055:	8d 75 e8             	lea    -0x18(%ebp),%esi
    4058:	01 f0                	add    %esi,%eax
    405a:	2d e4 08 00 00       	sub    $0x8e4,%eax
    405f:	0f b6 00             	movzbl (%eax),%eax
       printf(1, "%d\t%d\t%d\t%c\t%s\n",
    4062:	0f be f0             	movsbl %al,%esi
    4065:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    4068:	89 d0                	mov    %edx,%eax
    406a:	c1 e0 03             	shl    $0x3,%eax
    406d:	01 d0                	add    %edx,%eax
    406f:	c1 e0 02             	shl    $0x2,%eax
    4072:	8d 4d e8             	lea    -0x18(%ebp),%ecx
    4075:	01 c8                	add    %ecx,%eax
    4077:	2d f8 08 00 00       	sub    $0x8f8,%eax
    407c:	8b 18                	mov    (%eax),%ebx
    407e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    4081:	89 d0                	mov    %edx,%eax
    4083:	c1 e0 03             	shl    $0x3,%eax
    4086:	01 d0                	add    %edx,%eax
    4088:	c1 e0 02             	shl    $0x2,%eax
    408b:	8d 4d e8             	lea    -0x18(%ebp),%ecx
    408e:	01 c8                	add    %ecx,%eax
    4090:	2d 00 09 00 00       	sub    $0x900,%eax
    4095:	8b 08                	mov    (%eax),%ecx
    4097:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    409a:	89 d0                	mov    %edx,%eax
    409c:	c1 e0 03             	shl    $0x3,%eax
    409f:	01 d0                	add    %edx,%eax
    40a1:	c1 e0 02             	shl    $0x2,%eax
    40a4:	8d 55 e8             	lea    -0x18(%ebp),%edx
    40a7:	01 d0                	add    %edx,%eax
    40a9:	2d fc 08 00 00       	sub    $0x8fc,%eax
    40ae:	8b 00                	mov    (%eax),%eax
    40b0:	89 7c 24 18          	mov    %edi,0x18(%esp)
    40b4:	89 74 24 14          	mov    %esi,0x14(%esp)
    40b8:	89 5c 24 10          	mov    %ebx,0x10(%esp)
    40bc:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
    40c0:	89 44 24 08          	mov    %eax,0x8(%esp)
    40c4:	c7 44 24 04 93 5e 00 	movl   $0x5e93,0x4(%esp)
    40cb:	00 
    40cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    40d3:	e8 a9 01 00 00       	call   4281 <printf>
  for (i = 0; i < NPROC; i++)
    40d8:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    40dc:	83 7d e4 3f          	cmpl   $0x3f,-0x1c(%ebp)
    40e0:	0f 8e 28 ff ff ff    	jle    400e <ps+0x2c>
    }
  }
}
    40e6:	81 c4 3c 09 00 00    	add    $0x93c,%esp
    40ec:	5b                   	pop    %ebx
    40ed:	5e                   	pop    %esi
    40ee:	5f                   	pop    %edi
    40ef:	5d                   	pop    %ebp
...
SYSCALL(fork)
    40f1:	b8 01 00 00 00       	mov    $0x1,%eax
    40f6:	cd 40                	int    $0x40
    40f8:	c3                   	ret    

000040f9 <exit>:
SYSCALL(exit)
    40f9:	b8 02 00 00 00       	mov    $0x2,%eax
    40fe:	cd 40                	int    $0x40
    4100:	c3                   	ret    

00004101 <wait>:
SYSCALL(wait)
    4101:	b8 03 00 00 00       	mov    $0x3,%eax
    4106:	cd 40                	int    $0x40
    4108:	c3                   	ret    

00004109 <pipe>:
SYSCALL(pipe)
    4109:	b8 04 00 00 00       	mov    $0x4,%eax
    410e:	cd 40                	int    $0x40
    4110:	c3                   	ret    

00004111 <read>:
SYSCALL(read)
    4111:	b8 05 00 00 00       	mov    $0x5,%eax
    4116:	cd 40                	int    $0x40
    4118:	c3                   	ret    

00004119 <write>:
SYSCALL(write)
    4119:	b8 10 00 00 00       	mov    $0x10,%eax
    411e:	cd 40                	int    $0x40
    4120:	c3                   	ret    

00004121 <close>:
SYSCALL(close)
    4121:	b8 15 00 00 00       	mov    $0x15,%eax
    4126:	cd 40                	int    $0x40
    4128:	c3                   	ret    

00004129 <kill>:
SYSCALL(kill)
    4129:	b8 06 00 00 00       	mov    $0x6,%eax
    412e:	cd 40                	int    $0x40
    4130:	c3                   	ret    

00004131 <exec>:
SYSCALL(exec)
    4131:	b8 07 00 00 00       	mov    $0x7,%eax
    4136:	cd 40                	int    $0x40
    4138:	c3                   	ret    

00004139 <open>:
SYSCALL(open)
    4139:	b8 0f 00 00 00       	mov    $0xf,%eax
    413e:	cd 40                	int    $0x40
    4140:	c3                   	ret    

00004141 <mknod>:
SYSCALL(mknod)
    4141:	b8 11 00 00 00       	mov    $0x11,%eax
    4146:	cd 40                	int    $0x40
    4148:	c3                   	ret    

00004149 <unlink>:
SYSCALL(unlink)
    4149:	b8 12 00 00 00       	mov    $0x12,%eax
    414e:	cd 40                	int    $0x40
    4150:	c3                   	ret    

00004151 <fstat>:
SYSCALL(fstat)
    4151:	b8 08 00 00 00       	mov    $0x8,%eax
    4156:	cd 40                	int    $0x40
    4158:	c3                   	ret    

00004159 <link>:
SYSCALL(link)
    4159:	b8 13 00 00 00       	mov    $0x13,%eax
    415e:	cd 40                	int    $0x40
    4160:	c3                   	ret    

00004161 <mkdir>:
SYSCALL(mkdir)
    4161:	b8 14 00 00 00       	mov    $0x14,%eax
    4166:	cd 40                	int    $0x40
    4168:	c3                   	ret    

00004169 <chdir>:
SYSCALL(chdir)
    4169:	b8 09 00 00 00       	mov    $0x9,%eax
    416e:	cd 40                	int    $0x40
    4170:	c3                   	ret    

00004171 <dup>:
SYSCALL(dup)
    4171:	b8 0a 00 00 00       	mov    $0xa,%eax
    4176:	cd 40                	int    $0x40
    4178:	c3                   	ret    

00004179 <getpid>:
SYSCALL(getpid)
    4179:	b8 0b 00 00 00       	mov    $0xb,%eax
    417e:	cd 40                	int    $0x40
    4180:	c3                   	ret    

00004181 <sbrk>:
SYSCALL(sbrk)
    4181:	b8 0c 00 00 00       	mov    $0xc,%eax
    4186:	cd 40                	int    $0x40
    4188:	c3                   	ret    

00004189 <sleep>:
SYSCALL(sleep)
    4189:	b8 0d 00 00 00       	mov    $0xd,%eax
    418e:	cd 40                	int    $0x40
    4190:	c3                   	ret    

00004191 <uptime>:
SYSCALL(uptime)
    4191:	b8 0e 00 00 00       	mov    $0xe,%eax
    4196:	cd 40                	int    $0x40
    4198:	c3                   	ret    

00004199 <getpinfo>:
SYSCALL(getpinfo)
    4199:	b8 16 00 00 00       	mov    $0x16,%eax
    419e:	cd 40                	int    $0x40
    41a0:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    41a4:	83 ec 18             	sub    $0x18,%esp
    41a7:	8b 45 0c             	mov    0xc(%ebp),%eax
    41aa:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    41ad:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    41b4:	00 
    41b5:	8d 45 f4             	lea    -0xc(%ebp),%eax
    41b8:	89 44 24 04          	mov    %eax,0x4(%esp)
    41bc:	8b 45 08             	mov    0x8(%ebp),%eax
    41bf:	89 04 24             	mov    %eax,(%esp)
    41c2:	e8 52 ff ff ff       	call   4119 <write>
}
    41c7:	c9                   	leave  
    41c8:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    41d1:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    41d8:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    41dc:	74 17                	je     41f5 <printint+0x2c>
    41de:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    41e2:	79 11                	jns    41f5 <printint+0x2c>
    neg = 1;
    41e4:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    41eb:	8b 45 0c             	mov    0xc(%ebp),%eax
    41ee:	f7 d8                	neg    %eax
    41f0:	89 45 ec             	mov    %eax,-0x14(%ebp)
    41f3:	eb 06                	jmp    41fb <printint+0x32>
  } else {
    x = xx;
    41f5:	8b 45 0c             	mov    0xc(%ebp),%eax
    41f8:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    41fb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    4202:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    4205:	8d 41 01             	lea    0x1(%ecx),%eax
    4208:	89 45 f4             	mov    %eax,-0xc(%ebp)
    420b:	8b 5d 10             	mov    0x10(%ebp),%ebx
    420e:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4211:	ba 00 00 00 00       	mov    $0x0,%edx
    4216:	f7 f3                	div    %ebx
    4218:	89 d0                	mov    %edx,%eax
    421a:	0f b6 80 0c 66 00 00 	movzbl 0x660c(%eax),%eax
    4221:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    4225:	8b 75 10             	mov    0x10(%ebp),%esi
    4228:	8b 45 ec             	mov    -0x14(%ebp),%eax
    422b:	ba 00 00 00 00       	mov    $0x0,%edx
    4230:	f7 f6                	div    %esi
    4232:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4235:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4239:	75 c7                	jne    4202 <printint+0x39>
  if(neg)
    423b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    423f:	74 10                	je     4251 <printint+0x88>
    buf[i++] = '-';
    4241:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4244:	8d 50 01             	lea    0x1(%eax),%edx
    4247:	89 55 f4             	mov    %edx,-0xc(%ebp)
    424a:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    424f:	eb 1f                	jmp    4270 <printint+0xa7>
    4251:	eb 1d                	jmp    4270 <printint+0xa7>
    putc(fd, buf[i]);
    4253:	8d 55 dc             	lea    -0x24(%ebp),%edx
    4256:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4259:	01 d0                	add    %edx,%eax
    425b:	0f b6 00             	movzbl (%eax),%eax
    425e:	0f be c0             	movsbl %al,%eax
    4261:	89 44 24 04          	mov    %eax,0x4(%esp)
    4265:	8b 45 08             	mov    0x8(%ebp),%eax
    4268:	89 04 24             	mov    %eax,(%esp)
    426b:	e8 31 ff ff ff       	call   41a1 <putc>
  while(--i >= 0)
    4270:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    4274:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4278:	79 d9                	jns    4253 <printint+0x8a>
}
    427a:	83 c4 30             	add    $0x30,%esp
    427d:	5b                   	pop    %ebx
    427e:	5e                   	pop    %esi
    427f:	5d                   	pop    %ebp
    4280:	c3                   	ret    
...
{
    4281:	55                   	push   %ebp
    4282:	89 e5                	mov    %esp,%ebp
    4284:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
    428e:	8d 45 0c             	lea    0xc(%ebp),%eax
    4291:	83 c0 04             	add    $0x4,%eax
    4294:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    4297:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    429e:	e9 7c 01 00 00       	jmp    441f <printf+0x19e>
    c = fmt[i] & 0xff;
    42a3:	8b 55 0c             	mov    0xc(%ebp),%edx
    42a6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    42a9:	01 d0                	add    %edx,%eax
    42ab:	0f b6 00             	movzbl (%eax),%eax
    42ae:	0f be c0             	movsbl %al,%eax
    42b1:	25 ff 00 00 00       	and    $0xff,%eax
    42b6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    42b9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    42bd:	75 2c                	jne    42eb <printf+0x6a>
      if(c == '%'){
    42bf:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    42c3:	75 0c                	jne    42d1 <printf+0x50>
        state = '%';
    42c5:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    42cc:	e9 4a 01 00 00       	jmp    441b <printf+0x19a>
      } else {
        putc(fd, c);
    42d1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    42d4:	0f be c0             	movsbl %al,%eax
    42d7:	89 44 24 04          	mov    %eax,0x4(%esp)
    42db:	8b 45 08             	mov    0x8(%ebp),%eax
    42de:	89 04 24             	mov    %eax,(%esp)
    42e1:	e8 bb fe ff ff       	call   41a1 <putc>
    42e6:	e9 30 01 00 00       	jmp    441b <printf+0x19a>
      }
    } else if(state == '%'){
    42eb:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    42ef:	0f 85 26 01 00 00    	jne    441b <printf+0x19a>
      if(c == 'd'){
    42f5:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    42f9:	75 2d                	jne    4328 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    42fb:	8b 45 e8             	mov    -0x18(%ebp),%eax
    42fe:	8b 00                	mov    (%eax),%eax
    4300:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    4307:	00 
    4308:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    430f:	00 
    4310:	89 44 24 04          	mov    %eax,0x4(%esp)
    4314:	8b 45 08             	mov    0x8(%ebp),%eax
    4317:	89 04 24             	mov    %eax,(%esp)
    431a:	e8 aa fe ff ff       	call   41c9 <printint>
        ap++;
    431f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4323:	e9 ec 00 00 00       	jmp    4414 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    4328:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    432c:	74 06                	je     4334 <printf+0xb3>
    432e:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    4332:	75 2d                	jne    4361 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    4334:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4337:	8b 00                	mov    (%eax),%eax
    4339:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4340:	00 
    4341:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4348:	00 
    4349:	89 44 24 04          	mov    %eax,0x4(%esp)
    434d:	8b 45 08             	mov    0x8(%ebp),%eax
    4350:	89 04 24             	mov    %eax,(%esp)
    4353:	e8 71 fe ff ff       	call   41c9 <printint>
        ap++;
    4358:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    435c:	e9 b3 00 00 00       	jmp    4414 <printf+0x193>
      } else if(c == 's'){
    4361:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4365:	75 45                	jne    43ac <printf+0x12b>
        s = (char*)*ap;
    ...
    436f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    4373:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4377:	75 09                	jne    4382 <printf+0x101>
          s = "(null)";
    4379:	c7 45 f4 a3 5e 00 00 	movl   $0x5ea3,-0xc(%ebp)
        while(*s != 0){
    4380:	eb 1e                	jmp    43a0 <printf+0x11f>
    4382:	eb 1c                	jmp    43a0 <printf+0x11f>
          putc(fd, *s);
    4384:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4387:	0f b6 00             	movzbl (%eax),%eax
    438a:	0f be c0             	movsbl %al,%eax
    438d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4391:	8b 45 08             	mov    0x8(%ebp),%eax
    4394:	89 04 24             	mov    %eax,(%esp)
    4397:	e8 05 fe ff ff       	call   41a1 <putc>
          s++;
    439c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
        while(*s != 0){
    43a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43a3:	0f b6 00             	movzbl (%eax),%eax
    43a6:	84 c0                	test   %al,%al
    43a8:	75 da                	jne    4384 <printf+0x103>
    43aa:	eb 68                	jmp    4414 <printf+0x193>
        }
      } else if(c == 'c'){
    43ac:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    43b0:	75 1d                	jne    43cf <printf+0x14e>
        putc(fd, *ap);
    43b2:	8b 45 e8             	mov    -0x18(%ebp),%eax
    43b5:	8b 00                	mov    (%eax),%eax
    43b7:	0f be c0             	movsbl %al,%eax
    43ba:	89 44 24 04          	mov    %eax,0x4(%esp)
    43be:	8b 45 08             	mov    0x8(%ebp),%eax
    43c1:	89 04 24             	mov    %eax,(%esp)
    43c4:	e8 d8 fd ff ff       	call   41a1 <putc>
        ap++;
    43c9:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    43cd:	eb 45                	jmp    4414 <printf+0x193>
      } else if(c == '%'){
    43cf:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    43d3:	75 17                	jne    43ec <printf+0x16b>
        putc(fd, c);
    43d5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    43d8:	0f be c0             	movsbl %al,%eax
    43db:	89 44 24 04          	mov    %eax,0x4(%esp)
    43df:	8b 45 08             	mov    0x8(%ebp),%eax
    43e2:	89 04 24             	mov    %eax,(%esp)
    43e5:	e8 b7 fd ff ff       	call   41a1 <putc>
    43ea:	eb 28                	jmp    4414 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    43ec:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    43f3:	00 
    43f4:	8b 45 08             	mov    0x8(%ebp),%eax
    43f7:	89 04 24             	mov    %eax,(%esp)
    43fa:	e8 a2 fd ff ff       	call   41a1 <putc>
        putc(fd, c);
    43ff:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4402:	0f be c0             	movsbl %al,%eax
    4405:	89 44 24 04          	mov    %eax,0x4(%esp)
    4409:	8b 45 08             	mov    0x8(%ebp),%eax
    440c:	89 04 24             	mov    %eax,(%esp)
    440f:	e8 8d fd ff ff       	call   41a1 <putc>
      }
      state = 0;
    4414:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  for(i = 0; fmt[i]; i++){
    441b:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    441f:	8b 55 0c             	mov    0xc(%ebp),%edx
    4422:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4425:	01 d0                	add    %edx,%eax
    4427:	0f b6 00             	movzbl (%eax),%eax
    442a:	84 c0                	test   %al,%al
    442c:	0f 85 71 fe ff ff    	jne    42a3 <printf+0x22>
    }
  }
}
    4432:	c9                   	leave  
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4443:	a1 a8 66 00 00       	mov    0x66a8,%eax
  ...
  freep = p;
    ...
    450e:	a3 a8 66 00 00       	mov    %eax,0x66a8
}
    4513:	c9                   	leave  
    4514:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    4534:	e8 48 fc ff ff       	call   4181 <sbrk>
  ...
  return freep;
    4566:	a1 a8 66 00 00       	mov    0x66a8,%eax
}
    456b:	c9                   	leave  
    456c:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    4582:	a1 a8 66 00 00       	mov    0x66a8,%eax
    4587:	89 45 f0             	mov    %eax,-0x10(%ebp)
    458a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    458e:	75 23                	jne    45b3 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4590:	c7 45 f0 a0 66 00 00 	movl   $0x66a0,-0x10(%ebp)
    4597:	8b 45 f0             	mov    -0x10(%ebp),%eax
    459a:	a3 a8 66 00 00       	mov    %eax,0x66a8
    459f:	a1 a8 66 00 00       	mov    0x66a8,%eax
    45a4:	a3 a0 66 00 00       	mov    %eax,0x66a0
    base.s.size = 0;
    45a9:	c7 05 a4 66 00 00 00 	movl   $0x0,0x66a4
    45b0:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    45e3:	2b 45 ec             	sub    -0x14(%ebp),%eax
    ...
    4606:	a3 a8 66 00 00       	mov    %eax,0x66a8
      return (void*)(p + 1);
    ...
    if(p == freep)
    4613:	a1 a8 66 00 00       	mov    0x66a8,%eax
